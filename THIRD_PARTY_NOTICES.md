...
- [pdfjs-dist@6.1.200](https://mozilla.github.io/pdf.js/)
...
- [fast-uri@4.1.1](https://github.com/fastify/fast-uri)
...
- [lru-cache@11.5.1,11.5.2](https://github.com/isaacs/node-lru-cache#readme)
...
- [tar@7.5.20](https://github.com/isaacs/node-tar#readme)
...
- [@astrojs/compiler@4.0.0](https://astro.build)
- [@astrojs/internal-helpers@0.10.0](https://github.com/withastro/astro#readme)
- [@astrojs/markdown-remark@7.2.0](https://astro.build)
...
- [@astrojs/telemetry@3.3.2](https://astro.build)
...
- [@fastify/static@9.3.0](https://github.com/fastify/fastify-static)
...
- [array-iterate@2.0.1](https://github.com/wooorm/array-iterate#readme)
- [astring@1.9.0](https://github.com/davidbonnet/astring#readme)
- [astro@6.4.8](https://astro.build)
...
- [cookie-es@1.2.3](https://github.com/unjs/cookie-es#readme)
...
- [es-module-lexer@2.3.0,2.3.1](https://github.com/guybedford/es-module-lexer#readme)
...
- [fflate@0.4.8,0.8.3](https://101arrowz.github.io/fflate)
...
- [is-docker@3.0.0,4.0.0](https://github.com/sindresorhus/is-docker#readme)
...
- [mdast-util-definitions@6.0.0](https://github.com/syntax-tree/mdast-util-definitions#readme)
...
- [parse-latin@7.0.0](https://github.com/wooorm/parse-latin#readme)
...
- [postcss@8.5.20](https://postcss.org/)
...
- [react-router@7.18.1](https://github.com/remix-run/react-router#readme)
- [react-router-dom@7.18.1](https://github.com/remix-run/react-router#readme)
...
- [remark-smartypants@3.0.2](https://github.com/silvenon/remark-smartypants#readme)
...
- [retext@9.0.0](https://github.com/retextjs/retext)
- [retext-latin@4.0.0](https://github.com/retextjs/retext)
- [retext-smartypants@6.2.0](https://github.com/retextjs/retext-smartypants#readme)
- [retext-stringify@4.0.0](https://github.com/retextjs/retext)
...
- [unist-util-modify-children@4.0.0](https://github.com/syntax-tree/unist-util-modify-children#readme)
...
- [unist-util-visit-children@3.0.0](https://github.com/syntax-tree/unist-util-visit-children#readme)
...
- [which-pm-runs@1.1.0](https://github.com/zkochan/packages/tree/main/which-pm-runs#readme)
