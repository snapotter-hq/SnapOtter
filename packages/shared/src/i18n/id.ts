...
export const id: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "File Anda tidak pernah meninggalkan mesin Anda.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Suite manipulasi file self-hosted yang mengutamakan privasi dengan 157 alat untuk gambar, video, audio, PDF, dan data. Proses, konversi, kompres, dan otomasi alur kerja file Anda tanpa mengirim data ke cloud.",
      versionLabel: "Versi:",
      linksHeading: "Tautan",
  ...
  auth: {
    ...
    heroSubtitle: "Semua alat file yang Anda butuhkan.",
    rotatingPhrases: [
      ...
      "Deploy dalam hitungan menit dengan Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Statistik penggunaan anonim membantu kami memperbaiki bug dan membangun alat yang benar-benar Anda butuhkan. File Anda tetap di mesin Anda.",
    ...
    settingsPrivacy: "File Anda tidak pernah meninggalkan mesin Anda.",
  ...
  a11y: {
    ...
    nextImage: "File berikutnya",
    imageArea: "Area pratinjau",
    imageViewer: "Penampil file",
    fileDropZone: "File drop zone",
    imageDropZone: "Zona drop file",
    beforeAfterSlider: "Before/after comparison slider",
    imageControls: "Kontrol pratinjau",
