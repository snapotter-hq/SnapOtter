...
export const pl: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Samoobsługowy pakiet narzędzi do przetwarzania plików z priorytetem prywatności. 157 narzędzi do obrazów, wideo, audio, PDF i danych. Przetwarzanie, konwersja, kompresja i automatyzacja procesów bez wysyłania danych do chmury.",
      versionLabel: "Wersja:",
  ...
  auth: {
    ...
    heroSubtitle: "Wszystkie narzędzia do plików, jakich potrzebujesz.",
    rotatingPhrases: [
      ...
      "157 narzędzi.",
      "19 modeli AI. Na Twoim sprzęcie.",
      ...
      "Wdrożenie w minuty z Docker Compose.",
