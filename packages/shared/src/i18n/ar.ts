...
export const ar: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "ملفاتك لا تغادر جهازك أبدًا.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "مجموعة أدوات معالجة ملفات ذاتية الاستضافة تركز على الخصوصية مع 157 أداة عبر الصور والفيديو والصوت وPDF والبيانات. معالجة وتحويل وضغط وأتمتة سير عمل الملفات دون إرسال البيانات إلى السحابة.",
  ...
  auth: {
    ...
    heroSubtitle: "كل أدوات الملفات التي تحتاجها.",
    rotatingPhrases: [
      ...
      "خادمك. قواعدك.",
      "نشر في دقائق مع Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "إحصائيات الاستخدام المجهولة تساعدنا في إصلاح الأخطاء وبناء الأدوات التي تحتاجها فعلًا. ملفاتك تبقى على جهازك.",
    ...
    settingsPrivacy: "ملفاتك لا تغادر جهازك أبدًا.",
