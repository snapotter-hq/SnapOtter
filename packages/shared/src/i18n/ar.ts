...
export const ar: TranslationKeys = {
  ...
  toolSettings: {
    ...
    "pipeline-step": {
      noConfigurableSettingsDefaultsWill:
        "لا توجد إعدادات قابلة للتخصيص. سيتم استخدام الإعدادات الافتراضية.",
    },
    "html-to-image-results": {
      capturedScreenshot: "لقطة الشاشة الملتقطة",
    },
    "eraser-canvas": {
      paintOverObjectsToErase: "ارسم فوق الكائنات التي تريد مسحها",
    },
    "crop-canvas": {
      original: "الأصلي:",
      cropPreview: "معاينة القص",
      cropRegionSize: "منطقة القص: {width} x {height}",
      originalSize: "الأصلي: {width} x {height}",
    },
    "image-to-base64-results": {
      ...
      completedOfTotalFiles: "{completed} من {total} ملفات",
      convertedOfTotal: "تم تحويل {done} من {total}",
      preview: "معاينة",
      filesReadyClickConvert: '{count} ملفات جاهزة. اضغط "تحويل إلى Base64" للبدء.',
      clickConvertToConvert: 'اضغط "تحويل إلى Base64" للتحويل.',
      convertedOfTotalWithFailed: "تم تحويل {done} من {total}، فشل {count}",
      tabDataUri: "Data URI",
      tabRawBase64: "Base64 خام",
      startingConversion: "جاري بدء التحويل...",
      uploadImagesAndClickConvert: 'ارفع الصور واضغط "تحويل إلى Base64" للبدء.',
      copyAllAsJson: "نسخ الكل بصيغة JSON",
      downloadAllAsJson: "تحميل الكل بصيغة JSON",
      downloadAllAsText: "تحميل الكل كنص",
      noResultForThisFile: "لا توجد نتيجة لهذا الملف. ربما لم تتم معالجته بعد.",
    },
    "split-canvas": {
      loadingPreview: "جاري تحميل المعاينة...",
      splitGridOverlay: "طبقة شبكة التقسيم",
      infoBar: "{width} x {height}px . شبكة {cols}x{rows} . {count} مربعات",
    },
    "remove-bg": {
      original: "الأصلي:",
      transparent: "شفاف",
      ...
      originalKb: "الأصلي: {size} KB",
      processedKb: "المعالج: {size} KB",
    },
    "ocr-pdf-view": {
      extractedText: "النص المستخرج",
      copied: "تم النسخ",
      loadingExtractedText: "جاري تحميل النص المستخرج...",
      noTextFound: "(لم يتم العثور على نص)",
      extractingText: "جاري استخراج النص...",
      theExtractedTextWillAppear: "سيظهر النص المستخرج هنا بعد تشغيل OCR.",
    },
    "image-enhancement": {
      original: "الأصلي:",
      removesNoiseAndArtifactsUsing: "يزيل التشويش والتشوهات باستخدام AI",
      analyzingImage: "جاري تحليل الصورة...",
      imageLooksGoodFineTune: "تبدو الصورة جيدة. اضبط بدقة باستخدام شريط الشدة.",
      deepEnhance: "تحسين عميق",
      enhance: "تحسين",
      sharpenFilter: "مرشح زيادة الحدة",
      whiteBalanceTemperatureFilter: "مرشح درجة حرارة توازن اللون الأبيض",
      originalSizeKb: "الأصلي: {size} KB",
      enhancedSizeKb: "المحسّن: {size} KB",
    },
    "find-duplicates-results": {
      ...
      format: "الصيغة",
      scanned: "الممسوح:",
      duplicateGroups: "مجموعات المتكررات:",
      unique: "الفريدة:",
      spaceSaveable: "المساحة القابلة للتوفير:",
      noDuplicatesFound: "لم يتم العثور على متكررات",
      noPreview: "لا توجد معاينة",
      backToOverview: "العودة إلى النظرة العامة",
      fileSize: "حجم الملف",
      similarity: "التشابه",
      scanningForDuplicates: "جاري البحث عن المتكررات...",
      chooseADetectionModeAnd: 'اختر وضع الاكتشاف واضغط "مسح" للعثور على المتكررات.',
      allImagesUnique: "جميع الصور ({count}) فريدة.",
      percentSimilar: "تشابه بنسبة {percent}%",
      imagesClickToCompare: "{count} صور · اضغط للمقارنة ›",
      groupOf: "المجموعة {current} من {total}",
      showingAllImagesInGroup:
        'تُعرض جميع الصور ({count}) في هذه المجموعة. اضغط على أي صورة لتعيينها "الأفضل".',
      selectedAsBest: "محددة كالأفضل",
      clickToMarkAsBest: "اضغط لتحديدها كالأفضل",
    },
    "conversion-preset": {
      quality: "الجودة",
      high: "عالية",
    ...
    color: {
      ...
      adjustingColors: "جاري تعديل الألوان",
      apply: "تطبيق",
      temperatureAndTintColorFilter: "مرشح درجة الحرارة والصبغة",
      colorChannelFilter: "مرشح قنوات الألوان",
      sharpenFilter: "مرشح زيادة الحدة",
      originalKb: "الأصلي: {size} KB",
      processedKb: "المعالج: {size} KB",
    ...
    crop: {
      ...
      widthPx: "العرض (px)",
      heightPx: "الارتفاع (px)",
      swapWidthHeight: "تبديل العرض/الارتفاع",
      required: "مطلوب",
      widthOfMax: "العرض (من {max})",
      heightOfMax: "الارتفاع (من {max})",
      x: "X",
      xOfMax: "X (من {max})",
      y: "Y",
      yOfMax: "Y (من {max})",
    ...
    rotate: {
      rotate90CounterClockwise: "تدوير 90° عكس عقارب الساعة",
      rotate180: "تدوير 180°",
      rotate90Clockwise: "تدوير 90° مع عقارب الساعة",
      decrease1: "إنقاص 1°",
      increase1: "زيادة 1°",
      rotate: "تدوير",
      angle: "الزاوية",
    ...
    convert: {
      original: "الأصلي:",
      originalSizeKb: "الأصلي: {size} KB",
      processedSizeKb: "المعالج: {size} KB",
    ...
    "strip-metadata": {
      original: "الأصلي:",
      iccProfile: "بيانات ICC",
      originalSize: "الأصلي: {size} KB",
      processedSize: "المعالج: {size} KB",
      fieldsCount: "{count} حقول",
      locationCoords: "بيانات الموقع: {lat}، {lon}",
    ...
    "edit-metadata": {
      ...
      photographerCreatorName: "اسم المصوّر / المنشئ",
      imageTitle: "عنوان الصورة",
      shortHeadline: "عنوان رئيسي قصير",
      cityName: "اسم المدينة",
      stateOrProvince: "الولاية أو المقاطعة",
      countryName: "اسم البلد",
      saveCurrentValuesAsTemplate: "حفظ القيم الحالية كقالب",
      gpsCleared2: "، تم مسح GPS",
      gpsAdded2: "، تم إضافة GPS",
      datesShifted2: "، تم تحريك التواريخ",
      originalSizeKb: "الأصلي: {size} KB",
      processedSizeKb: "المعالج: {size} KB",
      readingMetadata: "جاري قراءة البيانات الوصفية...",
    ...
    "image-to-pdf": {
      preview: "معاينة",
      targetMetWithQuality: "تم تحقيق الهدف (جودة JPEG: {quality}%)",
    ...
    "pdf-to-image": {
      converting2: "جاري التحويل",
      page: "صفحة",
      custom: "مخصص",
      uploadAPdfToGet: "ارفع ملف PDF للبدء",
      generatingPagePreviews: "جاري إنشاء معاينات الصفحات...",
      selectAll: "تحديد الكل",
      deselectAll: "إلغاء تحديد الكل",
      convertingSelected: "جاري تحويل {count} صفحة...",
      convertingSelectedPlural: "جاري تحويل {count} صفحات...",
      pagesConverted: "تم تحويل {count} صفحة",
      pagesConvertedPlural: "تم تحويل {count} صفحات",
      selectedOfPages: "تم تحديد {selected} من {total} صفحة",
      selectedOfPagesPlural: "تم تحديد {selected} من {total} صفحات",
      pageAlt: "الصفحة {page}",
    ...
    favicon: {
      ...
      themeColor2: "لون السمة",
      usedInManifestJsonFor: "يُستخدم في manifest.json لواجهة المتصفح",
      uploadHint:
    ...
    ocr: {
      ...
      enhanceHint:
        "يحسّن التباين المحلي قبل التعرّف. يطبّقه الوضع السريع مباشرةً؛ ويحتفظ به الوضعان المتوازن والأفضل فقط إذا حسّن التقييم المُعاير النتيجة.",
      fastKoreanUnsupported:
        "لا يدعم OCR السريع اللغة الكورية. ثبّت حزمة OCR الدقيقة واختر متوازن أو الأفضل.",
      language: "اللغة",
    ...
    "enhance-faces": {
      ...
      fewerFaces: "وجوه أقل",
      moreFaces: "وجوه أكثر",
      onlyEnhanceMainFace: "تحسين الوجه الرئيسي فقط",
      forPortraitsIgnoresBackgroundFaces: "للصور الشخصية، يتجاهل الوجوه في الخلفية",
      originalSizeKb: "الأصلي: {size} KB",
      enhancedSizeKb: "المحسّن: {size} KB",
    ...
    "smart-crop": {
      ...
      smartCropping: "جاري القص الذكي",
      submitSubjectBatch: "قص ذكي ({count} ملف)",
      submitFaceBatch: "قص الوجه ({count} ملف)",
      submitTrimBatch: "تقليم الحدود ({count} ملف)",
    ...
    "passport-photo": {
      ...
      docUS: "جواز سفر الولايات المتحدة",
      countryCA: "كندا",
      docCA: "جواز سفر كندا",
      countryBR: "البرازيل",
      docBR: "جواز سفر البرازيل",
      countryMX: "المكسيك",
      docMX: "جواز سفر المكسيك",
      countryGB: "المملكة المتحدة",
      docGB: "جواز سفر المملكة المتحدة",
      countryEU: "الاتحاد الأوروبي",
      docEU: "جواز سفر الاتحاد الأوروبي (ICAO)",
      countryDE: "ألمانيا",
      docDE: "جواز سفر ألمانيا",
      countryFR: "فرنسا",
      docFR: "جواز سفر فرنسا",
      countryRU: "روسيا",
      docRU: "جواز سفر روسيا",
      countryTR: "تركيا",
      docTR: "جواز سفر تركيا",
      countryIE: "أيرلندا",
      docIE: "جواز سفر أيرلندا",
      countryIT: "إيطاليا",
      docIT: "جواز سفر إيطاليا",
      countryES: "إسبانيا",
      docES: "جواز سفر إسبانيا",
      countryNL: "هولندا",
      docNL: "جواز سفر هولندا",
      countryPL: "بولندا",
      docPL: "جواز سفر بولندا",
      countrySE: "السويد",
      docSE: "جواز سفر السويد",
      countryIN: "الهند",
      docIN: "جواز سفر الهند",
      countryCN: "الصين",
      docCN: "جواز سفر الصين",
      countryJP: "اليابان",
      docJP: "جواز سفر اليابان",
      countryKR: "كوريا الجنوبية",
      docKR: "جواز سفر كوريا الجنوبية",
      countryTH: "تايلاند",
      docTH: "جواز سفر تايلاند",
      countryPH: "الفلبين",
      docPH: "جواز سفر الفلبين",
      countryID: "إندونيسيا",
      docID: "جواز سفر إندونيسيا",
      countrySG: "سنغافورة",
      docSG: "جواز سفر سنغافورة",
      countryMY: "ماليزيا",
      docMY: "جواز سفر ماليزيا",
      countryVN: "فيتنام",
      docVN: "جواز سفر فيتنام",
      countryPK: "باكستان",
      docPK: "جواز سفر باكستان",
      countryBD: "بنغلاديش",
      docBD: "جواز سفر بنغلاديش",
      countryAU: "أستراليا",
      docAU: "جواز سفر أستراليا",
      countryNZ: "نيوزيلندا",
      docNZ: "جواز سفر نيوزيلندا",
      countrySA: "المملكة العربية السعودية",
      docSA: "جواز سفر السعودية",
      countryAE: "الإمارات العربية المتحدة",
      docAE: "جواز سفر الإمارات",
      countryNG: "نيجيريا",
      docNG: "جواز سفر نيجيريا",
      countryEG: "مصر",
      docEG: "جواز سفر مصر",
      countryZA: "جنوب أفريقيا",
      docZA: "جواز سفر جنوب أفريقيا",
      countryCUSTOM: "مخصص",
      docCUSTOM: "مخصص",
      width: "العرض",
      height: "الارتفاع",
      maxFileSize2: "الحجم الأقصى للملف:",
      analyzingFace: "جاري تحليل الوجه",
      resetTo100: "إعادة التعيين إلى 100%",
      dimensionsSummary: "{width}x{height} مم ({pxWidth}x{pxHeight}px) بدقة {dpi} DPI",
      faceCenteredDetail: "الوجه ليس في المنتصف. قص الصورة أو غيّر موضعها.",
      headLevelDetail: "الرأس مائل. اجعل رأسك مستقيمًا أو قم بتدوير الصورة.",
      lookingStraightDetail: "الوجه ملتفت جانبًا. انظر مباشرة إلى الكاميرا.",
      faceSizeDetail: "الوجه صغير جدًا. اقترب من الكاميرا أو قص الصورة بشكل أضيق.",
      ...
      bgWhite: "أبيض",
      bgOffWhite: "أبيض عاجي",
      bgLightGray: "رمادي فاتح (UK/DE)",
      bgLightBlue: "أزرق فاتح (FR)",
      bgRed: "أحمر (ID)",
      detectingLandmarksShort: "جاري اكتشاف معالم الوجه...",
      country: "البلد",
    ...
    "transparency-fixer": {
      webp: "WebP",
      progressLabelBatch: "جاري إصلاح الشفافية ({count} ملف)",
    ...
    "background-replace": {
      ...
      color1: "اللون 1",
      color22: "اللون 2",
      angleValue: "الزاوية: {angle}°",
      edgeFeatherValue: "تنعيم الحواف: {feather}px",
      color: "لون الخلفية",
    ...
    "blur-background": {
      off: "إيقاف",
      outputFormat: "صيغة الإخراج",
      edgeFeather: "تنعيم الحواف",
      softensTheEdgeBetweenSubject: "ينعّم الحافة بين الموضوع والخلفية المموهة",
    ...
    "watermark-text": {
      ...
      tiledRepeating: "متكرر",
      originalKb: "الأصلي: {size} KB",
      processedKb: "المعالج: {size} KB",
      applyWatermarkBatch: "تطبيق العلامة المائية ({count} ملف)",
    ...
    "watermark-image": {
      ...
      chooseWatermarkImage: "اختيار صورة العلامة المائية",
      originalKb: "الأصلي: {size} KB",
      processedKb: "المعالج: {size} KB",
    ...
    compose: {
      ...
      screen: "شاشة",
      processing: "جاري المعالجة...",
      overlayImage: "صورة التراكب",
      chooseOverlayImage: "اختيار صورة التراكب",
      normal: "عادي",
      multiply: "ضرب",
      overlay: "تراكب",
      darken: "تغميق",
    ...
    "meme-generator": {
      ...
      noTemplatesMatchYourSearch: "لا توجد قوالب تطابق بحثك",
      backToTemplates: "العودة إلى القوالب",
      chooseATextLayout: "اختر تخطيط النص",
      generatedMeme: "صورة Meme المُنشأة",
      newMeme: "Meme جديد",
      yourMemeIsReady: "صورة Meme جاهزة.",
    ...
    info: {
      ...
      max: "الأقصى:",
      mean: "المتوسط:",
      minValue: "الأدنى:{value}",
      maxValue: "الأقصى:{value}",
      meanValue: "المتوسط:{value}",
    ...
    compare: {
      ...
      chooseSecondImage: "اختيار الصورة الثانية",
      comparing: "جاري المقارنة...",
      downloadDiffImage: "تحميل صورة الفرق",
    ...
    "find-duplicates": {
      ...
      strictMatch: "مطابقة صارمة",
      broadMatch: "مطابقة واسعة",
      analyzing: "جاري التحليل...",
      totalScanned: "إجمالي الممسوح",
      duplicateGroups: "مجموعات المتكررات",
      uniqueImages: "الصور الفريدة",
      spaceSaveable: "المساحة القابلة للتوفير",
      skipped: "تم تخطيها",
      downloadGrouped: "تحميل حسب المجموعات",
      downloadUniqueOnly: "تحميل الفريدة فقط",
      reScanWithDifferentSettings: "إعادة المسح بإعدادات مختلفة",
      skippedFileOne: "تعذر تحليل {count} ملف",
      skippedFileOther: "تعذر تحليل {count} ملفات",
      uploadingPercent: "جاري الرفع... {percent}%",
      scanImages: "مسح {count} صور",
      preset: "القالب",
      exact: "مطابق",
      similar: "متشابه",
      loose: "تقريبي",
    ...
    "qr-generate": {
      ...
      linear: "خطي",
      radial: "شعاعي",
      enterContentToGenerateA: "أدخل محتوى لإنشاء رمز QR",
      httpsExampleCom: "https://example.com",
      enterAnyText: "أدخل أي نص...",
      networkNameSsid: "اسم الشبكة (SSID)",
      encryption: "التشفير",
      ...
      yourMessage: "رسالتك...",
      style: "النمط",
      dotPattern: "نمط النقاط",
      cornerSquare: "مربع الزاوية",
      cornerDot: "نقطة الزاوية",
      dotColor: "لون النقاط",
      useGradient: "استخدام التدرج",
      from: "من",
      customCornerColors: "ألوان زوايا مخصصة",
      addLogoImage: "إضافة صورة شعار",
      logoSize: "حجم الشعار",
      logoMargin: "هامش الشعار",
      cleanAreaBehindLogo: "تنظيف المنطقة خلف الشعار",
      errorCorrection: "تصحيح الأخطاء",
      low7MaxDensity: "منخفض (7%) - أقصى كثافة",
      medium15GeneralUse: "متوسط (15%) - استخدام عام",
      quartile25WithSmallLogo: "ربعي (25%) - مع شعار صغير",
      high30WithLargeLogo: "عالٍ (30%) - مع شعار كبير",
    ...
    "barcode-read": {
      ...
      scanImagesForQrCodes:
        "مسح الصور بحثًا عن رموز QR والباركود (Code 128 وEAN وUPC وغيرها) والرموز ثنائية الأبعاد (DataMatrix وPDF417 وAztec).",
      options: "الخيارات",
      thoroughScan: "مسح شامل",
      spendsMoreTimeAnalyzingThe:
        "يقضي وقتًا أطول في تحليل الصورة. فعّله للباركود الصغير أو التالف أو منخفض التباين.",
      scanningForBarcodes: "جاري مسح الباركود",
      copyAll: "نسخ الكل",
      copyValue: "نسخ القيمة",
      scanBarcodesBatch: "مسح الباركود ({count} ملف)",
      foundBarcode: "تم العثور على {count} باركود",
      foundBarcodePlural: "تم العثور على {count} باركود",
      submit: "مسح الباركود",
    ...
    collage: {
      ...
      stacked: "مكدّس",
      leftLarge: "كبير على اليسار",
      rightLarge: "كبير على اليمين",
      topLarge: "كبير في الأعلى",
      bottomLarge: "كبير في الأسفل",
      centerLarge: "كبير في الوسط",
      ...
      mosaic: "فسيفساء",
      uploadingImages: "جاري رفع الصور...",
      processingCollage: "جاري معالجة الصورة المجمّعة...",
      loaded: "محمّلة",
      images: "صور",
      collage: "الصورة المجمّعة:",
      snapotter: "SnapOtter",
      background: "الخلفية",
      format: "الصيغة",
      uploadImagesForCollage: "رفع صور للصورة المجمّعة",
      drop2OrMoreImages: "اسحب صورتين أو أكثر هنا للبدء",
      resetPositionAndZoom: "إعادة تعيين الموضع والتكبير",
      collageResult: "نتيجة الصورة المجمّعة",
      backToEditor: "العودة إلى المحرر",
      layout: "التخطيط",
      allLayouts: "جميع التخطيطات",
      spacingStyle: "التباعد والنمط",
      canvas: "اللوحة",
      output: "الإخراج",
      creating: "جاري الإنشاء...",
      sizeKbIn: "الإدخال: {size} KB",
      sizeKbOut: "الناتج: {size} KB",
      imagesLoadedOne: "تم تحميل {count} صورة",
      imagesLoadedOther: "تم تحميل {count} صور",
      bestForImages: "الأنسب لـ {count} صور",
      inputTotalKb: "إجمالي المدخلات: {size} KB",
      collageKb: "الصورة المجمّعة: {size} KB",
      collageCell: "خلية الصورة المجمّعة {index}",
      fitEntireImage: "ملاءمة الصورة كاملة",
      fillCell: "ملء الخلية",
      submitWithCount: "إنشاء صورة مجمّعة ({count} صور)",
      templateTitle: "{label} ({count} صور)",
      template: "القالب",
      aspectRatio: "نسبة الأبعاد",
      gap: "الفجوة",
      cornerRadius: "نصف قطر الزوايا",
    ...
    stitch: {
      ...
      stitching: "جاري الدمج...",
      downloadStitchedImage: "تحميل الصورة المدموجة",
      uploadingPercent: "جاري الرفع... {percent}%",
      submitCount: "دمج {count} صور",
      direction: "الاتجاه",
      horizontal: "أفقي",
      vertical: "عمودي",
      grid: "شبكة",
    ...
    split: {
      ...
      tileWidthPx: "عرض المربع (px)",
      tileHeightPx: "ارتفاع المربع (px)",
      splitting: "جاري التقسيم...",
      downloadAllAsZip: "تحميل الكل (ZIP)",
      imageGridSummary: "الصورة: {width}x{height}px. الشبكة: {cols}x{rows} = {count} مربعات",
      gridSummary: "{cols}x{rows} = {count} مربعات",
      tileDimsEach: "~{width}x{height}px لكل مربع",
      submitBatch: "تقسيم {count} صور ({tiles} مربعات لكل صورة)",
      splitIntoTiles: "التقسيم إلى {count} مربعات",
      imagesSplitSummary: "تم تقسيم {count} صور ({tiles} مربعات لكل صورة)",
      tilesGenerated: "تم إنشاء {count} مربعات",
      downloadTile: "تحميل المربع {label}",
      tileAlt: "المربع {label}",
      modeGrid: "شبكة",
      ...
      tileWarningSmall: "ستكون المربعات صغيرة جدًا ({width}x{height}px)",
    },
    border: {
      blur: "تمويه",
      opacity: "الشفافية",
      ...
      applyingBorder: "جاري تطبيق الحدود",
      applyBorder: "تطبيق الحدود",
      applyBorderBatch: "تطبيق الحدود ({count} ملف)",
      presets: "قوالب جاهزة",
    ...
    beautify: {
      ...
      yourWatermarkText: "نص علامتك المائية",
      processing: "جاري المعالجة...",
      frameLabel: "إطار {label}",
      preset: "القالب",
      backgroundType: "نوع الخلفية",
      solidColor: "لون صلب",
    ...
    "circle-crop": {
      ...
      transparent: "شفاف",
      color: "ملون",
      dragThePreviewToReposition: "اسحب المعاينة لتغيير الموضع",
      zoom: "التكبير",
      borderColor: "لون الحدود",
      outputSizePx: "حجم الإخراج (px)",
      submit: "اقتصاص دائري",
    ...
    pixelate: {
      ...
      selection: "التحديد",
      wholeHint: "تُطبَّق البكسلة على الصورة كاملة",
      width: "العرض",
      height: "الارتفاع",
      dragHint: "اسحب مربع التحديد على الصورة لتغيير موضعه",
      submit: "بكسلة",
    ...
    "gif-webp": {
      ...
      convertsGifToWebpAnd:
        "يحوّل GIF إلى WebP وWebP إلى GIF مع الحفاظ على جميع إطارات الرسوم المتحركة. يُحدَّد الاتجاه تلقائيًا حسب صيغة الملف المدخل.",
      lossy: "مع فقدان",
      lossless: "بدون فقدان",
      submit: "تحويل",
    ...
    histogram: {
      generatesAnRgbHistogramChart: "يُنشئ مخططًا بيانيًا RGB يعرض توزيع الألوان في الصورة.",
      histogramChart: "المخطط البياني",
    ...
    "sprite-sheet": {
      ...
      copyJson: "نسخ JSON",
      sheetSummary:
        "شبكة {cols} x {rows} · خلايا {cellWidth} x {cellHeight}px · لوحة {canvasWidth} x {canvasHeight}px",
      columns: "الأعمدة",
      padding: "الحشو",
    ...
    "svg-to-raster": {
      ...
      auto: "تلقائي",
      format: "الصيغة",
      svgDimensions: "أبعاد SVG",
      couldNotDetectDimensionsUsing: "تعذر اكتشاف الأبعاد. سيتم استخدام حجم مخصص.",
      renderDpi: "دقة التصيير (DPI)",
      progressLabelBatch: "جاري تحويل {count} ملفات",
      outputFormat: "صيغة الإخراج",
      sizing: "التحجيم",
      scaleMode: "مقياس",
      customMode: "مخصص",
    ...
    vectorize: {
      ...
      fewerColors: "ألوان أقل",
      moreColors: "ألوان أكثر",
      gradientStep: "خطوة التدرج",
      smoothGradients: "تدرجات سلسة",
      flatColors: "ألوان مسطحة",
      moreWhite: "أبيض أكثر",
      moreBlack: "أسود أكثر",
      moreCorners: "زوايا أكثر",
      smoother: "أكثر نعومة",
      invertColors2: "عكس الألوان",
    ...
    "gif-tools": {
      ...
      horizontal: "أفقي",
      vertical: "عمودي",
      readingGifMetadata: "جاري قراءة بيانات GIF الوصفية...",
      staticImage: "صورة ثابتة",
      pixels: "بكسل",
      fewerColorsSmallerFile: "ألوان أقل = ملف أصغر",
      higherEffortSlowerButSmaller: "جهد أعلى = أبطأ لكن أصغر",
      reversesThePlaybackOrderOf: "يعكس ترتيب تشغيل جميع الإطارات.",
      alsoAdjustSpeed: "تعديل السرعة أيضًا",
      loop: "التكرار",
      originalKb: "الأصلي: {size} KB",
      processedKb: "المعالج: {size} KB",
      framesCount: "{count} إطارات",
      frameRangeHint: "من 0 إلى {max} (0 هو الإطار الأول)",
      extractsAllFrames: "يستخرج جميع الإطارات ({count}) كصور منفصلة في ملف ZIP.",
      requiresAnimatedGif: "يتطلب GIF متحركًا",
      unlockAspectRatio: "إلغاء قفل نسبة الأبعاد",
      lockAspectRatio: "قفل نسبة الأبعاد",
      mode: "الوضع",
      resize: "تغيير الحجم",
      optimize: "تحسين",
      speed: "السرعة",
    ...
    "image-to-base64": {
      converting: "جاري التحويل...",
      outputImageFormat: "صيغة صورة الإخراج",
      convertBeforeEncodingToControl: "حوّل قبل الترميز للتحكم في نوع MIME والحجم",
      lowerQualitySmallerBase64String: "جودة أقل = سلسلة base64 أصغر",
      maxWidthPx: "العرض الأقصى (px)",
      t0NoLimit: "0 = بدون حد",
      maxHeightPx: "الارتفاع الأقصى (px)",
      resizeBeforeEncodingAspectRatio:
        "تغيير الحجم قبل الترميز مع الحفاظ على نسبة الأبعاد. 0 = بدون حد.",
      submitWithCount: "تحويل إلى Base64 ({count})",
      outputFormat: "صيغة الإخراج",
    ...
    "barcode-generate": {
      enterTextOrNumber: "أدخل نصًا أو رقمًا...",
      generatedBarcode: "الباركود المُنشأ",
      text: "النص",
      type: "نوع الباركود",
      scale: "المقياس",
    ...
    "chart-maker": {
      optionalChartTitle: "عنوان الرسم البياني (اختياري)",
    ...
    "trim-video": {
      endTimeMustBeAfter: "يجب أن يكون وقت النهاية بعد وقت البداية",
      start: "البداية (ثوانٍ)",
      end: "النهاية (ثوانٍ)",
    ...
    "images-to-video": {
      square1080x1080: "مربع (1080x1080)",
  ...
  urlImport: {
    ...
    placeholder: "الصق روابط الملفات، رابط واحد في كل سطر...",
    ...
    failedStatus: "فشل",
    textareaPlaceholder:
      "https://example.com/photo.jpg\nhttps://example.com/report.pdf\n- https://example.com/clip.mp4\n[ملفي](https://example.com/recording.mp3)",
  },
  comparison: {
    original: "الأصلي",
    processed: "المعالج",
    ...
    after: "بعد",
    savings: "التوفير",
    originalSize: "الأصلي: {size}",
    processedSize: "المعالج: {size}",
    smallerBadge: "({percent}% أصغر)",
    largerBadge: "({percent}% أكبر)",
  },
  toolPage: {
    ...
    libraryOverwrite: "استبدال الملف الأصلي",
    libraryOverwriteHint: "تحل النتيجة محل الملف الأصلي في ملفاتك",
    viewInFiles: "عرض في الملفات",
  ...
  editor: {
    ...
    options: {
      ...
      cloneStamp: {
        aligned: "محاذاة",
        altClickHint: "Alt+نقر لتحديد المصدر",
      },
      crop: {
        ratioLabel: "النسبة:",
        applyTitle: "تطبيق القص (Enter)",
        cancelTitle: "إلغاء القص (Escape)",
      },
      dodgeBurn: {
        dodge: "تفتيح",
        burn: "تعتيم",
      ...
      move: {
        ...
        alignCenterHorizontal: "توسيط أفقي",
        alignRight: "محاذاة لليمين",
        alignTop: "محاذاة للأعلى",
        alignCenterVertical: "توسيط عمودي",
        alignBottom: "محاذاة للأسفل",
        distributeLabel: "التوزيع:",
      ...
      selection: {
        typeLabel: "النوع:",
        rectangular: "تحديد مستطيل",
        rectShort: "مستطيل",
        elliptical: "تحديد بيضاوي",
        ellipseShort: "بيضاوي",
        lasso: "لاسو",
        magicWand: "العصا السحرية",
        modeLabel: "الوضع:",
        newSelection: "تحديد جديد",
        newShort: "جديد",
        addToSelection: "إضافة للتحديد",
        addShort: "إضافة",
        subtractFromSelection: "طرح من التحديد",
        subtractShort: "طرح",
        freehandLasso: "لاسو حر",
        freehandShort: "حر",
      ...
      text: {
        ...
        switchToPointText: "التبديل إلى نص نقطي",
        switchToAreaText: "التبديل إلى نص منطقة",
        area: "منطقة",
        point: "نقطي",
      },
      transform: {
    ...
    panels: {
      adjustments: {
        ...
        levelsOutBlack: "أسود الإخراج",
        levelsOutWhite: "أبيض الإخراج",
        presetCustom: "مخصص",
        curvesHint: "انقر لإضافة نقطة. اسحب للتحريك. انقر نقرًا مزدوجًا للحذف.",
        sectionFilters: "المرشحات",
        sectionBlurEffects: "تأثيرات التمويه",
        sectionEffects: "التأثيرات",
      ...
      color: {
        channelAriaLabel: "قناة اللون {channel}",
        recent: "الأخيرة",
        swapColorsTitle: "تبديل الألوان (X)",
        resetColorsTitle: "إعادة تعيين الألوان (D)",
        foreground: "المقدمة",
      },
      histogram: {
        noData: "لا توجد بيانات للمخطط البياني",
        mean: "المتوسط",
        stdDev: "الانحراف",
        median: "الوسيط",
      },
      ...
      layers: {
        ...
        unlockLayer: "إلغاء قفل الطبقة",
        thumbnailAlt: "صورة مصغّرة لـ {name}",
        effects: {
          heading: "تأثيرات الطبقة",
          dropShadow: "ظل مسقط",
          innerShadow: "ظل داخلي",
          outerGlow: "توهج خارجي",
          stroke: "حد",
          collapseAria: "طي {label}",
          expandAria: "توسيع {label}",
          color: "اللون",
          opacity: "الشفافية",
          angle: "الزاوية",
          distance: "المسافة",
          ...
          positionInside: "داخل",
          positionCenter: "وسط",
          positionOutside: "خارج",
        },
      },
      navigator: {
        noImageLoaded: "لم يتم تحميل صورة",
      },
    },
    ui: {
      widthPx: "العرض (px)",
      ...
      canvasResize: {
        heading: "حجم اللوحة",
        current: "الحالي: {width} x {height} px",
        anchorLabel: "نقطة الارتكاز:",
        anchorAriaLabel: "ارتكاز {position}",
      ...
      imageResize: {
        heading: "حجم الصورة",
        original: "الأصلي: {width} x {height} px",
        note: "يُغيَّر حجم جميع العناصر بالتناسب مع الأبعاد الجديدة.",
      },
      exportDialog: {
        heading: "تصدير الصورة",
        previewAlt: "معاينة التصدير",
        format: "الصيغة",
        quality: "الجودة",
        dimensions: "الأبعاد",
        width: "العرض",
        height: "الارتفاع",
        resetToOriginalSize: "إعادة الحجم الأصلي ({width} x {height})",
      ...
      autosaveRecovery: {
        message: "تم استرجاع عمل غير محفوظ من {time}.",
        restore: "استرجاع",
        discard: "تجاهل",
      },
      fillDialog: {
        heading: "تعبئة",
        contentsLabel: "المحتوى",
        customColor: "لون مخصص",
        opacity: "الشفافية",
        previewLabel: "معاينة:",
        contents: {
      ...
      colorSwatch: {
        ariaLabel: "اللون {color}",
      },
      shapeColorPicker: {
        ariaLabel: "منتقي لون {label}",
        noneSelected: "{label}: بدون",
        setNone: "بدون {label}",
      },
    },
  },
  settings: {
    ...
    tools: {
      ...
      disabledCountOne: "{count} أداة معطلة",
      disabledCountOther: "{count} أدوات معطلة",
    },
    experimental: {
    ...
    aiFeatures: {
      ...
      importDescription: "استورد وقت تشغيل OCR موقّعًا أو حزمة AI قديمة للاستخدام دون اتصال.",
      importButton: "استيراد من ملف",
      importing: "جارٍ الاستيراد...",
      importSuccess: "تم استيراد الحزمة بنجاح.",
      importError: "فشل استيراد الحزمة: {error}",
      importType: "نوع الحزمة",
      importOcr: "حزمة OCR الدقيقة",
      importLegacy: "حزمة AI القديمة",
      importOcrIndex: "فهرس OCR الموقّع (.json)",
      importOcrArchive: "أرشيف وقت تشغيل OCR (.tar.gz)",
      importLegacyArchive: "أرشيف الحزمة القديمة (.tar.gz)",
  ...
  reviewPanel: {
    ...
    downloadAllZipSize: "تحميل الكل (ZIP، {size})",
    downloadFilesZipSize: "تحميل {count} ملفات (ZIP، {size})",
    downloadTypeSize: "تحميل {type} ({size})",
  },
  features: {
  ...
  appLayout: {
    ...
    aiInstall: {
      installingBundle: "جارٍ تثبيت {name}",
      defaultBundleName: "ميزة AI",
      bundlesInstalled: "تم تثبيت {completed}/{total}",
      bundlesQueued: "{count} في الانتظار",
    },
  },
  a11y: {
  ...
  commonUi: {
    ...
    metadataGrid: {
      ...
      restoreField: "استعادة {field}",
      removeField: "إزالة {field}",
    },
    multiImageViewer: {
      cannotPreview: "لا يمكن معاينة ملفات {ext} في المتصفح.",
    },
    waveform: {
      play: "تشغيل",
      pause: "إيقاف مؤقت",
  ...
  privacyPolicy: {
    ...
    overview: {
      heading: "نظرة عامة",
      body: "SnapOtter تطبيق مفتوح المصدر لمعالجة الملفات يعمل بالاستضافة الذاتية. المثيل الخاص بك يشغّله ويتحكم فيه بالكامل من نشره. وتوضّح هذه السياسة كيف يتعامل البرنامج نفسه مع بياناتك.",
    },
    localProcessing: {
      heading: "المعالجة المحلية",
      body: "تجري معالجة الملفات بالكامل على الخادم الذي نُشر عليه SnapOtter. ولا تُرسَل ملفاتك أبدًا إلى خدمات خارجية أو واجهات برمجة تابعة لجهات أخرى. وعندما ترفع ملفًا للمعالجة، يُعالَج في الذاكرة أو في تخزين مؤقت على الجهاز المضيف، ولا يُحتفظ به بعد انتهاء العملية.",
    },
    analytics: {
      heading: "التحليلات",
      body: "يتضمن SnapOtter تحليلات أساسية (استخدام الأدوات وتقارير الأخطاء) للمساعدة في تحسين البرنامج. ولا تشمل هذه التحليلات ملفاتك ولا أسماء ملفاتك ولا بياناتك الشخصية. التحليلات مفعّلة افتراضيًا ويمكن تعطيلها أثناء التشغيل. يستطيع المسؤول إيقاف تحليلات المنتج المجهولة من الإعدادات > النظام > {privacy}، دون الحاجة إلى إعادة تشغيل أو إعادة بناء. وللإيقاف التام عند البناء، ابنِ باستخدام {code}، فيُزال من الحزمة كليًا. ويعمل كل شيء بشكل طبيعي بدونه.",
      feedbackBody:
        "يتضمن SnapOtter أيضًا طلبات ملاحظات اختيارية. لا تُرسَل الملاحظات إلا عندما ترسلها بنفسك، وفقط عندما تكون التحليلات مفعّلة. وتذهب أحداث الملاحظات إلى PostHog باسم {code}. ولا يُرسَل اسم جهة الاتصال والبريد الإلكتروني والشركة إلا إذا فعّلت خانة الإذن بالتواصل. ولا يُرفق SnapOtter بالملاحظات أي ملفات أو أسماء ملفات أو مسارات رفع أو مخرجات OCR والنسخ الصوتي أو نصوص مستندات خاصة أو سجلات أخطاء خام.",
    },
    dataStorage: {
      heading: "تخزين البيانات",
      body: "إذا كانت المصادقة مفعّلة، يخزّن التطبيق حسابات المستخدمين (أسماء المستخدمين وكلمات المرور المجزّأة) في قاعدة بيانات PostgreSQL على الجهاز المضيف. وإذا استخدمت ميزة الملفات، تُخزَّن الملفات المرفوعة على نظام ملفات الخادم. وتبقى جميع البيانات المخزَّنة تحت سيطرة مشغّل المثيل بالكامل.",
    },
    thirdParty: {
      heading: "خدمات الجهات الخارجية",
      body: "تجري كل المعالجة محليًا؛ ولا تُرسَل ملفاتك إلى أي مكان. وتحليلات الاستخدام المجهولة مدعومة بـ PostHog وSentry كما هو موضّح أعلاه. وتعمل الميزات المعتمدة على الذكاء الاصطناعي محليًا باستخدام نماذج مضمّنة. ولا يجري الاتصال بأي خدمات خارجية أخرى.",
    },
    openSource: {
      heading: "مفتوح المصدر",
      body: "SnapOtter مفتوح المصدر بالكامل. يمكنك تدقيق الشيفرة المصدرية للتحقق من هذا في أي وقت. الشفافية مبدأ أساسي في هذا المشروع.",
    },
    yourControl: {
      heading: "تحكّمك",
      body: "لأن SnapOtter يعمل بالاستضافة الذاتية، يملك مشغّل المثيل تحكمًا كاملًا في جميع البيانات. يمكنك حذف بياناتك في أي وقت بإزالة الملفات من الخادم أو بحذف قاعدة البيانات. ولا توجد أي بيانات خارج بنيتك التحتية.",
    },
  },
} as const;
