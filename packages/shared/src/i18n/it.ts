...
export const it: TranslationKeys = {
  ...
  toolPage: {
    ...
    previousImage: "File precedente",
    nextImage: "File successivo",
    imageCounter: "{current} / {total}",
    settingsLabel: "Impostazioni",
    downloadAllZip: "Scarica tutto (ZIP)",
    hideSettings: "Nascondi impostazioni",
    imageArea: "Area anteprima",
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "I tuoi file non lasciano mai il tuo dispositivo.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Una suite di manipolazione file self-hosted e orientata alla privacy, con 157 strumenti per immagini, video, audio, PDF e dati. Elabora, converti, comprimi e automatizza i tuoi flussi di lavoro senza inviare dati al cloud.",
  ...
  auth: {
    ...
    heroSubtitle: "Tutti gli strumenti per i file di cui hai bisogno.",
    rotatingPhrases: [
      ...
      "Si installa in pochi minuti con Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Le statistiche d'uso anonime ci aiutano a correggere bug e creare gli strumenti di cui hai davvero bisogno. I tuoi file restano sul tuo dispositivo.",
    ...
    settingsPrivacy: "I tuoi file non lasciano mai il tuo dispositivo.",
  ...
  a11y: {
    ...
    nextImage: "File successivo",
    imageArea: "Area anteprima",
    imageViewer: "Visualizzatore file",
    fileDropZone: "Zona di rilascio file",
    imageDropZone: "Zona di rilascio file",
    beforeAfterSlider: "Cursore confronto prima/dopo",
    imageControls: "Controlli anteprima",
