...
export const it: TranslationKeys = {
  ...
  feedback: {
    ...
    messagePlaceholder: "Dicci cosa ha funzionato, cosa si è rotto o cosa potrebbe migliorare SnapOtter.",
    ...
    thanksDescription: "Ci aiuta a migliorare SnapOtter senza raccogliere file o contenuti privati.",
