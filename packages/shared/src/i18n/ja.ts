...
export const ja: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "ファイルがお使いのマシンから外に出ることはありません。",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "セルフホスト型、プライバシー第一のファイル操作スイート。画像・動画・音声・PDF・データ対応の157ツールを搭載。処理、変換、圧縮など、ファイルワークフローをクラウドにデータを送ることなく自動化できます。",
      versionLabel: "バージョン：",
      linksHeading: "リンク",
  ...
  auth: {
    ...
    heroSubtitle: "必要なすべてのファイルツールがここに。",
    rotatingPhrases: [
      "登録不要。アカウント不要。",
      "クラウドへのアップロードは一切なし。",
      "100%ローカル処理。",
      ...
      "バッチ処理も無制限。",
      "157のツールを搭載。",
      "19のAIモデル。あなたのハードウェアで。",
      "Sharp搭載で超高速処理。",
      "エアギャップ環境にも対応。",
      "Docker Composeスタックで完結。",
      "オープンソース。いつまでも。",
      "すべてのピクセルがあなたのハードウェアに。",
      "あなたのサーバー。あなたのルール。",
      "Docker Composeで数分でデプロイ完了。",
      "セルフホストという選択肢。",
      "リサイズも圧縮も変換もローカルで。",
      "無料の画像エディター。透かしなし。",
      "バッチファイル処理を無制限で。",
  ...
  analytics: {
    ...
    consentDescription:
      "匿名の使用データはバグ修正や本当に必要なツールの開発に役立ちます。ファイルがお使いのマシンから外に出ることはありません。",
    ...
    settingsPrivacy: "ファイルがお使いのマシンから外に出ることはありません。",
  ...
  a11y: {
    ...
    nextImage: "次のファイル",
    imageArea: "プレビューエリア",
    imageViewer: "ファイルビューアー",
    fileDropZone: "File drop zone",
    imageDropZone: "ファイルドロップゾーン",
    beforeAfterSlider: "Before/after comparison slider",
    imageControls: "プレビューコントロール",
