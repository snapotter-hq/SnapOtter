...
export const hi: TranslationKeys = {
  ...
  toolSettings: {
    "signature-pad": {
      signaturePreview: "हस्ताक्षर प्रीव्यू",
    },
    "pipeline-step": {
      noConfigurableSettingsDefaultsWill: "कोई कॉन्फ़िगर करने योग्य सेटिंग्स नहीं। डिफ़ॉल्ट का उपयोग होगा।",
    },
    "html-to-image-results": {
      capturedScreenshot: "कैप्चर किया गया स्क्रीनशॉट",
    },
    "eraser-canvas": {
      paintOverObjectsToErase: "मिटाने के लिए ऑब्जेक्ट पर पेंट करें",
    },
    "crop-canvas": {
      original: "मूल:",
      cropPreview: "क्रॉप प्रीव्यू",
      cropRegionSize: "क्रॉप क्षेत्र: {width} x {height}",
      originalSize: "मूल: {width} x {height}",
    },
    "image-to-base64-results": {
      ...
      completedOfTotalFiles: "{total} में से {completed} फाइलें",
      convertedOfTotal: "{total} में से {done} कन्वर्ट हुईं",
      preview: "प्रीव्यू",
      filesReadyClickConvert: '{count} फाइलें तैयार हैं। शुरू करने के लिए "Base64 में कन्वर्ट करें" पर क्लिक करें।',
      clickConvertToConvert: 'कन्वर्ट करने के लिए "Base64 में कन्वर्ट करें" पर क्लिक करें।',
      convertedOfTotalWithFailed: "{total} में से {done} कन्वर्ट हुईं, {count} विफल",
      tabDataUri: "Data URI",
      tabRawBase64: "रॉ Base64",
      startingConversion: "कन्वर्ज़न शुरू हो रहा है...",
      uploadImagesAndClickConvert: 'शुरू करने के लिए इमेज अपलोड करें और "Base64 में कन्वर्ट करें" पर क्लिक करें।',
      copyAllAsJson: "सभी JSON के रूप में कॉपी करें",
      downloadAllAsJson: "सभी JSON के रूप में डाउनलोड करें",
      downloadAllAsText: "सभी टेक्स्ट के रूप में डाउनलोड करें",
      noResultForThisFile: "इस फाइल के लिए कोई परिणाम नहीं। हो सकता है यह अभी प्रोसेस न हुई हो।",
    },
    "split-canvas": {
      loadingPreview: "प्रीव्यू लोड हो रहा है...",
      splitGridOverlay: "स्प्लिट ग्रिड ओवरले",
      infoBar: "{width} x {height}px . {cols}x{rows} ग्रिड . {count} टाइल",
    },
    "remove-bg": {
      original: "मूल:",
      ...
      to: "से",
      endColor: "अंतिम रंग",
      originalKb: "मूल: {size} KB",
      processedKb: "प्रोसेस्ड: {size} KB",
    },
    "ocr-pdf-view": {
      extractedText: "निकाला गया टेक्स्ट",
      copied: "कॉपी किया गया",
      loadingExtractedText: "निकाला गया टेक्स्ट लोड हो रहा है...",
      noTextFound: "(कोई टेक्स्ट नहीं मिला)",
      extractingText: "टेक्स्ट निकाला जा रहा है...",
      theExtractedTextWillAppear: "OCR चलाने के बाद निकाला गया टेक्स्ट यहां दिखाई देगा।",
    },
    "image-enhancement": {
      original: "मूल:",
      removesNoiseAndArtifactsUsing: "AI का उपयोग करके नॉइज़ और आर्टिफैक्ट हटाता है",
      analyzingImage: "इमेज का विश्लेषण हो रहा है...",
      imageLooksGoodFineTune: "इमेज अच्छी दिखती है। तीव्रता स्लाइडर से फाइन-ट्यून करें।",
      deepEnhance: "डीप एन्हांस",
      enhance: "एन्हांस करें",
      sharpenFilter: "शार्पन फिल्टर",
      whiteBalanceTemperatureFilter: "व्हाइट बैलेंस टेम्परेचर फिल्टर",
      originalSizeKb: "मूल: {size} KB",
      enhancedSizeKb: "एन्हांस्ड: {size} KB",
    },
    "find-duplicates-results": {
      ...
      duplicateGroups: "डुप्लीकेट ग्रुप:",
      unique: "यूनिक:",
      spaceSaveable: "बचाई जा सकने वाली जगह:",
      noDuplicatesFound: "कोई डुप्लीकेट नहीं मिला",
      noPreview: "कोई प्रीव्यू नहीं",
      backToOverview: "ओवरव्यू पर वापस",
      fileSize: "फाइल साइज़",
      similarity: "समानता",
      scanningForDuplicates: "डुप्लीकेट स्कैन हो रहे हैं...",
      chooseADetectionModeAnd: 'डुप्लीकेट खोजने के लिए डिटेक्शन मोड चुनें और "स्कैन" पर क्लिक करें।',
      allImagesUnique: "सभी {count} इमेज यूनिक हैं।",
      percentSimilar: "{percent}% समान",
      imagesClickToCompare: "{count} इमेज · तुलना के लिए क्लिक करें ›",
      groupOf: "{total} में से ग्रुप {current}",
      showingAllImagesInGroup:
        'इस ग्रुप की सभी {count} इमेज दिखाई जा रही हैं। किसी इमेज को "सर्वोत्तम" सेट करने के लिए उस पर क्लिक करें।',
      selectedAsBest: "सर्वोत्तम के रूप में चयनित",
      clickToMarkAsBest: "सर्वोत्तम चिह्नित करने के लिए क्लिक करें",
    },
    "conversion-preset": {
      quality: "क्वालिटी",
      high: "उच्च",
    ...
    color: {
      ...
      adjustingColors: "रंग समायोजित हो रहे हैं",
      apply: "लागू करें",
      temperatureAndTintColorFilter: "टेम्परेचर और टिंट कलर फिल्टर",
      colorChannelFilter: "कलर चैनल फिल्टर",
      sharpenFilter: "शार्पन फिल्टर",
      originalKb: "मूल: {size} KB",
      processedKb: "प्रोसेस्ड: {size} KB",
    ...
    crop: {
      ...
      widthPx: "चौड़ाई (px)",
      heightPx: "ऊंचाई (px)",
      swapWidthHeight: "चौड़ाई/ऊंचाई आपस में बदलें",
      required: "आवश्यक",
      widthOfMax: "चौड़ाई ({max} में से)",
      heightOfMax: "ऊंचाई ({max} में से)",
      x: "X",
      xOfMax: "X ({max} में से)",
      y: "Y",
      yOfMax: "Y ({max} में से)",
    ...
    rotate: {
      rotate90CounterClockwise: "90° घड़ी की विपरीत दिशा में घुमाएं",
      rotate180: "180° घुमाएं",
      rotate90Clockwise: "90° घड़ी की दिशा में घुमाएं",
      decrease1: "1° घटाएं",
      increase1: "1° बढ़ाएं",
      rotate: "रोटेट",
      angle: "कोण",
    ...
    convert: {
      original: "मूल:",
      originalSizeKb: "मूल: {size} KB",
      processedSizeKb: "प्रोसेस्ड: {size} KB",
    ...
    "strip-metadata": {
      original: "मूल:",
      iccProfile: "ICC डेटा",
      originalSize: "मूल: {size} KB",
      processedSize: "प्रोसेस्ड: {size} KB",
      fieldsCount: "{count} फील्ड",
      locationCoords: "लोकेशन डेटा: {lat}, {lon}",
    ...
    "edit-metadata": {
      original: "मूल:",
      imageDescription: "इमेज का विवरण",
      photographerCreatorName: "फोटोग्राफर / निर्माता का नाम",
      imageTitle: "इमेज का शीर्षक",
      shortHeadline: "छोटा मुख्य शीर्षक",
      cityName: "शहर का नाम",
      stateOrProvince: "राज्य या प्रांत",
      countryName: "देश का नाम",
      saveCurrentValuesAsTemplate: "मौजूदा मान टेम्प्लेट के रूप में सहेजें",
      gpsCleared2: ", GPS साफ किया गया",
      gpsAdded2: ", GPS जोड़ा गया",
      datesShifted2: ", तारीखें शिफ्ट की गईं",
      originalSizeKb: "मूल: {size} KB",
      processedSizeKb: "प्रोसेस्ड: {size} KB",
      readingMetadata: "मेटाडेटा पढ़ा जा रहा है...",
    ...
    "image-to-pdf": {
      preview: "प्रीव्यू",
      targetMetWithQuality: "टार्गेट पूरा हुआ (JPEG क्वालिटी: {quality}%)",
    ...
    "pdf-to-image": {
      converting2: "कन्वर्ट हो रहा है",
      page: "पेज",
      custom: "कस्टम",
      uploadAPdfToGet: "शुरू करने के लिए एक PDF अपलोड करें",
      generatingPagePreviews: "पेज प्रीव्यू बन रहे हैं...",
      selectAll: "सभी चुनें",
      deselectAll: "सभी का चयन हटाएं",
      convertingSelected: "{count} पेज कन्वर्ट हो रहा है...",
      convertingSelectedPlural: "{count} पेज कन्वर्ट हो रहे हैं...",
      pagesConverted: "{count} पेज कन्वर्ट हुआ",
      pagesConvertedPlural: "{count} पेज कन्वर्ट हुए",
      selectedOfPages: "{total} में से {selected} पेज चुना गया",
      selectedOfPagesPlural: "{total} में से {selected} पेज चुने गए",
      pageAlt: "पेज {page}",
    ...
    favicon: {
      ...
      themeColor: "थीम कलर",
      themeColor2: "थीम कलर",
      usedInManifestJsonFor: "ब्राउज़र UI के लिए manifest.json में उपयोग होता है",
      uploadHint:
    ...
    ocr: {
      ...
      enhanceHint:
        "पहचान से पहले स्थानीय कॉन्ट्रास्ट सुधारता है। तेज़ मोड इसे सीधे लागू करता है; संतुलित और सर्वोत्तम मोड इसे तभी रखते हैं जब कैलिब्रेटेड स्कोर परिणाम सुधारता है।",
      fastKoreanUnsupported:
        "तेज़ OCR कोरियाई का समर्थन नहीं करता। सटीक OCR पैक इंस्टॉल करें और संतुलित या सर्वोत्तम चुनें।",
      language: "भाषा",
    ...
    "enhance-faces": {
      ...
      fewerFaces: "कम चेहरे",
      moreFaces: "अधिक चेहरे",
      onlyEnhanceMainFace: "केवल मुख्य चेहरा एन्हांस करें",
      forPortraitsIgnoresBackgroundFaces: "पोर्ट्रेट के लिए: बैकग्राउंड के चेहरों को अनदेखा करता है",
      originalSizeKb: "मूल: {size} KB",
      enhancedSizeKb: "एन्हांस्ड: {size} KB",
    ...
    "smart-crop": {
      ...
      detectionSensitivity: "डिटेक्शन सेंसिटिविटी",
      moreFaces: "अधिक चेहरे",
      swapWidthAndHeight: "चौड़ाई और ऊंचाई आपस में बदलें",
      smartCropping: "स्मार्ट क्रॉपिंग",
      submitSubjectBatch: "स्मार्ट क्रॉप ({count} फाइलें)",
      submitFaceBatch: "फेस क्रॉप ({count} फाइलें)",
      submitTrimBatch: "बॉर्डर ट्रिम ({count} फाइलें)",
    ...
    "passport-photo": {
      ...
      docUS: "अमेरिकी पासपोर्ट",
      countryCA: "कनाडा",
      docCA: "कनाडाई पासपोर्ट",
      countryBR: "ब्राज़ील",
      docBR: "ब्राज़ीलियाई पासपोर्ट",
      countryMX: "मेक्सिको",
      docMX: "मेक्सिकन पासपोर्ट",
      countryGB: "यूनाइटेड किंगडम",
      docGB: "ब्रिटिश पासपोर्ट",
      countryEU: "यूरोपीय संघ",
      docEU: "EU पासपोर्ट (ICAO)",
      countryDE: "जर्मनी",
      docDE: "जर्मन पासपोर्ट",
      countryFR: "फ़्रांस",
      docFR: "फ़्रांसीसी पासपोर्ट",
      countryRU: "रूस",
      docRU: "रूसी पासपोर्ट",
      countryTR: "तुर्की",
      docTR: "तुर्की पासपोर्ट",
      countryIE: "आयरलैंड",
      docIE: "आयरिश पासपोर्ट",
      countryIT: "इटली",
      docIT: "इतालवी पासपोर्ट",
      countryES: "स्पेन",
      docES: "स्पेनिश पासपोर्ट",
      countryNL: "नीदरलैंड",
      docNL: "डच पासपोर्ट",
      countryPL: "पोलैंड",
      docPL: "पोलिश पासपोर्ट",
      countrySE: "स्वीडन",
      docSE: "स्वीडिश पासपोर्ट",
      countryIN: "भारत",
      docIN: "भारतीय पासपोर्ट",
      countryCN: "चीन",
      docCN: "चीनी पासपोर्ट",
      countryJP: "जापान",
      docJP: "जापानी पासपोर्ट",
      countryKR: "दक्षिण कोरिया",
      docKR: "कोरियाई पासपोर्ट",
      countryTH: "थाईलैंड",
      docTH: "थाई पासपोर्ट",
      countryPH: "फ़िलीपींस",
      docPH: "फ़िलीपीनी पासपोर्ट",
      countryID: "इंडोनेशिया",
      docID: "इंडोनेशियाई पासपोर्ट",
      countrySG: "सिंगापुर",
      docSG: "सिंगापुर पासपोर्ट",
      countryMY: "मलेशिया",
      docMY: "मलेशियाई पासपोर्ट",
      countryVN: "वियतनाम",
      docVN: "वियतनामी पासपोर्ट",
      countryPK: "पाकिस्तान",
      docPK: "पाकिस्तानी पासपोर्ट",
      countryBD: "बांग्लादेश",
      docBD: "बांग्लादेशी पासपोर्ट",
      countryAU: "ऑस्ट्रेलिया",
      docAU: "ऑस्ट्रेलियाई पासपोर्ट",
      countryNZ: "न्यूज़ीलैंड",
      docNZ: "न्यूज़ीलैंड पासपोर्ट",
      countrySA: "सऊदी अरब",
      docSA: "सऊदी पासपोर्ट",
      countryAE: "संयुक्त अरब अमीरात",
      docAE: "UAE पासपोर्ट",
      countryNG: "नाइजीरिया",
      docNG: "नाइजीरियाई पासपोर्ट",
      countryEG: "मिस्र",
      docEG: "मिस्री पासपोर्ट",
      countryZA: "दक्षिण अफ़्रीका",
      docZA: "दक्षिण अफ़्रीकी पासपोर्ट",
      countryCUSTOM: "कस्टम",
      docCUSTOM: "कस्टम",
      width: "चौड़ाई",
      height: "ऊँचाई",
      maxFileSize2: "अधिकतम फाइल साइज़:",
      analyzingFace: "चेहरे का विश्लेषण हो रहा है",
      resetTo100: "100% पर रीसेट करें",
      dimensionsSummary: "{width}x{height}mm ({pxWidth}x{pxHeight}px) {dpi} DPI पर",
      faceCenteredDetail: "चेहरा केंद्र में नहीं है। फोटो क्रॉप करें या उसकी स्थिति बदलें।",
      headLevelDetail: "सिर झुका हुआ है। सिर सीधा करें या फोटो घुमाएं।",
      lookingStraightDetail: "चेहरा एक ओर मुड़ा हुआ है। सीधे कैमरे की ओर देखें।",
      faceSizeDetail: "चेहरा बहुत छोटा है। कैमरे के करीब आएं या क्रॉप को टाइट करें।",
      regionAmericas: "उत्तर व दक्षिण अमेरिका",
      regionEurope: "यूरोप",
      regionAsia: "एशिया",
      regionMiddleEast: "मध्य पूर्व",
      regionAfrica: "अफ़्रीका",
      regionOceania: "ओशिआनिया",
      bgWhite: "सफ़ेद",
      bgOffWhite: "ऑफ-व्हाइट",
      bgLightGray: "हल्का ग्रे (UK/DE)",
      bgLightBlue: "हल्का नीला (FR)",
      bgRed: "लाल (ID)",
      detectingLandmarksShort: "लैंडमार्क डिटेक्ट हो रहे हैं...",
      country: "देश",
    ...
    "transparency-fixer": {
      webp: "WebP",
      progressLabelBatch: "ट्रांसपेरेंसी ठीक हो रही है ({count} फाइलें)",
    ...
    "background-replace": {
      ...
      color1: "रंग 1",
      color22: "रंग 2",
      angleValue: "कोण: {angle}°",
      edgeFeatherValue: "एज फेदर: {feather}px",
      color: "पृष्ठभूमि रंग",
    ...
    "blur-background": {
      ...
      outputFormat: "आउटपुट फॉर्मेट",
      edgeFeather: "एज फेदर",
      softensTheEdgeBetweenSubject: "विषय और धुंधली पृष्ठभूमि के बीच के किनारे को नरम बनाता है",
    ...
    "watermark-text": {
      original: "मूल:",
      applyWatermark: "वॉटरमार्क लगाएं",
      tiledRepeating: "टाइल्ड (दोहराव वाला)",
      originalKb: "मूल: {size} KB",
      processedKb: "प्रोसेस्ड: {size} KB",
      applyWatermarkBatch: "वॉटरमार्क लागू करें ({count} फाइलें)",
    ...
    "watermark-image": {
      ...
      chooseWatermarkImage: "वॉटरमार्क इमेज चुनें",
      originalKb: "मूल: {size} KB",
      processedKb: "प्रोसेस्ड: {size} KB",
    ...
    compose: {
      ...
      screen: "स्क्रीन",
      processing: "प्रोसेस हो रहा है...",
      overlayImage: "ओवरले इमेज",
      chooseOverlayImage: "ओवरले इमेज चुनें",
      normal: "नॉर्मल",
      multiply: "मल्टिप्लाई",
      overlay: "ओवरले",
      darken: "डार्कन",
      lighten: "लाइटन",
      hardLight: "हार्ड लाइट",
      softLight: "सॉफ्ट लाइट",
      difference: "डिफरेंस",
      exclusion: "एक्सक्लूज़न",
      originalKb: "मूल: {size} KB",
      processedKb: "प्रोसेस्ड: {size} KB",
    ...
    "meme-generator": {
      ...
      stroke: "स्ट्रोक",
      alignment: "अलाइनमेंट",
      backToEditor: "एडिटर पर वापस",
      searchTemplates: "टेम्प्लेट खोजें...",
      uploadCustomImage: "कस्टम इमेज अपलोड करें",
      noTemplatesMatchYourSearch: "आपकी खोज से कोई टेम्प्लेट मेल नहीं खाता",
      backToTemplates: "टेम्प्लेट पर वापस",
      chooseATextLayout: "टेक्स्ट लेआउट चुनें",
      generatedMeme: "बनाया गया Meme",
      newMeme: "नया Meme",
      yourMemeIsReady: "आपका Meme तैयार है।",
      editAgain: "फिर से संपादित करें",
      templatePreview: "टेम्प्लेट प्रीव्यू",
    ...
    info: {
      ...
      max: "अधिकतम:",
      mean: "माध्य:",
      minValue: "न्यूनतम:{value}",
      maxValue: "अधिकतम:{value}",
      meanValue: "माध्य:{value}",
    ...
    compare: {
      secondImage: "दूसरी इमेज",
      chooseSecondImage: "दूसरी इमेज चुनें",
      comparing: "तुलना हो रही है...",
      downloadDiffImage: "अंतर इमेज डाउनलोड करें",
    ...
    "find-duplicates": {
      sensitivity: "सेंसिटिविटी",
      detectionMode: "डिटेक्शन मोड",
      strictMatch: "सख्त मैच",
      broadMatch: "व्यापक मैच",
      analyzing: "विश्लेषण हो रहा है...",
      totalScanned: "कुल स्कैन किए गए",
      duplicateGroups: "डुप्लीकेट ग्रुप",
      uniqueImages: "यूनिक इमेज",
      spaceSaveable: "बचाई जा सकने वाली जगह",
      skipped: "स्किप की गईं",
      downloadGrouped: "ग्रुप में डाउनलोड करें",
      downloadUniqueOnly: "केवल यूनिक डाउनलोड करें",
      reScanWithDifferentSettings: "अलग सेटिंग्स के साथ दोबारा स्कैन करें",
      skippedFileOne: "{count} फाइल का विश्लेषण नहीं हो सका",
      skippedFileOther: "{count} फाइलों का विश्लेषण नहीं हो सका",
      uploadingPercent: "अपलोड हो रहा है... {percent}%",
      scanImages: "{count} इमेज स्कैन करें",
      preset: "प्रीसेट",
      exact: "सटीक",
      similar: "समान",
      loose: "लचीला",
    ...
    "qr-generate": {
      ...
      linear: "लीनियर",
      radial: "रेडियल",
      enterContentToGenerateA: "QR कोड बनाने के लिए कंटेंट दर्ज करें",
      httpsExampleCom: "https://example.com",
      enterAnyText: "कोई भी टेक्स्ट दर्ज करें...",
      networkNameSsid: "नेटवर्क नाम (SSID)",
      encryption: "एन्क्रिप्शन",
      hiddenNetwork: "छिपा हुआ नेटवर्क",
      to: "प्रति",
      recipientExampleCom: "recipient@example.com",
      subjectLine: "विषय पंक्ति",
      body: "बॉडी",
      emailBody: "ईमेल बॉडी...",
      ...
      style: "स्टाइल",
      dotPattern: "डॉट पैटर्न",
      cornerSquare: "कॉर्नर स्क्वेयर",
      cornerDot: "कॉर्नर डॉट",
      dotColor: "डॉट कलर",
      useGradient: "ग्रेडिएंट उपयोग करें",
      from: "से",
      customCornerColors: "कस्टम कॉर्नर कलर",
      addLogoImage: "लोगो इमेज जोड़ें",
      logoSize: "लोगो साइज़",
      logoMargin: "लोगो मार्जिन",
      cleanAreaBehindLogo: "लोगो के पीछे का क्षेत्र साफ करें",
      errorCorrection: "एरर करेक्शन",
      low7MaxDensity: "कम (7%): अधिकतम डेंसिटी",
      medium15GeneralUse: "मध्यम (15%): सामान्य उपयोग",
      quartile25WithSmallLogo: "क्वार्टाइल (25%): छोटे लोगो के साथ",
      high30WithLargeLogo: "उच्च (30%): बड़े लोगो के साथ",
    ...
    "barcode-read": {
      ...
      scanImagesForQrCodes:
        "QR कोड, बारकोड (Code 128, EAN, UPC आदि) और 2D कोड (DataMatrix, PDF417, Aztec) के लिए इमेज स्कैन करें।",
      options: "विकल्प",
      thoroughScan: "गहन स्कैन",
      spendsMoreTimeAnalyzingThe:
        "इमेज के विश्लेषण में अधिक समय लगाता है। छोटे, क्षतिग्रस्त या कम-कंट्रास्ट बारकोड के लिए सक्षम करें।",
      scanningForBarcodes: "बारकोड स्कैन हो रहे हैं",
      copyAll: "सभी कॉपी करें",
      copyValue: "मान कॉपी करें",
      scanBarcodesBatch: "बारकोड स्कैन करें ({count} फाइलें)",
      foundBarcode: "{count} बारकोड मिला",
      foundBarcodePlural: "{count} बारकोड मिले",
    ...
    collage: {
      ...
      stacked: "ऊपर-नीचे",
      leftLarge: "बाईं ओर बड़ा",
      rightLarge: "दाईं ओर बड़ा",
      topLarge: "ऊपर बड़ा",
      bottomLarge: "नीचे बड़ा",
      centerLarge: "बीच में बड़ा",
      threeColumns: "तीन कॉलम",
      threeRows: "तीन पंक्तियाँ",
      grid2x2: "2x2 ग्रिड",
      grid2x3: "2x3 ग्रिड",
      grid3x2: "3x2 ग्रिड",
      grid3x3: "3x3 ग्रिड",
      ...
      mosaic: "मोज़ेक",
      uploadingImages: "इमेज अपलोड हो रही हैं...",
      processingCollage: "कोलाज प्रोसेस हो रहा है...",
      loaded: "लोड हुईं",
      images: "इमेज",
      collage: "कोलाज:",
      snapotter: "SnapOtter",
      background: "बैकग्राउंड",
      format: "फॉर्मेट",
      uploadImagesForCollage: "कोलाज के लिए इमेज अपलोड करें",
      drop2OrMoreImages: "शुरू करने के लिए 2 या अधिक इमेज यहां छोड़ें",
      resetPositionAndZoom: "स्थिति और ज़ूम रीसेट करें",
      collageResult: "कोलाज परिणाम",
      backToEditor: "एडिटर पर वापस",
      layout: "लेआउट",
      allLayouts: "सभी लेआउट",
      spacingStyle: "स्पेसिंग और स्टाइल",
      canvas: "कैनवास",
      output: "आउटपुट",
      creating: "बनाया जा रहा है...",
      sizeKbIn: "{size} KB इनपुट",
      sizeKbOut: "{size} KB आउटपुट",
      imagesLoadedOne: "{count} इमेज लोड हुई",
      imagesLoadedOther: "{count} इमेज लोड हुईं",
      bestForImages: "{count} इमेज के लिए सर्वोत्तम",
      inputTotalKb: "कुल इनपुट: {size} KB",
      collageKb: "कोलाज: {size} KB",
      collageCell: "कोलाज सेल {index}",
      fitEntireImage: "पूरी इमेज फिट करें",
      fillCell: "सेल भरें",
      submitWithCount: "कोलाज बनाएं ({count} इमेज)",
      templateTitle: "{label} ({count} इमेज)",
      template: "टेम्प्लेट",
      aspectRatio: "आस्पेक्ट रेशियो",
      gap: "गैप",
      cornerRadius: "कॉर्नर रेडियस",
    ...
    stitch: {
      ...
      stitching: "इमेज जोड़ी जा रही हैं...",
      downloadStitchedImage: "जुड़ी हुई इमेज डाउनलोड करें",
      uploadingPercent: "अपलोड हो रहा है... {percent}%",
      submitCount: "{count} इमेज जोड़ें",
      direction: "दिशा",
      horizontal: "क्षैतिज",
      vertical: "लंबवत",
      grid: "ग्रिड",
    ...
    split: {
      splitMode: "स्प्लिट मोड",
      tileWidthPx: "टाइल चौड़ाई (px)",
      tileHeightPx: "टाइल ऊंचाई (px)",
      splitting: "बांटा जा रहा है...",
      downloadAllAsZip: "सभी ZIP के रूप में डाउनलोड करें",
      imageGridSummary: "इमेज: {width}x{height}px. ग्रिड: {cols}x{rows} = {count} टाइल",
      gridSummary: "{cols}x{rows} = {count} टाइल",
      tileDimsEach: "प्रत्येक ~{width}x{height}px",
      submitBatch: "{count} इमेज बांटें (प्रत्येक {tiles} टाइल)",
      splitIntoTiles: "{count} टाइल में बांटें",
      imagesSplitSummary: "{count} इमेज बांटी गईं (प्रत्येक {tiles} टाइल)",
      tilesGenerated: "{count} टाइल बनाई गईं",
      downloadTile: "टाइल {label} डाउनलोड करें",
      tileAlt: "टाइल {label}",
      modeGrid: "ग्रिड",
      ...
      tileWarningSmall: "टाइल बहुत छोटी होंगी ({width}x{height}px)",
    },
    border: {
      blur: "ब्लर",
      opacity: "ओपेसिटी",
      ...
      applyingBorder: "बॉर्डर लागू हो रहा है",
      applyBorder: "बॉर्डर लागू करें",
      applyBorderBatch: "बॉर्डर लागू करें ({count} फाइलें)",
      presets: "प्रीसेट",
    ...
    beautify: {
      ...
      linear: "लीनियर",
      radial: "रेडियल",
      colorStops: "कलर स्टॉप",
      addStop: "स्टॉप जोड़ें",
      windowTitle: "विंडो शीर्षक",
      spacing: "स्पेसिंग",
      offsetX: "X ऑफसेट",
      offsetY: "Y ऑफसेट",
      exportSize: "एक्सपोर्ट साइज़",
      yourWatermarkText: "आपका वॉटरमार्क टेक्स्ट",
      processing: "प्रोसेस हो रहा है...",
      frameLabel: "{label} फ्रेम",
      preset: "प्रीसेट",
      backgroundType: "बैकग्राउंड प्रकार",
      solidColor: "ठोस रंग",
    ...
    "circle-crop": {
      ...
      transparent: "पारदर्शी",
      color: "रंगीन",
      dragThePreviewToReposition: "स्थिति बदलने के लिए प्रीव्यू को खींचें",
      zoom: "ज़ूम",
      borderColor: "बॉर्डर कलर",
      outputSizePx: "आउटपुट साइज़ (px)",
      submit: "सर्कल क्रॉप",
    ...
    "rounded-crop": {
      ...
      borderColor: "बॉर्डर कलर",
      outputSizePx: "आउटपुट साइज़ (px)",
      roundedSquare: "गोल कोनों वाला वर्ग",
      cornerRadius: "कॉर्नर रेडियस",
    ...
    pixelate: {
      ...
      wholeImage: "पूरी छवि",
      selection: "चयन",
      wholeHint: "पूरी छवि पर पिक्सेलेशन लागू होता है",
      width: "चौड़ाई",
      height: "ऊँचाई",
      dragHint: "स्थिति बदलने के लिए चयन बॉक्स को छवि पर खींचें",
    ...
    "gif-webp": {
      ...
      convertsGifToWebpAnd:
        "GIF को WebP में और WebP को GIF में कन्वर्ट करता है, सभी एनिमेशन फ्रेम बनाए रखते हुए। दिशा इनपुट फाइल फॉर्मेट से अपने आप तय होती है।",
      lossy: "लॉसी",
      lossless: "लॉसलेस",
      submit: "कन्वर्ट करें",
    ...
    histogram: {
      generatesAnRgbHistogramChart: "इमेज के रंग वितरण को दिखाने वाला RGB हिस्टोग्राम चार्ट बनाता है।",
      histogramChart: "हिस्टोग्राम चार्ट",
    ...
    "sprite-sheet": {
      ...
      sheetSummary:
        "{cols} x {rows} ग्रिड · {cellWidth} x {cellHeight}px सेल · {canvasWidth} x {canvasHeight}px कैनवास",
      columns: "कॉलम",
      padding: "पैडिंग",
    ...
    "svg-to-raster": {
      ...
      auto: "ऑटो",
      format: "फॉर्मेट",
      svgDimensions: "SVG आयाम",
      couldNotDetectDimensionsUsing: "आयाम डिटेक्ट नहीं हो सके। कस्टम साइज़ का उपयोग हो रहा है।",
      renderDpi: "रेंडर DPI",
      progressLabelBatch: "{count} फाइलें कन्वर्ट हो रही हैं",
      outputFormat: "आउटपुट फॉर्मेट",
      sizing: "साइज़िंग",
      scaleMode: "स्केल",
      customMode: "कस्टम",
    ...
    vectorize: {
      ...
      fewerColors: "कम रंग",
      moreColors: "अधिक रंग",
      gradientStep: "ग्रेडिएंट स्टेप",
      smoothGradients: "स्मूद ग्रेडिएंट",
      flatColors: "फ्लैट रंग",
      moreWhite: "अधिक सफ़ेद",
      moreBlack: "अधिक काला",
      moreCorners: "अधिक कोने",
      smoother: "अधिक स्मूद",
      invertColors2: "रंग इन्वर्ट करें",
    ...
    "gif-tools": {
      ...
      horizontal: "क्षैतिज",
      vertical: "लंबवत",
      readingGifMetadata: "GIF मेटाडेटा पढ़ा जा रहा है...",
      staticImage: "स्टैटिक इमेज",
      pixels: "पिक्सेल",
      fewerColorsSmallerFile: "कम रंग = छोटी फाइल",
      higherEffortSlowerButSmaller: "अधिक प्रयास = धीमा लेकिन छोटा",
      reversesThePlaybackOrderOf: "सभी फ्रेम के प्लेबैक क्रम को उलट देता है।",
      alsoAdjustSpeed: "स्पीड भी समायोजित करें",
      loop: "लूप",
      originalKb: "मूल: {size} KB",
      processedKb: "प्रोसेस्ड: {size} KB",
      framesCount: "{count} फ्रेम",
      frameRangeHint: "0 से {max} (0 पहला फ्रेम है)",
      extractsAllFrames: "सभी {count} फ्रेम को ZIP में अलग-अलग इमेज के रूप में निकालता है।",
      requiresAnimatedGif: "एनिमेटेड GIF आवश्यक",
      unlockAspectRatio: "आस्पेक्ट रेशियो अनलॉक करें",
    ...
    "image-to-base64": {
      converting: "कन्वर्ट हो रहा है...",
      outputImageFormat: "आउटपुट इमेज फॉर्मेट",
      convertBeforeEncodingToControl: "MIME प्रकार और साइज़ नियंत्रित करने के लिए एन्कोडिंग से पहले कन्वर्ट करें",
      lowerQualitySmallerBase64String: "कम क्वालिटी = छोटी base64 स्ट्रिंग",
      maxWidthPx: "अधिकतम चौड़ाई (px)",
      t0NoLimit: "0 = कोई सीमा नहीं",
      maxHeightPx: "अधिकतम ऊंचाई (px)",
      resizeBeforeEncodingAspectRatio:
        "एन्कोडिंग से पहले रीसाइज़ करें। आस्पेक्ट रेशियो बना रहता है। 0 = कोई सीमा नहीं।",
      submitWithCount: "Base64 में कन्वर्ट करें ({count})",
      outputFormat: "आउटपुट फॉर्मेट",
    ...
    "barcode-generate": {
      enterTextOrNumber: "टेक्स्ट या नंबर दर्ज करें...",
      generatedBarcode: "बनाया गया बारकोड",
      text: "टेक्स्ट",
      type: "बारकोड प्रकार",
      scale: "स्केल",
    ...
    "chart-maker": {
      optionalChartTitle: "वैकल्पिक चार्ट शीर्षक",
      kind: "चार्ट प्रकार",
      title: "शीर्षक",
      width: "चौड़ाई",
      height: "ऊँचाई",
    ...
    "trim-video": {
      endTimeMustBeAfter: "अंत का समय शुरुआत के समय के बाद होना चाहिए",
      start: "शुरुआत (सेकंड)",
      end: "अंत (सेकंड)",
    ...
    "images-to-video": {
      square1080x1080: "वर्गाकार (1080x1080)",
    ...
    "sign-pdf": {
      ...
      deleteSignature: "हस्ताक्षर हटाएं",
      ...
      loadFailed:
        "यह PDF प्रदर्शित नहीं हो सका। फ़ाइल दूषित या पासवर्ड से सुरक्षित हो सकती है; यदि यह एन्क्रिप्टेड है, तो पहले PDF अनलॉक टूल से पासवर्ड हटाएँ।",
      pad: {
        inkColor: "स्याही {color}",
  ...
  urlImport: {
    ...
    placeholder: "फाइल URL पेस्ट करें, प्रति पंक्ति एक...",
    ...
    failedStatus: "विफल",
    textareaPlaceholder:
      "https://example.com/photo.jpg\nhttps://example.com/report.pdf\n- https://example.com/clip.mp4\n[मेरी फ़ाइल](https://example.com/recording.mp3)",
  },
  comparison: {
    original: "मूल",
    processed: "प्रोसेस्ड",
    ...
    processedSize: "प्रोसेस्ड: {size}",
    smallerBadge: "({percent}% छोटा)",
    largerBadge: "({percent}% बड़ा)",
  },
  toolPage: {
    ...
    libraryOverwrite: "मूल फ़ाइल को अधिलेखित करें",
    libraryOverwriteHint: "परिणाम आपकी फ़ाइल्स में मूल फ़ाइल की जगह लेता है",
    viewInFiles: "फ़ाइल्स में देखें",
  ...
  editor: {
    ...
    options: {
      ...
      cloneStamp: {
        aligned: "संरेखित",
        altClickHint: "स्रोत सेट करने के लिए Alt+क्लिक",
      },
      crop: {
        ratioLabel: "रेशियो:",
        applyTitle: "क्रॉप लागू करें (Enter)",
        cancelTitle: "क्रॉप रद्द करें (Escape)",
      },
      dodgeBurn: {
        dodge: "डॉज",
        burn: "बर्न",
      ...
      move: {
        ...
        alignCenterHorizontal: "क्षैतिज मध्य में संरेखित करें",
        alignRight: "दाएं संरेखित करें",
        alignTop: "ऊपर संरेखित करें",
        alignCenterVertical: "लंबवत मध्य में संरेखित करें",
        alignBottom: "नीचे संरेखित करें",
        distributeLabel: "वितरण:",
        distributeHorizontally: "क्षैतिज रूप से वितरित करें",
        distributeVertically: "लंबवत रूप से वितरित करें",
      },
      pixelBrush: {
        blur: "ब्लर",
        sharpen: "शार्पन",
      ...
      selection: {
        ...
        ellipseShort: "दीर्घवृत्त",
        lasso: "लैसो",
        magicWand: "मैजिक वैंड",
        modeLabel: "मोड:",
        newSelection: "नया चयन",
        newShort: "नया",
        addToSelection: "चयन में जोड़ें",
        addShort: "जोड़ें",
        subtractFromSelection: "चयन से घटाएं",
        subtractShort: "घटाएं",
      ...
      text: {
        ...
        letterSpacing: "लेटर स्पेसिंग",
        switchToPointText: "पॉइंट टेक्स्ट पर स्विच करें",
        switchToAreaText: "एरिया टेक्स्ट पर स्विच करें",
        area: "एरिया",
        point: "पॉइंट",
      },
      transform: {
    ...
    panels: {
      adjustments: {
        ...
        levelsGamma: "गामा",
        levelsWhite: "सफ़ेद",
        sectionOutput: "आउटपुट",
        levelsOutBlack: "आउट काला",
        levelsOutWhite: "आउट सफ़ेद",
        presetCustom: "कस्टम",
        curvesHint: "पॉइंट जोड़ने के लिए क्लिक करें। हिलाने के लिए खींचें। हटाने के लिए डबल-क्लिक करें।",
        sectionFilters: "फिल्टर",
        sectionBlurEffects: "ब्लर इफेक्ट्स",
        sectionEffects: "इफेक्ट्स",
        vignette: "विन्येट",
        grain: "ग्रेन",
        resetAll: "सभी रीसेट करें",
        apply: "लागू करें",
      ...
      color: {
        channelAriaLabel: "{channel} कलर चैनल",
        recent: "हाल के",
        swapColorsTitle: "रंग अदल-बदल करें (X)",
        resetColorsTitle: "रंग रीसेट करें (D)",
        foreground: "फ़ोरग्राउंड",
      },
      histogram: {
        noData: "कोई हिस्टोग्राम डेटा उपलब्ध नहीं",
        mean: "माध्य",
        stdDev: "मानक विचलन",
        median: "माध्यिका",
      },
      ...
      layers: {
        ...
        lockLayer: "लेयर लॉक करें",
        unlockLayer: "लेयर अनलॉक करें",
        thumbnailAlt: "{name} थंबनेल",
        effects: {
          heading: "लेयर इफेक्ट्स",
          dropShadow: "ड्रॉप शैडो",
          innerShadow: "इनर शैडो",
          outerGlow: "आउटर ग्लो",
          stroke: "स्ट्रोक",
          collapseAria: "{label} संक्षिप्त करें",
          expandAria: "{label} विस्तारित करें",
          color: "रंग",
          opacity: "ओपेसिटी",
          angle: "कोण",
          distance: "दूरी",
          ...
          positionOutside: "बाहर",
        },
      },
      navigator: {
        noImageLoaded: "कोई इमेज लोड नहीं",
      },
    },
    ui: {
      widthPx: "चौड़ाई (px)",
      ...
      betaBadge: "बीटा",
      canvasResize: {
        heading: "कैनवास साइज़",
        current: "वर्तमान: {width} x {height} px",
        anchorLabel: "एंकर:",
        anchorAriaLabel: "एंकर {position}",
      ...
      imageResize: {
        heading: "इमेज साइज़",
        original: "मूल: {width} x {height} px",
        note: "सभी ऑब्जेक्ट को नए आयामों के अनुपात में स्केल करता है।",
      },
      exportDialog: {
        heading: "इमेज एक्सपोर्ट करें",
        previewAlt: "एक्सपोर्ट प्रीव्यू",
        format: "फ़ॉर्मैट",
        quality: "क्वालिटी",
        dimensions: "आयाम",
        width: "चौड़ाई",
        height: "ऊँचाई",
        resetToOriginalSize: "मूल साइज़ पर रीसेट करें ({width} x {height})",
        transparentBackground: "पारदर्शी बैकग्राउंड",
      ...
      autosaveRecovery: {
        message: "{time} का सहेजा न गया काम पुनर्प्राप्त किया गया।",
        restore: "पुनर्स्थापित करें",
        discard: "छोड़ दें",
      },
      fillDialog: {
        heading: "भरण",
        contentsLabel: "सामग्री",
        customColor: "कस्टम रंग",
        opacity: "ओपेसिटी",
        previewLabel: "प्रीव्यू:",
        contents: {
          foreground: "फ़ोरग्राउंड रंग",
      ...
      shapeColorPicker: {
        ariaLabel: "{label} कलर पिकर",
        noneSelected: "{label}: कोई नहीं",
        setNone: "कोई {label} नहीं",
      },
    },
  },
  settings: {
    ...
    tools: {
      ...
      disabledCountOne: "{count} टूल निष्क्रिय",
      disabledCountOther: "{count} टूल निष्क्रिय",
    },
    experimental: {
    ...
    aiFeatures: {
      ...
      importDescription: "ऑफ़लाइन उपयोग के लिए हस्ताक्षरित OCR रनटाइम या पुराना AI बंडल आयात करें।",
      importButton: "फ़ाइल से आयात करें",
      importing: "आयात हो रहा है...",
      importSuccess: "बंडल सफलतापूर्वक आयात किया गया।",
      importError: "बंडल आयात विफल: {error}",
      importType: "बंडल प्रकार",
      importOcr: "सटीक OCR पैक",
      importLegacy: "पुराना AI बंडल",
      importOcrIndex: "हस्ताक्षरित OCR इंडेक्स (.json)",
      importOcrArchive: "OCR रनटाइम आर्काइव (.tar.gz)",
      importLegacyArchive: "पुराना बंडल आर्काइव (.tar.gz)",
  ...
  auth: {
    ...
    mfaEnrollmentHeading: "जारी रखने के लिए द्वि-कारक प्रमाणीकरण सेट अप करें",
    ...
    mfaThrottled: "बहुत सारे प्रयास। {minutes} मिनट बाद फिर से प्रयास करें।",
    mfaThrottledPlural: "बहुत सारे प्रयास। {minutes} मिनट बाद फिर से प्रयास करें।",
    mfaThrottledUnknownWait: "बहुत सारे प्रयास। कृपया फिर से प्रयास करने से पहले प्रतीक्षा करें।",
    methodSaml: "SAML",
  ...
  files: {
    ...
    download: "डाउनलोड",
    details: {
      previewFailedRetry: "प्रीव्यू बनाना विफल रहा। पुनः प्रयास करें।",
    },
  },
  dropzone: {
    unsupportedFileType: "इस फाइल प्रकार को यह टूल सपोर्ट नहीं करता",
    urlFetchFailed: "URL से फाइल नहीं ला सके",
    ariaLabel: "फाइल ड्रॉप ज़ोन",
    dropPrompt: "अपनी फाइलें यहां खींचें",
    takePhoto: "फ़ोटो लें",
    ...
    orSeparator: "या",
    urlPlaceholder: "फाइल URL पेस्ट करें...",
    urlLoadingIndicator: "...",
    addUrlButton: "जोड़ें",
  ...
  reviewPanel: {
    ...
    downloadAllZipSize: "सभी डाउनलोड करें (ZIP, {size})",
    downloadFilesZipSize: "{count} फ़ाइलें डाउनलोड करें (ZIP, {size})",
    downloadTypeSize: "{type} डाउनलोड करें ({size})",
  },
  features: {
  ...
  appLayout: {
    ...
    aiInstall: {
      installingBundle: "{name} इंस्टॉल हो रहा है",
      defaultBundleName: "AI सुविधा",
      bundlesInstalled: "{completed}/{total} इंस्टॉल",
      bundlesQueued: "{count} कतार में",
    },
  },
  a11y: {
  ...
  commonUi: {
    ...
    metadataGrid: {
      ...
      restoreField: "{field} पुनर्स्थापित करें",
      removeField: "{field} हटाएं",
    },
    multiImageViewer: {
      cannotPreview: "{ext} फाइलें ब्राउज़र में प्रीव्यू नहीं हो सकतीं।",
    },
    waveform: {
      play: "चलाएं",
      pause: "रोकें",
  ...
  privacyPolicy: {
    lastUpdated: "अंतिम अपडेट: 24 जून 2026",
    overview: {
      heading: "अवलोकन",
      body: "SnapOtter एक सेल्फ-होस्टेड, ओपन-सोर्स फ़ाइल प्रोसेसिंग एप्लिकेशन है। आपका इंस्टेंस पूरी तरह उसी के संचालन और नियंत्रण में रहता है जिसने इसे डिप्लॉय किया है। यह नीति बताती है कि सॉफ़्टवेयर खुद आपके डेटा को कैसे संभालता है।",
    },
    localProcessing: {
      heading: "लोकल प्रोसेसिंग",
      body: "सारी फ़ाइल प्रोसेसिंग पूरी तरह उसी सर्वर पर होती है जहां SnapOtter डिप्लॉय है। आपकी फ़ाइलें कभी बाहरी सेवाओं या तृतीय-पक्ष API को नहीं भेजी जातीं। जब आप प्रोसेसिंग के लिए कोई फ़ाइल अपलोड करते हैं, तो उसे होस्ट मशीन की मेमोरी या अस्थायी स्टोरेज में संभाला जाता है और काम पूरा होने के बाद रखा नहीं जाता।",
    },
    analytics: {
      heading: "एनालिटिक्स",
      body: "सॉफ़्टवेयर को बेहतर बनाने में मदद के लिए SnapOtter में बुनियादी एनालिटिक्स (टूल उपयोग, त्रुटि रिपोर्ट) शामिल है। आपकी फ़ाइलें, फ़ाइल नाम और निजी डेटा इसका हिस्सा कभी नहीं होते। एनालिटिक्स डिफ़ॉल्ट रूप से चालू रहता है और इसे रनटाइम पर बंद किया जा सकता है। एक प्रशासक अनाम उत्पाद एनालिटिक्स को सेटिंग्स > सिस्टम > {privacy} में बंद कर सकता है, इसके लिए किसी रीस्टार्ट या रीबिल्ड की ज़रूरत नहीं। कंपाइल-टाइम पर पूरी तरह बंद करने के लिए {code} के साथ बिल्ड करें, जो इसे बंडल से पूरी तरह हटा देता है। इसके बिना भी सब कुछ सामान्य रूप से काम करता है।",
      feedbackBody:
        "SnapOtter में वैकल्पिक प्रतिक्रिया प्रॉम्प्ट भी शामिल हैं। प्रतिक्रिया केवल तभी भेजी जाती है जब आप उसे सबमिट करते हैं, और केवल तभी जब एनालिटिक्स चालू हो। प्रतिक्रिया इवेंट PostHog को {code} के रूप में जाते हैं। संपर्क नाम, ईमेल और कंपनी तभी भेजे जाते हैं जब आप संपर्क अनुमति बॉक्स चेक करते हैं। SnapOtter प्रतिक्रिया के साथ फ़ाइलें, फ़ाइल नाम, अपलोड पाथ, OCR/ट्रांसक्रिप्शन आउटपुट, निजी दस्तावेज़ टेक्स्ट या कच्चे त्रुटि लॉग नहीं जोड़ता।",
    },
    dataStorage: {
      heading: "डेटा स्टोरेज",
      body: "अगर प्रमाणीकरण चालू है, तो एप्लिकेशन उपयोगकर्ता खाते (यूज़रनेम और हैश किए गए पासवर्ड) होस्ट मशीन पर एक PostgreSQL डेटाबेस में सहेजता है। अगर आप फ़ाइल्स सुविधा का उपयोग करते हैं, तो अपलोड की गई फ़ाइलें सर्वर के फ़ाइल सिस्टम पर रखी जाती हैं। सारा सहेजा गया डेटा पूरी तरह इंस्टेंस संचालक के नियंत्रण में रहता है।",
    },
    thirdParty: {
      heading: "तृतीय-पक्ष सेवाएं",
      body: "सारी प्रोसेसिंग लोकल होती है; आपकी फ़ाइलें कहीं नहीं भेजी जातीं। ऊपर बताए अनुसार अनाम उपयोग एनालिटिक्स PostHog और Sentry से चलते हैं। AI-संचालित सुविधाएं बंडल किए गए मॉडल से लोकली चलती हैं। किसी और बाहरी सेवा से संपर्क नहीं किया जाता।",
    },
    openSource: {
      heading: "ओपन सोर्स",
      body: "SnapOtter पूरी तरह ओपन सोर्स है। इन दावों की पुष्टि के लिए आप कभी भी सोर्स कोड की जांच कर सकते हैं। पारदर्शिता इस प्रोजेक्ट का मूल सिद्धांत है।",
    },
    yourControl: {
      heading: "आपका नियंत्रण",
      body: "चूंकि SnapOtter सेल्फ-होस्टेड है, इंस्टेंस संचालक का सारे डेटा पर पूरा नियंत्रण होता है। आप सर्वर से फ़ाइलें हटाकर या डेटाबेस मिटाकर कभी भी अपना डेटा हटा सकते हैं। आपके इंफ्रास्ट्रक्चर के बाहर कोई डेटा मौजूद नहीं रहता।",
    },
  },
} as const;
