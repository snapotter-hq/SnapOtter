...
export const hi: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "आपकी फाइलें कभी आपकी मशीन से बाहर नहीं जातीं।",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "157 टूल्स के साथ गोपनीयता-पहले, सेल्फ-होस्टेड फाइल मैनिपुलेशन सूट - इमेज, वीडियो, ऑडियो, PDF और डेटा। क्लाउड को डेटा भेजे बिना प्रोसेस, कन्वर्ट, कंप्रेस और अपने फाइल वर्कफ्लो ऑटोमेट करें।",
      versionLabel: "वर्शन:",
      linksHeading: "लिंक्स",
  ...
  auth: {
    ...
    heroSubtitle: "हर वो फ़ाइल टूल जो आपको चाहिए।",
    rotatingPhrases: [
      ...
      "Docker Compose से मिनटों में डिप्लॉय।",
  ...
  features: {
    ...
    progressMessages: [
      ...
      "आपकी फाइलें बाद में शुक्रिया करेंगी...",
  ...
  analytics: {
    ...
    consentDescription:
      "गुमनाम उपयोग आंकड़े हमें बग ठीक करने और आपके काम के टूल्स बनाने में मदद करते हैं। आपकी फाइलें आपकी मशीन पर ही रहती हैं।",
    ...
    settingsPrivacy: "आपकी फाइलें कभी आपकी मशीन से बाहर नहीं जातीं।",
