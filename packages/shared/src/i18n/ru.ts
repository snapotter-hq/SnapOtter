...
export const ru: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Самостоятельно размещаемый набор инструментов для обработки файлов с приоритетом конфиденциальности. 157 инструментов для изображений, видео, аудио, PDF и данных. Обработка, конвертация, сжатие и автоматизация рабочих процессов без отправки данных в облако.",
      versionLabel: "Версия:",
      linksHeading: "Ссылки",
  ...
  auth: {
    ...
    heroSubtitle: "Все инструменты для работы с файлами.",
    rotatingPhrases: [
      ...
      "157 инструментов.",
      "19 AI-моделей. На Вашем оборудовании.",
      ...
      "Установка за минуты с Docker Compose.",
