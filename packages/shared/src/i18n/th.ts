...
export const th: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "ชุดเครื่องมือจัดการไฟล์แบบโฮสต์เองที่เน้นความเป็นส่วนตัวพร้อม 157 เครื่องมือสำหรับภาพ วิดีโอ เสียง PDF และข้อมูล ประมวลผล แปลง บีบอัด และทำงานอัตโนมัติโดยไม่ต้องส่งข้อมูลไปคลาวด์",
  ...
  auth: {
    ...
    heroSubtitle: "เครื่องมือจัดการไฟล์ทุกอย่างที่คุณต้องการ",
    rotatingPhrases: [
      ...
      "ติดตั้งได้ในไม่กี่นาทีด้วย Docker Compose",
      "ทางเลือกโฮสต์เอง",
