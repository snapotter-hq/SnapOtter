...
export const vi: TranslationKeys = {
  ...
  toolSettings: {
    ...
    "pipeline-step": {
      noConfigurableSettingsDefaultsWill:
        "Không có cài đặt nào để tùy chỉnh. Sẽ dùng giá trị mặc định.",
    },
    "html-to-image-results": {
      capturedScreenshot: "Ảnh chụp màn hình",
    },
    "eraser-canvas": {
      paintOverObjectsToErase: "Tô lên đối tượng cần xóa",
    },
    "crop-canvas": {
      original: "Gốc:",
      cropPreview: "Xem trước vùng cắt",
      cropRegionSize: "Vùng cắt: {width} x {height}",
      originalSize: "Gốc: {width} x {height}",
    },
    "image-to-base64-results": {
      ...
      completedOfTotalFiles: "{completed} / {total} tệp",
      convertedOfTotal: "Đã chuyển đổi {done} / {total}",
      preview: "Xem trước",
      filesReadyClickConvert: '{count} tệp đã sẵn sàng. Nhấn "Chuyển sang Base64" để bắt đầu.',
      clickConvertToConvert: 'Nhấn "Chuyển sang Base64" để chuyển đổi.',
      convertedOfTotalWithFailed: "Đã chuyển đổi {done} / {total}, {count} thất bại",
      tabDataUri: "Data URI",
      tabRawBase64: "Base64 thô",
      startingConversion: "Đang bắt đầu chuyển đổi...",
      uploadImagesAndClickConvert: 'Tải lên hình ảnh và nhấn "Chuyển sang Base64" để bắt đầu.',
      copyAllAsJson: "Sao chép tất cả dạng JSON",
      downloadAllAsJson: "Tải tất cả dạng JSON",
      downloadAllAsText: "Tải tất cả dạng văn bản",
      noResultForThisFile: "Không có kết quả cho tệp này. Có thể tệp chưa được xử lý.",
    },
    "split-canvas": {
      loadingPreview: "Đang tải bản xem trước...",
      splitGridOverlay: "Lớp phủ lưới tách ảnh",
      infoBar: "{width} x {height}px . lưới {cols}x{rows} . {count} ô",
    },
    "remove-bg": {
      original: "Gốc:",
      ...
      originalKb: "Gốc: {size} KB",
      processedKb: "Đã xử lý: {size} KB",
    },
    "ocr-pdf-view": {
      extractedText: "Văn bản trích xuất",
      copied: "Đã sao chép",
      loadingExtractedText: "Đang tải văn bản trích xuất...",
      noTextFound: "(không tìm thấy văn bản)",
      extractingText: "Đang trích xuất văn bản...",
      theExtractedTextWillAppear: "Văn bản trích xuất sẽ hiển thị tại đây sau khi bạn chạy OCR.",
    },
    "image-enhancement": {
      original: "Gốc:",
      removesNoiseAndArtifactsUsing: "Khử nhiễu và hiện tượng lỗi bằng AI",
      analyzingImage: "Đang phân tích hình ảnh...",
      imageLooksGoodFineTune: "Hình ảnh trông tốt. Tinh chỉnh bằng thanh trượt cường độ.",
      deepEnhance: "Nâng cao sâu",
      enhance: "Nâng cao",
      sharpenFilter: "Bộ lọc làm nét",
      whiteBalanceTemperatureFilter: "Bộ lọc nhiệt độ cân bằng trắng",
      originalSizeKb: "Gốc: {size} KB",
      enhancedSizeKb: "Đã nâng cao: {size} KB",
    },
    "find-duplicates-results": {
      ...
      unique: "Duy nhất:",
      spaceSaveable: "Dung lượng có thể tiết kiệm:",
      ...
      scanningForDuplicates: "Đang quét tìm ảnh trùng...",
      chooseADetectionModeAnd: 'Chọn chế độ phát hiện rồi nhấn "Quét" để tìm ảnh trùng.',
      allImagesUnique: "Tất cả {count} hình ảnh đều là duy nhất.",
      percentSimilar: "Giống {percent}%",
      imagesClickToCompare: "{count} hình ảnh · Nhấp để so sánh ›",
      groupOf: "Nhóm {current} / {total}",
      showingAllImagesInGroup:
        'Hiển thị tất cả {count} hình ảnh trong nhóm này. Nhấp vào ảnh bất kỳ để đặt làm "tốt nhất".',
      selectedAsBest: "Đã chọn làm tốt nhất",
      clickToMarkAsBest: "Nhấp để đánh dấu là tốt nhất",
    },
    "conversion-preset": {
      quality: "Chất lượng",
      high: "Cao",
    ...
    color: {
      ...
      adjustingColors: "Đang điều chỉnh màu sắc",
      apply: "Áp dụng",
      temperatureAndTintColorFilter: "Bộ lọc nhiệt độ màu và sắc thái",
      colorChannelFilter: "Bộ lọc kênh màu",
      sharpenFilter: "Bộ lọc làm nét",
      originalKb: "Gốc: {size} KB",
      processedKb: "Đã xử lý: {size} KB",
    ...
    crop: {
      ...
      widthPx: "Chiều rộng (px)",
      heightPx: "Chiều cao (px)",
      swapWidthHeight: "Hoán đổi rộng/cao",
      required: "Bắt buộc",
      widthOfMax: "Chiều rộng (tối đa {max})",
      heightOfMax: "Chiều cao (tối đa {max})",
      x: "X",
      xOfMax: "X (tối đa {max})",
      y: "Y",
      yOfMax: "Y (tối đa {max})",
    ...
    rotate: {
      rotate90CounterClockwise: "Xoay 90° ngược chiều kim đồng hồ",
      rotate180: "Xoay 180°",
      rotate90Clockwise: "Xoay 90° theo chiều kim đồng hồ",
      decrease1: "Giảm 1°",
      increase1: "Tăng 1°",
      rotate: "Xoay",
      angle: "Góc",
    ...
    convert: {
      original: "Gốc:",
      originalSizeKb: "Gốc: {size} KB",
      processedSizeKb: "Đã xử lý: {size} KB",
    ...
    "strip-metadata": {
      original: "Gốc:",
      iccProfile: "Có ICC",
      originalSize: "Gốc: {size} KB",
      processedSize: "Đã xử lý: {size} KB",
      fieldsCount: "{count} trường",
      locationCoords: "Dữ liệu vị trí: {lat}, {lon}",
    ...
    "edit-metadata": {
      ...
      photographerCreatorName: "Tên nhiếp ảnh gia / người tạo",
      imageTitle: "Tiêu đề hình ảnh",
      shortHeadline: "Đầu đề ngắn",
      cityName: "Tên thành phố",
      stateOrProvince: "Tỉnh hoặc thành phố",
      countryName: "Tên quốc gia",
      saveCurrentValuesAsTemplate: "Lưu giá trị hiện tại làm mẫu",
      gpsCleared2: ", đã xóa GPS",
      gpsAdded2: ", đã thêm GPS",
      datesShifted2: ", đã dịch chuyển ngày",
      originalSizeKb: "Gốc: {size} KB",
      processedSizeKb: "Đã xử lý: {size} KB",
      readingMetadata: "Đang đọc siêu dữ liệu...",
    ...
    "image-to-pdf": {
      preview: "Xem trước",
      targetMetWithQuality: "Đã đạt mục tiêu (chất lượng JPEG: {quality}%)",
    ...
    "pdf-to-image": {
      converting2: "Đang chuyển đổi",
      page: "trang",
      custom: "Tùy chỉnh",
      uploadAPdfToGet: "Tải lên PDF để bắt đầu",
      generatingPagePreviews: "Đang tạo bản xem trước trang...",
      selectAll: "Chọn tất cả",
      deselectAll: "Bỏ chọn tất cả",
      convertingSelected: "Đang chuyển đổi {count} trang...",
      convertingSelectedPlural: "Đang chuyển đổi {count} trang...",
      pagesConverted: "Đã chuyển đổi {count} trang",
      pagesConvertedPlural: "Đã chuyển đổi {count} trang",
      selectedOfPages: "Đã chọn {selected} / {total} trang",
      selectedOfPagesPlural: "Đã chọn {selected} / {total} trang",
      pageAlt: "Trang {page}",
    ...
    favicon: {
      ...
      themeColor2: "Màu chủ đề",
      usedInManifestJsonFor: "Dùng trong manifest.json cho giao diện trình duyệt",
      uploadHint:
    ...
    upscale: {
      ...
      off: "Tắt",
      originalKb: "Gốc: {size} KB",
      upscaledKb: "Đã phóng to: {size} KB",
    ...
    "enhance-faces": {
      ...
      fewerFaces: "Ít khuôn mặt hơn",
      moreFaces: "Nhiều khuôn mặt hơn",
      onlyEnhanceMainFace: "Chỉ nâng cao khuôn mặt chính",
      forPortraitsIgnoresBackgroundFaces: "Cho ảnh chân dung, bỏ qua khuôn mặt ở nền",
      originalSizeKb: "Gốc: {size} KB",
      enhancedSizeKb: "Đã nâng cao: {size} KB",
    ...
    "smart-crop": {
      ...
      detectionSensitivity: "Độ nhạy phát hiện",
      moreFaces: "Nhiều khuôn mặt hơn",
      swapWidthAndHeight: "Hoán đổi chiều rộng và chiều cao",
      smartCropping: "Đang cắt thông minh",
      submitSubjectBatch: "Cắt thông minh ({count} tệp)",
      submitFaceBatch: "Cắt khuôn mặt ({count} tệp)",
      submitTrimBatch: "Cắt viền ({count} tệp)",
    ...
    "restore-photo": {
      ...
      strong: "Mạnh",
      originalKb: "Gốc: {size} KB",
      restoredKb: "Đã phục chế: {size} KB",
    ...
    "passport-photo": {
      countryUS: "Hoa Kỳ",
      docUS: "Hộ chiếu Hoa Kỳ",
      countryCA: "Canada",
      docCA: "Hộ chiếu Canada",
      countryBR: "Brazil",
      docBR: "Hộ chiếu Brazil",
      countryMX: "Mexico",
      docMX: "Hộ chiếu Mexico",
      countryGB: "Vương quốc Anh",
      docGB: "Hộ chiếu Anh",
      countryEU: "Liên minh Châu Âu",
      docEU: "Hộ chiếu EU (ICAO)",
      countryDE: "Đức",
      docDE: "Hộ chiếu Đức",
      countryFR: "Pháp",
      docFR: "Hộ chiếu Pháp",
      ...
      docTR: "Hộ chiếu Thổ Nhĩ Kỳ",
      countryIE: "Ireland",
      docIE: "Hộ chiếu Ireland",
      countryIT: "Ý",
      docIT: "Hộ chiếu Ý",
      countryES: "Tây Ban Nha",
      docES: "Hộ chiếu Tây Ban Nha",
      countryNL: "Hà Lan",
      docNL: "Hộ chiếu Hà Lan",
      countryPL: "Ba Lan",
      docPL: "Hộ chiếu Ba Lan",
      countrySE: "Thụy Điển",
      docSE: "Hộ chiếu Thụy Điển",
      countryIN: "Ấn Độ",
      docIN: "Hộ chiếu Ấn Độ",
      countryCN: "Trung Quốc",
      docCN: "Hộ chiếu Trung Quốc",
      countryJP: "Nhật Bản",
      docJP: "Hộ chiếu Nhật Bản",
      countryKR: "Hàn Quốc",
      docKR: "Hộ chiếu Hàn Quốc",
      countryTH: "Thái Lan",
      docTH: "Hộ chiếu Thái Lan",
      countryPH: "Philippines",
      docPH: "Hộ chiếu Philippines",
      countryID: "Indonesia",
      docID: "Hộ chiếu Indonesia",
      countrySG: "Singapore",
      docSG: "Hộ chiếu Singapore",
      countryMY: "Malaysia",
      docMY: "Hộ chiếu Malaysia",
      countryVN: "Việt Nam",
      docVN: "Hộ chiếu Việt Nam",
      countryPK: "Pakistan",
      docPK: "Hộ chiếu Pakistan",
      countryBD: "Bangladesh",
      docBD: "Hộ chiếu Bangladesh",
      countryAU: "Úc",
      docAU: "Hộ chiếu Úc",
      countryNZ: "New Zealand",
      docNZ: "Hộ chiếu New Zealand",
      countrySA: "Ả Rập Xê Út",
      docSA: "Hộ chiếu Ả Rập Xê Út",
      countryAE: "Các Tiểu vương quốc Ả Rập Thống nhất",
      docAE: "Hộ chiếu UAE",
      countryNG: "Nigeria",
      docNG: "Hộ chiếu Nigeria",
      countryEG: "Ai Cập",
      docEG: "Hộ chiếu Ai Cập",
      countryZA: "Nam Phi",
      docZA: "Hộ chiếu Nam Phi",
      countryCUSTOM: "Tùy chỉnh",
      docCUSTOM: "Tùy chỉnh",
      width: "Chiều rộng",
      height: "Chiều cao",
      maxFileSize2: "Kích thước tệp tối đa:",
      analyzingFace: "Đang phân tích khuôn mặt",
      resetTo100: "Đặt lại về 100%",
      dimensionsSummary: "{width}x{height}mm ({pxWidth}x{pxHeight}px) ở {dpi} DPI",
      faceCenteredDetail: "Khuôn mặt bị lệch tâm. Hãy cắt hoặc căn lại vị trí ảnh.",
      headLevelDetail: "Đầu bị nghiêng. Hãy giữ đầu thẳng hoặc xoay ảnh.",
      lookingStraightDetail: "Khuôn mặt quay nghiêng. Hãy nhìn thẳng vào máy ảnh.",
      faceSizeDetail: "Khuôn mặt quá nhỏ. Hãy lại gần máy ảnh hơn hoặc cắt sát hơn.",
      ...
      bgWhite: "Trắng",
      bgOffWhite: "Trắng ngà",
      bgLightGray: "Xám nhạt (UK/DE)",
      bgLightBlue: "Xanh dương nhạt (FR)",
      bgRed: "Đỏ (ID)",
      detectingLandmarksShort: "Đang phát hiện điểm mốc...",
      country: "Quốc gia",
    ...
    "transparency-fixer": {
      webp: "WebP",
      progressLabelBatch: "Đang sửa trong suốt ({count} tệp)",
    ...
    "background-replace": {
      ...
      color1: "Màu 1",
      color22: "Màu 2",
      angleValue: "Góc: {angle}°",
      edgeFeatherValue: "Làm mềm viền: {feather}px",
      color: "Màu nền",
      submit: "Thay đổi nền",
    ...
    "blur-background": {
      off: "Tắt",
      outputFormat: "Định dạng đầu ra",
      edgeFeather: "Làm mềm viền",
      softensTheEdgeBetweenSubject: "Làm mềm ranh giới giữa chủ thể và nền đã làm mờ",
    ...
    "watermark-text": {
      ...
      tiledRepeating: "Lát gạch (lặp lại)",
      originalKb: "Gốc: {size} KB",
      processedKb: "Đã xử lý: {size} KB",
      applyWatermarkBatch: "Áp dụng hình mờ ({count} tệp)",
    ...
    "watermark-image": {
      ...
      watermarkImage: "Ảnh hình mờ",
      chooseWatermarkImage: "Chọn ảnh hình mờ",
      originalKb: "Gốc: {size} KB",
      processedKb: "Đã xử lý: {size} KB",
    ...
    compose: {
      ...
      screen: "Màn hình",
      processing: "Đang xử lý...",
      overlayImage: "Ảnh lớp phủ",
      chooseOverlayImage: "Chọn ảnh lớp phủ",
      normal: "Bình thường",
      multiply: "Nhân",
      overlay: "Che phủ",
      darken: "Làm tối",
    ...
    "meme-generator": {
      ...
      uploadCustomImage: "Tải lên ảnh tùy chỉnh",
      noTemplatesMatchYourSearch: "Không có mẫu nào khớp với tìm kiếm của bạn",
      backToTemplates: "Quay lại danh sách mẫu",
      chooseATextLayout: "Chọn bố cục văn bản",
      generatedMeme: "Meme đã tạo",
      newMeme: "Meme mới",
      yourMemeIsReady: "Meme của bạn đã sẵn sàng.",
      editAgain: "Chỉnh sửa lại",
    ...
    info: {
      ...
      max: "lớn nhất:",
      mean: "trung bình:",
      minValue: "nhỏ nhất:{value}",
      maxValue: "lớn nhất:{value}",
      meanValue: "trung bình:{value}",
    ...
    compare: {
      ...
      chooseSecondImage: "Chọn ảnh thứ hai",
      comparing: "Đang so sánh...",
      downloadDiffImage: "Tải xuống ảnh khác biệt",
    ...
    "find-duplicates": {
      ...
      strictMatch: "Khớp nghiêm ngặt",
      broadMatch: "Khớp rộng",
      analyzing: "Đang phân tích...",
      totalScanned: "Tổng số đã quét",
      duplicateGroups: "Nhóm trùng lặp",
      uniqueImages: "Hình ảnh duy nhất",
      spaceSaveable: "Dung lượng có thể tiết kiệm",
      skipped: "Đã bỏ qua",
      downloadGrouped: "Tải xuống theo nhóm",
      downloadUniqueOnly: "Chỉ tải ảnh duy nhất",
      reScanWithDifferentSettings: "Quét lại với cài đặt khác",
      skippedFileOne: "Không thể phân tích {count} tệp",
      skippedFileOther: "Không thể phân tích {count} tệp",
      uploadingPercent: "Đang tải lên... {percent}%",
      scanImages: "Quét {count} hình ảnh",
      preset: "Mẫu",
      exact: "Chính xác",
      similar: "Tương tự",
      loose: "Lỏng",
    ...
    "qr-generate": {
      ...
      linear: "Tuyến tính",
      radial: "Tỏa tròn",
      enterContentToGenerateA: "Nhập nội dung để tạo mã QR",
      httpsExampleCom: "https://example.com",
      enterAnyText: "Nhập văn bản bất kỳ...",
      networkNameSsid: "Tên mạng (SSID)",
      encryption: "Mã hóa",
      ...
      style: "Kiểu dáng",
      dotPattern: "Họa tiết chấm",
      cornerSquare: "Ô vuông góc",
      cornerDot: "Chấm góc",
      dotColor: "Màu chấm",
      useGradient: "Dùng chuyển sắc",
      from: "Từ",
      customCornerColors: "Màu góc tùy chỉnh",
      addLogoImage: "Thêm ảnh logo",
      logoSize: "Kích thước logo",
      logoMargin: "Lề logo",
      cleanAreaBehindLogo: "Làm sạch vùng phía sau logo",
      errorCorrection: "Mức sửa lỗi",
      low7MaxDensity: "Thấp (7%): mật độ tối đa",
      medium15GeneralUse: "Trung bình (15%): dùng thông thường",
      quartile25WithSmallLogo: "Khá (25%): dùng với logo nhỏ",
      high30WithLargeLogo: "Cao (30%): dùng với logo lớn",
    ...
    "barcode-read": {
      ...
      scanImagesForQrCodes:
        "Quét hình ảnh để tìm mã QR, mã vạch (Code 128, EAN, UPC, v.v.) và mã 2D (DataMatrix, PDF417, Aztec).",
      options: "Tùy chọn",
      thoroughScan: "Quét kỹ lưỡng",
      spendsMoreTimeAnalyzingThe:
        "Dành nhiều thời gian hơn để phân tích hình ảnh. Bật cho mã vạch nhỏ, bị hỏng hoặc có độ tương phản thấp.",
      scanningForBarcodes: "Đang quét tìm mã vạch",
      copyAll: "Sao chép tất cả",
      copyValue: "Sao chép giá trị",
      scanBarcodesBatch: "Quét mã vạch ({count} tệp)",
      foundBarcode: "Tìm thấy {count} mã vạch",
      foundBarcodePlural: "Tìm thấy {count} mã vạch",
      submit: "Quét mã vạch",
    ...
    collage: {
      ...
      stacked: "Xếp chồng",
      leftLarge: "Bên trái lớn",
      rightLarge: "Bên phải lớn",
      topLarge: "Phía trên lớn",
      bottomLarge: "Phía dưới lớn",
      centerLarge: "Ở giữa lớn",
      threeColumns: "Ba cột",
      threeRows: "Ba hàng",
      grid2x2: "Lưới 2x2",
      grid2x3: "Lưới 2x3",
      ...
      mosaic: "Khảm",
      uploadingImages: "Đang tải lên hình ảnh...",
      processingCollage: "Đang xử lý ảnh ghép...",
      loaded: "đã tải",
      images: "hình ảnh",
      collage: "Ảnh ghép:",
      snapotter: "SnapOtter",
      background: "Nền",
      format: "Định dạng",
      uploadImagesForCollage: "Tải lên hình ảnh để tạo ảnh ghép",
      drop2OrMoreImages: "Thả 2 hình ảnh trở lên vào đây để bắt đầu",
      resetPositionAndZoom: "Đặt lại vị trí và thu phóng",
      collageResult: "Kết quả ảnh ghép",
      backToEditor: "Quay lại trình chỉnh sửa",
      layout: "Bố cục",
      allLayouts: "Tất cả bố cục",
      spacingStyle: "Khoảng cách & Kiểu dáng",
      canvas: "Khung vẽ",
      output: "Đầu ra",
      creating: "Đang tạo...",
      sizeKbIn: "{size} KB đầu vào",
      sizeKbOut: "{size} KB đầu ra",
      imagesLoadedOne: "Đã tải {count} hình ảnh",
      imagesLoadedOther: "Đã tải {count} hình ảnh",
      bestForImages: "Phù hợp nhất cho {count} hình ảnh",
      inputTotalKb: "Tổng đầu vào: {size} KB",
      collageKb: "Ảnh ghép: {size} KB",
      collageCell: "Ô ảnh ghép {index}",
      fitEntireImage: "Vừa toàn bộ ảnh",
      fillCell: "Lấp đầy ô",
      submitWithCount: "Tạo ảnh ghép ({count} hình ảnh)",
      templateTitle: "{label} ({count} hình ảnh)",
      template: "Mẫu",
      aspectRatio: "Tỷ lệ khung hình",
      gap: "Khoảng cách",
      cornerRadius: "Bán kính bo góc",
    ...
    stitch: {
      ...
      stitching: "Đang ghép nối...",
      downloadStitchedImage: "Tải xuống ảnh đã ghép nối",
      uploadingPercent: "Đang tải lên... {percent}%",
      submitCount: "Ghép nối {count} hình ảnh",
      direction: "Hướng",
      horizontal: "Ngang",
      vertical: "Dọc",
      grid: "Lưới",
    ...
    split: {
      ...
      tileWidthPx: "Chiều rộng ô (px)",
      tileHeightPx: "Chiều cao ô (px)",
      splitting: "Đang tách...",
      downloadAllAsZip: "Tải tất cả dạng ZIP",
      imageGridSummary: "Ảnh: {width}x{height}px. Lưới: {cols}x{rows} = {count} ô",
      gridSummary: "{cols}x{rows} = {count} ô",
      tileDimsEach: "~{width}x{height}px mỗi ô",
      submitBatch: "Tách {count} hình ảnh ({tiles} ô mỗi ảnh)",
      splitIntoTiles: "Tách thành {count} ô",
      imagesSplitSummary: "Đã tách {count} hình ảnh ({tiles} ô mỗi ảnh)",
      tilesGenerated: "Đã tạo {count} ô",
      downloadTile: "Tải xuống ô {label}",
      tileAlt: "Ô {label}",
      modeGrid: "Lưới",
      ...
      tileWarningSmall: "Các ô sẽ rất nhỏ ({width}x{height}px)",
    },
    border: {
      blur: "Làm mờ",
      opacity: "Độ mờ",
      ...
      applyingBorder: "Đang thêm viền",
      applyBorder: "Thêm viền",
      applyBorderBatch: "Thêm viền ({count} tệp)",
      presets: "Mẫu có sẵn",
    ...
    beautify: {
      ...
      linear: "Tuyến tính",
      radial: "Tỏa tròn",
      colorStops: "Điểm dừng màu",
      addStop: "Thêm điểm dừng",
      windowTitle: "Tiêu đề cửa sổ",
      spacing: "Khoảng cách",
      offsetX: "Lệch X",
      offsetY: "Lệch Y",
      exportSize: "Kích thước xuất",
      yourWatermarkText: "Văn bản hình mờ của bạn",
      processing: "Đang xử lý...",
      frameLabel: "Khung {label}",
      preset: "Mẫu",
      backgroundType: "Loại nền",
      solidColor: "Màu đơn",
    ...
    "circle-crop": {
      ...
      transparent: "Trong suốt",
      color: "Màu",
      dragThePreviewToReposition: "Kéo bản xem trước để thay đổi vị trí",
      zoom: "Thu phóng",
      borderColor: "Màu viền",
      outputSizePx: "Kích thước đầu ra (px)",
      submit: "Cắt tròn",
    ...
    "rounded-crop": {
      ...
      borderColor: "Màu viền",
      outputSizePx: "Kích thước đầu ra (px)",
      roundedSquare: "Hình vuông bo tròn",
      cornerRadius: "Bán kính bo góc",
      submit: "Cắt bo tròn",
    ...
    pixelate: {
      ...
      mode: "Chế độ",
      wholeImage: "Toàn bộ ảnh",
      selection: "Vùng chọn",
      wholeHint: "Áp dụng làm khảm cho toàn bộ ảnh",
      width: "Chiều rộng",
      height: "Chiều cao",
      dragHint: "Kéo khung chọn trên ảnh để thay đổi vị trí",
      submit: "Làm khảm",
    ...
    "gif-webp": {
      ...
      convertsGifToWebpAnd:
        "Chuyển đổi GIF sang WebP và WebP sang GIF, giữ nguyên tất cả khung hình hoạt ảnh. Hướng chuyển đổi được xác định tự động theo định dạng tệp đầu vào.",
      lossy: "Mất dữ liệu",
    ...
    histogram: {
      generatesAnRgbHistogramChart: "Tạo biểu đồ histogram RGB thể hiện phân bố màu của hình ảnh.",
    ...
    "sprite-sheet": {
      ...
      sheetSummary:
        "Lưới {cols} x {rows} · ô {cellWidth} x {cellHeight}px · khung vẽ {canvasWidth} x {canvasHeight}px",
      columns: "Số cột",
      padding: "Khoảng đệm",
      background: "Màu nền",
    ...
    "svg-to-raster": {
      ...
      auto: "Tự động",
      format: "Định dạng",
      svgDimensions: "Kích thước SVG",
      couldNotDetectDimensionsUsing:
        "Không thể phát hiện kích thước. Đang dùng kích thước tùy chỉnh.",
      renderDpi: "DPI kết xuất",
      progressLabelBatch: "Đang chuyển đổi {count} tệp",
      outputFormat: "Định dạng đầu ra",
      sizing: "Kích thước",
      scaleMode: "Tỷ lệ",
    ...
    vectorize: {
      ...
      fewerColors: "Ít màu hơn",
      moreColors: "Nhiều màu hơn",
      gradientStep: "Bước chuyển sắc",
      smoothGradients: "Chuyển sắc mượt",
      flatColors: "Màu phẳng",
      moreWhite: "Trắng nhiều hơn",
      moreBlack: "Đen nhiều hơn",
      moreCorners: "Nhiều góc hơn",
      smoother: "Mượt hơn",
      invertColors2: "Đảo ngược màu",
    ...
    "gif-tools": {
      ...
      horizontal: "Ngang",
      vertical: "Dọc",
      readingGifMetadata: "Đang đọc siêu dữ liệu GIF...",
      staticImage: "Ảnh tĩnh",
      pixels: "Điểm ảnh",
      fewerColorsSmallerFile: "Ít màu hơn = tệp nhỏ hơn",
      higherEffortSlowerButSmaller: "Mức nỗ lực cao hơn = chậm hơn nhưng tệp nhỏ hơn",
      reversesThePlaybackOrderOf: "Đảo ngược thứ tự phát của tất cả khung hình.",
      alsoAdjustSpeed: "Đồng thời điều chỉnh tốc độ",
      loop: "Lặp",
      originalKb: "Gốc: {size} KB",
      processedKb: "Đã xử lý: {size} KB",
      framesCount: "{count} khung hình",
      frameRangeHint: "0 đến {max} (0 là khung hình đầu tiên)",
      extractsAllFrames:
        "Trích xuất tất cả {count} khung hình thành các ảnh riêng lẻ trong tệp ZIP.",
      requiresAnimatedGif: "Yêu cầu GIF động",
    ...
    "image-to-base64": {
      converting: "Đang chuyển đổi...",
      outputImageFormat: "Định dạng ảnh đầu ra",
      convertBeforeEncodingToControl:
        "Chuyển đổi trước khi mã hóa để kiểm soát loại MIME và kích thước",
      lowerQualitySmallerBase64String: "Chất lượng thấp hơn = chuỗi base64 nhỏ hơn",
      maxWidthPx: "Chiều rộng tối đa (px)",
      t0NoLimit: "0 = không giới hạn",
      maxHeightPx: "Chiều cao tối đa (px)",
      resizeBeforeEncodingAspectRatio:
        "Thay đổi kích thước trước khi mã hóa. Tỷ lệ khung hình được giữ nguyên. 0 = không giới hạn.",
      submitWithCount: "Chuyển sang Base64 ({count})",
      outputFormat: "Định dạng đầu ra",
    ...
    "barcode-generate": {
      enterTextOrNumber: "Nhập văn bản hoặc số...",
      generatedBarcode: "Mã vạch đã tạo",
      text: "Văn bản",
      type: "Loại mã vạch",
      scale: "Tỷ lệ",
    ...
    "chart-maker": {
      optionalChartTitle: "Tiêu đề biểu đồ (tùy chọn)",
      kind: "Loại biểu đồ",
      title: "Tiêu đề",
      width: "Chiều rộng",
      height: "Chiều cao",
    ...
    "trim-video": {
      endTimeMustBeAfter: "Thời gian kết thúc phải sau thời gian bắt đầu",
      start: "Bắt đầu (giây)",
      end: "Kết thúc (giây)",
    ...
    "images-to-video": {
      square1080x1080: "Vuông (1080x1080)",
  ...
  urlImport: {
    title: "Nhập từ URL",
    placeholder: "Dán URL tệp, mỗi dòng một URL...",
    ...
    textareaPlaceholder:
      "https://example.com/photo.jpg\nhttps://example.com/report.pdf\n- https://example.com/clip.mp4\n[Tệp của tôi](https://example.com/recording.mp3)",
  },
  comparison: {
    original: "Gốc",
    processed: "Đã xử lý",
    ...
    after: "Sau",
    savings: "Tiết kiệm",
    originalSize: "Gốc: {size}",
    processedSize: "Đã xử lý: {size}",
    smallerBadge: "(nhỏ hơn {percent}%)",
    largerBadge: "(lớn hơn {percent}%)",
  },
  toolPage: {
    ...
    libraryOverwrite: "Ghi đè tệp gốc",
    libraryOverwriteHint: "Kết quả sẽ thay thế tệp gốc trong Tệp của bạn",
    viewInFiles: "Xem trong Tệp",
  ...
  editor: {
    ...
    options: {
      ...
      cloneStamp: {
        aligned: "Căn chỉnh",
        altClickHint: "Alt+Nhấp để đặt nguồn",
      },
      crop: {
        ratioLabel: "Tỷ lệ:",
        applyTitle: "Áp dụng cắt (Enter)",
        cancelTitle: "Hủy cắt (Escape)",
      },
      dodgeBurn: {
        dodge: "Làm sáng",
        burn: "Làm tối",
        ...
        exposure: "Phơi sáng",
        saturate: "Tăng bão hòa",
        desaturate: "Giảm bão hòa",
      },
      eyedropper: {
        sampleLabel: "Lấy mẫu:",
        toggleDropdown: "Mở/đóng danh sách",
      },
      fill: {
        tolerance: "Dung sai",
      },
      ...
      move: {
        alignLabel: "Căn:",
        alignLeft: "Căn trái",
        alignCenterHorizontal: "Căn giữa ngang",
        alignRight: "Căn phải",
        alignTop: "Căn trên",
        alignCenterVertical: "Căn giữa dọc",
        alignBottom: "Căn dưới",
        distributeLabel: "Phân bố:",
      ...
      selection: {
        ...
        magicWand: "Đũa thần",
        modeLabel: "Chế độ:",
        newSelection: "Vùng chọn mới",
        newShort: "Mới",
        addToSelection: "Thêm vào vùng chọn",
        addShort: "Thêm",
        subtractFromSelection: "Trừ khỏi vùng chọn",
        subtractShort: "Trừ",
        freehandLasso: "Lasso tự do",
        freehandShort: "Tự do",
      ...
      text: {
        systemFonts: "Phông hệ thống",
        appFonts: "Phông ứng dụng",
        fontSize: "Cỡ chữ",
        bold: "Đậm",
        italic: "Nghiêng",
        underline: "Gạch chân",
        ...
        switchToPointText: "Chuyển sang văn bản điểm",
        switchToAreaText: "Chuyển sang văn bản vùng",
        area: "Vùng",
        point: "Điểm",
      },
      transform: {
    ...
    panels: {
      adjustments: {
        auto: "Tự động",
        channelRed: "Đỏ",
        channelGreen: "Xanh lá",
        channelBlue: "Xanh dương",
        levelsBlack: "Đen",
        levelsGamma: "Gamma",
        levelsWhite: "Trắng",
        sectionOutput: "Đầu ra",
        levelsOutBlack: "Đen đầu ra",
        levelsOutWhite: "Trắng đầu ra",
        presetCustom: "Tùy chỉnh",
        curvesHint: "Nhấp để thêm điểm. Kéo để di chuyển. Nhấp đúp để xóa.",
        sectionFilters: "Bộ lọc",
        sectionBlurEffects: "Hiệu ứng làm mờ",
      ...
      color: {
        channelAriaLabel: "Kênh màu {channel}",
        recent: "Gần đây",
        swapColorsTitle: "Đổi màu (X)",
        resetColorsTitle: "Đặt lại màu (D)",
        foreground: "Tiền cảnh",
      },
      histogram: {
        noData: "Không có dữ liệu histogram",
        mean: "Trung bình",
        stdDev: "Lệch chuẩn",
        median: "Trung vị",
      },
      ...
      layers: {
        ...
        thumbnailAlt: "Hình thu nhỏ của {name}",
        effects: {
          heading: "Hiệu ứng lớp",
          dropShadow: "Bóng đổ",
          innerShadow: "Bóng trong",
          outerGlow: "Phát sáng ngoài",
          stroke: "Viền",
          collapseAria: "Thu gọn {label}",
          expandAria: "Mở rộng {label}",
          color: "Màu",
          opacity: "Độ mờ",
          angle: "Góc",
          ...
          width: "Độ rộng",
          position: "Vị trí",
          positionInside: "Bên trong",
          positionCenter: "Giữa",
          positionOutside: "Bên ngoài",
        },
      },
      navigator: {
    ...
    ui: {
      ...
      betaBadge: "Beta",
      canvasResize: {
        heading: "Kích thước khung vẽ",
        current: "Hiện tại: {width} x {height} px",
        anchorLabel: "Neo:",
        anchorAriaLabel: "Neo {position}",
        backgroundLabel: "Nền:",
        anchors: {
          topLeft: "trên trái",
          topCenter: "trên giữa",
      ...
      exportDialog: {
        ...
        width: "Chiều rộng",
        height: "Chiều cao",
        resetToOriginalSize: "Đặt lại kích thước gốc ({width} x {height})",
      ...
      autosaveRecovery: {
        message: "Đã khôi phục phần việc chưa lưu từ {time}.",
        restore: "Khôi phục",
        discard: "Bỏ qua",
      },
      fillDialog: {
      ...
      shapeColorPicker: {
        ariaLabel: "Bộ chọn màu {label}",
        noneSelected: "{label}: Không",
        setNone: "Không {label}",
      },
    },
  },
  settings: {
    ...
    tools: {
      ...
      disabledCountOne: "{count} công cụ bị tắt",
      disabledCountOther: "{count} công cụ bị tắt",
    },
    experimental: {
  ...
  auth: {
    ...
    mfaThrottled: "Quá nhiều lần thử. Vui lòng thử lại sau {minutes} phút.",
    mfaThrottledPlural: "Quá nhiều lần thử. Vui lòng thử lại sau {minutes} phút.",
    mfaThrottledUnknownWait: "Quá nhiều lần thử. Vui lòng đợi trước khi thử lại.",
    methodSaml: "SAML",
  ...
  files: {
    ...
    download: "Tải xuống",
    details: {
      previewFailedRetry: "Tạo xem trước thất bại. Hãy thử lại.",
    },
  },
  dropzone: {
    unsupportedFileType: "Loại tệp này không được công cụ này hỗ trợ",
    urlFetchFailed: "Không thể tải tệp từ URL",
    ariaLabel: "Vùng thả tệp",
    dropPrompt: "Kéo thả tệp vào đây",
    takePhoto: "Chụp ảnh",
  ...
  reviewPanel: {
    ...
    downloadAllZipSize: "Tải tất cả (ZIP, {size})",
    downloadFilesZipSize: "Tải xuống {count} tệp (ZIP, {size})",
    downloadTypeSize: "Tải xuống {type} ({size})",
  },
  features: {
  ...
  appLayout: {
    ...
    aiInstall: {
      installingBundle: "Đang cài đặt {name}",
      defaultBundleName: "Tính năng AI",
      bundlesInstalled: "Đã cài {completed}/{total}",
      bundlesQueued: "{count} đang chờ",
    },
  },
  a11y: {
  ...
  commonUi: {
    ...
    metadataGrid: {
      ...
      restoreField: "Khôi phục {field}",
      removeField: "Xóa {field}",
    },
    multiImageViewer: {
      cannotPreview: "Không thể xem trước tệp {ext} trong trình duyệt.",
    },
    waveform: {
      play: "Phát",
      pause: "Tạm dừng",
  ...
  privacyPolicy: {
    lastUpdated: "Cập nhật lần cuối: ngày 24 tháng 6 năm 2026",
    overview: {
      heading: "Tổng quan",
      body: "SnapOtter là ứng dụng xử lý tệp mã nguồn mở, tự lưu trữ. Phiên bản của bạn hoàn toàn do người triển khai nó vận hành và kiểm soát. Chính sách này mô tả cách bản thân phần mềm xử lý dữ liệu của bạn.",
    },
    localProcessing: {
      heading: "Xử lý cục bộ",
      body: "Toàn bộ việc xử lý tệp diễn ra ngay trên máy chủ nơi SnapOtter được triển khai. Tệp của bạn không bao giờ được gửi tới dịch vụ bên ngoài hay API của bên thứ ba. Khi bạn tải một tệp lên để xử lý, tệp được xử lý trong bộ nhớ hoặc trong bộ nhớ tạm trên máy chủ và không được giữ lại sau khi thao tác hoàn tất.",
    },
    analytics: {
      heading: "Phân tích",
      body: "SnapOtter có tính năng phân tích cơ bản (mức sử dụng công cụ, báo cáo lỗi) để giúp cải thiện phần mềm. Tệp, tên tệp và dữ liệu cá nhân của bạn không bao giờ nằm trong đó. Phân tích được bật theo mặc định và có thể tắt ngay khi ứng dụng đang chạy. Quản trị viên có thể tắt phân tích sản phẩm ẩn danh trong Cài đặt > Hệ thống > {privacy} mà không cần khởi động lại hay dựng lại. Nếu muốn tắt hẳn ngay từ lúc biên dịch, hãy dựng bản build với {code}, tùy chọn này loại bỏ hoàn toàn phần đó khỏi gói. Mọi thứ vẫn chạy bình thường khi không có nó.",
      feedbackBody:
        "SnapOtter cũng có các lời mời gửi phản hồi tùy chọn. Phản hồi chỉ được gửi khi bạn bấm gửi, và chỉ khi phân tích đang bật. Sự kiện phản hồi được gửi tới PostHog dưới dạng {code}. Tên liên hệ, email và công ty chỉ được gửi nếu bạn tích vào ô cho phép liên hệ. SnapOtter không đính kèm tệp, tên tệp, đường dẫn tải lên, kết quả OCR/phiên âm, nội dung tài liệu riêng tư hay nhật ký lỗi thô vào phản hồi.",
    },
    dataStorage: {
      heading: "Lưu trữ dữ liệu",
      body: "Nếu bật xác thực, ứng dụng lưu tài khoản người dùng (tên đăng nhập và mật khẩu đã băm) trong cơ sở dữ liệu PostgreSQL trên máy chủ. Nếu bạn dùng tính năng Tệp, các tệp tải lên được lưu trên hệ thống tệp của máy chủ. Mọi dữ liệu đã lưu vẫn hoàn toàn nằm dưới quyền kiểm soát của người vận hành phiên bản đó.",
    },
    thirdParty: {
      heading: "Dịch vụ bên thứ ba",
      body: "Mọi quá trình xử lý diễn ra cục bộ; tệp của bạn không bao giờ được gửi đi đâu cả. Phân tích sử dụng ẩn danh do PostHog và Sentry đảm nhiệm như mô tả ở trên. Các tính năng AI chạy cục bộ bằng mô hình đi kèm. Không có dịch vụ bên ngoài nào khác được liên hệ.",
    },
    openSource: {
      heading: "Mã nguồn mở",
      body: "SnapOtter hoàn toàn là mã nguồn mở. Bạn có thể kiểm tra mã nguồn bất cứ lúc nào để xác minh những điều nêu trên. Minh bạch là nguyên tắc cốt lõi của dự án này.",
    },
    yourControl: {
      heading: "Quyền kiểm soát của bạn",
      body: "Vì SnapOtter là phần mềm tự lưu trữ nên người vận hành phiên bản có toàn quyền kiểm soát mọi dữ liệu. Bạn có thể xóa dữ liệu của mình bất cứ lúc nào bằng cách xóa tệp khỏi máy chủ hoặc xóa cơ sở dữ liệu. Không có dữ liệu nào tồn tại bên ngoài hạ tầng của bạn.",
    },
  },
} as const;
