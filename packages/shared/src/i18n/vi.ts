...
export const vi: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Tệp của bạn không bao giờ rời khỏi máy.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Bộ công cụ xử lý tệp tự lưu trữ, ưu tiên quyền riêng tư với 157 công cụ cho ảnh, video, âm thanh, PDF và dữ liệu. Xử lý, chuyển đổi, nén và tự động hóa quy trình xử lý tệp mà không cần gửi dữ liệu lên đám mây.",
  ...
  auth: {
    ...
    heroSubtitle: "Mọi công cụ xử lý tệp bạn cần.",
    rotatingPhrases: [
      ...
      "157 công cụ.",
      "19 mô hình AI. Chạy trên phần cứng của bạn.",
      ...
      "Triển khai trong vài phút với Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Thống kê sử dụng ẩn danh giúp chúng tôi sửa lỗi và xây dựng các công cụ bạn thực sự cần. Tệp của bạn luôn ở trên máy bạn.",
    ...
    settingsPrivacy: "Tệp của bạn không bao giờ rời khỏi máy.",
