export const en = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "A self-hosted, privacy-first file manipulation suite with 157 tools across image, video, audio, PDF, and data. Process, convert, compress, and automate your file workflows without sending data to the cloud.",
  ...
  auth: {
    ...
    heroSubtitle: "Every file tool you need.",
    rotatingPhrases: [
