...
export const uk: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Ваші файли ніколи не залишають Ваш комп'ютер.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Самостійно розміщуваний набір інструментів для обробки файлів з пріоритетом конфіденційності. 157 інструментів для зображень, відео, аудіо, PDF та даних. Обробка, конвертація, стиснення та автоматизація робочих процесів без надсилання даних у хмару.",
      versionLabel: "Версія:",
  ...
  auth: {
    ...
    heroSubtitle: "Усі інструменти для роботи з файлами.",
    rotatingPhrases: [
      ...
      "157 інструментів.",
      "19 AI-моделей. На Вашому обладнанні.",
      ...
      "Встановлення за хвилини з Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Анонімна статистика використання допомагає нам виправляти помилки та створювати потрібні Вам інструменти. Ваші файли залишаються на Вашому комп'ютері.",
    ...
    settingsPrivacy: "Ваші файли ніколи не залишають Ваш комп'ютер.",
