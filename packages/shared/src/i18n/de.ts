...
export const de: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Ihre Dateien verlassen niemals Ihren Rechner.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Eine selbst gehostete, datenschutzorientierte Dateiverarbeitungssuite mit 157 Werkzeugen fuer Bild, Video, Audio, PDF und Daten. Verarbeiten, konvertieren, komprimieren und Dateiablaeufe automatisieren, ohne Daten in die Cloud zu senden.",
  ...
  auth: {
    ...
    heroSubtitle: "Jedes Dateiwerkzeug, das Sie brauchen.",
    rotatingPhrases: [
      ...
      "In Minuten mit Docker Compose bereit.",
  ...
  analytics: {
    ...
    consentDescription:
      "Anonyme Nutzungsstatistiken helfen uns, Fehler zu beheben und die Werkzeuge zu entwickeln, die Sie wirklich brauchen. Ihre Dateien bleiben auf Ihrem Rechner.",
    ...
    settingsPrivacy: "Ihre Dateien verlassen niemals Ihren Rechner.",
