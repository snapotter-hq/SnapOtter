...
export const nl: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Je bestanden verlaten nooit je computer.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Een zelf-gehoste, privacy-first bestandsverwerkingssuite met 157 tools voor afbeeldingen, video, audio, PDF en data. Verwerken, converteren, comprimeren en je bestandsworkflows automatiseren zonder data naar de cloud te sturen.",
      versionLabel: "Versie:",
      linksHeading: "Links",
  ...
  auth: {
    ...
    heroSubtitle: "Elke bestandstool die je nodig hebt.",
    rotatingPhrases: [
      ...
      "Klaar in minuten met Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Anonieme gebruiksstatistieken helpen ons bugs te fixen en tools te bouwen die je echt nodig hebt. Je bestanden blijven op je computer.",
    ...
    settingsPrivacy: "Je bestanden verlaten nooit je computer.",
  ...
  a11y: {
    ...
    nextImage: "Volgend bestand",
    imageArea: "Voorbeeldgebied",
    imageViewer: "Bestandsviewer",
    fileDropZone: "File drop zone",
    imageDropZone: "Bestand-dropzone",
    beforeAfterSlider: "Before/after comparison slider",
    imageControls: "Voorbeeldbediening",
