...
export const ptBR: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Uma suite de manipulacao de arquivos auto-hospedada e focada em privacidade, com 157 ferramentas para imagem, video, audio, PDF e dados. Processe, converta, comprima e automatize seus fluxos de trabalho de arquivos sem enviar dados para a nuvem.",
      versionLabel: "Versao:",
      linksHeading: "Links",
  ...
  auth: {
    ...
    heroSubtitle: "Todas as ferramentas de arquivo que voce precisa.",
    rotatingPhrases: [
      ...
      "Instala em minutos com Docker Compose.",
