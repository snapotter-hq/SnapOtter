...
export const zhTW: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "自架式、隱私優先的檔案處理套件，內含157個工具，涵蓋影像、影片、音訊、PDF及資料。處理、轉換、壓縮，自動化檔案工作流程，無需將資料傳送到雲端。",
      versionLabel: "版本：",
      linksHeading: "連結",
