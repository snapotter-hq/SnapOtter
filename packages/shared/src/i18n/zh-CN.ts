...
export const zhCN: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "自托管、隐私优先的文件处理套件，包含 157 种工具，涵盖图片、视频、音频、PDF 和数据。处理、转换、压缩，自动化您的文件工作流，无需将数据发送到云端。",
      versionLabel: "版本：",
      linksHeading: "链接",
