...
export const zhCN: TranslationKeys = {
  ...
  toolSettings: {
    ...
    "pipeline-step": {
      noConfigurableSettingsDefaultsWill: "没有可配置的设置，将使用默认值。",
    },
    "html-to-image-results": {
      capturedScreenshot: "截图结果",
    },
    "eraser-canvas": {
      paintOverObjectsToErase: "涂抹要擦除的物体",
    },
    "crop-canvas": {
      original: "原始：",
      cropPreview: "裁剪预览",
      cropRegionSize: "裁剪区域：{width} x {height}",
    ...
    "image-to-base64-results": {
      ...
      downloadTxt: "下载 .txt",
      completedOfTotalFiles: "{completed} / {total} 个文件",
      convertedOfTotal: "已转换 {done} / {total}",
      preview: "预览",
      filesReadyClickConvert: "{count} 个文件已就绪。点击「转换为 Base64」开始。",
      clickConvertToConvert: "点击「转换为 Base64」进行转换。",
      convertedOfTotalWithFailed: "已转换 {done} / {total}，{count} 个失败",
      tabDataUri: "Data URI",
      tabRawBase64: "原始 Base64",
      startingConversion: "开始转换...",
      uploadImagesAndClickConvert: "上传图片并点击「转换为 Base64」开始。",
      copyAllAsJson: "全部复制为 JSON",
      downloadAllAsJson: "全部下载为 JSON",
      downloadAllAsText: "全部下载为文本",
      noResultForThisFile: "此文件暂无结果，可能尚未处理。",
    },
    "split-canvas": {
      loadingPreview: "正在加载预览...",
      splitGridOverlay: "分割网格叠加层",
      infoBar: "{width} x {height}px · {cols}x{rows} 网格 · {count} 个切片",
    },
    "remove-bg": {
      original: "原始：",
      transparent: "透明",
      ...
      processedKb: "处理后：{size} KB",
    },
    "ocr-pdf-view": {
      extractedText: "提取的文字",
      copied: "已复制",
      loadingExtractedText: "正在加载提取的文字...",
      noTextFound: "（未找到文字）",
      extractingText: "正在提取文字...",
      theExtractedTextWillAppear: "运行 OCR 后，提取的文字将显示在此处。",
    },
    "image-enhancement": {
      original: "原始：",
      removesNoiseAndArtifactsUsing: "利用 AI 移除噪点和伪影",
      analyzingImage: "正在分析图片...",
      imageLooksGoodFineTune: "图片状态良好。可使用强度滑块进行微调。",
      deepEnhance: "深度增强",
      enhance: "增强",
      sharpenFilter: "锐化滤镜",
      whiteBalanceTemperatureFilter: "白平衡色温滤镜",
      originalSizeKb: "原始：{size} KB",
      enhancedSizeKb: "增强后：{size} KB",
    },
    "find-duplicates-results": {
      ...
      unique: "唯一：",
      spaceSaveable: "可节省空间：",
      noDuplicatesFound: "未发现重复项",
      noPreview: "无预览",
      backToOverview: "返回概览",
      fileSize: "文件大小",
      similarity: "相似度",
      scanningForDuplicates: "正在扫描重复项...",
      chooseADetectionModeAnd: "选择检测模式并点击「扫描」以查找重复项。",
      allImagesUnique: "全部 {count} 张图片都是唯一的。",
      percentSimilar: "相似度 {percent}%",
      imagesClickToCompare: "{count} 张图片 · 点击对比 ›",
      groupOf: "第 {current} 组，共 {total} 组",
      showingAllImagesInGroup: "显示该组的全部 {count} 张图片。点击任意图片将其设为「最佳」。",
      selectedAsBest: "已选为最佳",
      clickToMarkAsBest: "点击标记为最佳",
    },
    "conversion-preset": {
      quality: "质量",
      high: "高",
    ...
    color: {
      ...
      blue: "蓝",
      resetAll: "全部重置",
      adjustingColors: "正在调整颜色",
      apply: "应用",
      temperatureAndTintColorFilter: "色温与色调滤镜",
      colorChannelFilter: "颜色通道滤镜",
      sharpenFilter: "锐化滤镜",
      originalKb: "原始：{size} KB",
      processedKb: "处理后：{size} KB",
    ...
    "strip-metadata": {
      ...
      processedSize: "处理后：{size} KB",
      fieldsCount: "{count} 个字段",
      locationCoords: "位置数据：{lat}, {lon}",
    ...
    "edit-metadata": {
      ...
      photographerCreatorName: "摄影师/作者姓名",
      imageTitle: "图片标题",
      shortHeadline: "简短标题",
      cityName: "城市名称",
      stateOrProvince: "省份",
      countryName: "国家名称",
      saveCurrentValuesAsTemplate: "将当前值保存为模板",
      gpsCleared2: "，GPS 已清除",
      gpsAdded2: "，GPS 已添加",
      datesShifted2: "，日期已偏移",
      originalSizeKb: "原始：{size} KB",
    ...
    "image-to-pdf": {
      preview: "预览",
      targetMetWithQuality: "已达到目标（JPEG 质量：{quality}%）",
    ...
    "pdf-to-image": {
      ...
      page: "页",
      custom: "自定义",
      uploadAPdfToGet: "上传 PDF 以开始",
      generatingPagePreviews: "正在生成页面预览...",
      selectAll: "全选",
      deselectAll: "取消全选",
      convertingSelected: "正在转换 {count} 页...",
      convertingSelectedPlural: "正在转换 {count} 页...",
      pagesConverted: "已转换 {count} 页",
      pagesConvertedPlural: "已转换 {count} 页",
      selectedOfPages: "已选择 {selected} / {total} 页",
      selectedOfPagesPlural: "已选择 {selected} / {total} 页",
      pageAlt: "第 {page} 页",
    ...
    favicon: {
      ...
      themeColor: "主题色",
      themeColor2: "主题色",
      usedInManifestJsonFor: "用于 manifest.json，设置浏览器界面颜色",
    ...
    "enhance-faces": {
      ...
      fewerFaces: "更少人脸",
      moreFaces: "更多人脸",
      onlyEnhanceMainFace: "仅增强主要人脸",
      forPortraitsIgnoresBackgroundFaces: "适用于人像，忽略背景人脸",
      originalSizeKb: "原始：{size} KB",
      enhancedSizeKb: "增强后：{size} KB",
    ...
    "smart-crop": {
      ...
      detectionSensitivity: "检测灵敏度",
      moreFaces: "更多人脸",
      swapWidthAndHeight: "交换宽高",
      smartCropping: "正在智能裁剪",
      submitSubjectBatch: "智能裁剪（{count} 个文件）",
      submitFaceBatch: "人脸裁剪（{count} 个文件）",
      submitTrimBatch: "裁切边框（{count} 个文件）",
      subjectFocus: "主体聚焦",
      faceFocus: "人脸聚焦",
      autoTrim: "自动裁切",
      customSize: "自定义大小",
    ...
    "passport-photo": {
      ...
      faceCenteredDetail: "人脸未居中。请裁剪或调整照片位置。",
      headLevelDetail: "头部倾斜。请摆正头部或旋转照片。",
      lookingStraightDetail: "面部偏向一侧。请直视相机。",
      faceSizeDetail: "人脸过小。请靠近相机或裁剪得更紧一些。",
      regionAmericas: "美洲",
      regionEurope: "欧洲",
      regionAsia: "亚洲",
      regionMiddleEast: "中东",
      ...
      bgWhite: "白色",
      bgOffWhite: "米白色",
      bgLightGray: "浅灰色（英国/德国）",
      bgLightBlue: "浅蓝色（法国）",
      bgRed: "红色（印度尼西亚）",
      detectingLandmarksShort: "正在检测人脸特征点...",
      country: "国家",
    ...
    "transparency-fixer": {
      webp: "WebP",
      progressLabelBatch: "正在修复透明度（{count} 个文件）",
    ...
    "background-replace": {
      ...
      color22: "颜色 2",
      angleValue: "角度：{angle}°",
      edgeFeatherValue: "边缘羽化：{feather}px",
      color: "背景颜色",
      submit: "替换背景",
    ...
    "blur-background": {
      ...
      outputFormat: "输出格式",
      edgeFeather: "边缘羽化",
      softensTheEdgeBetweenSubject: "柔化主体与模糊背景之间的边缘",
      intensity: "模糊强度",
      submit: "模糊背景",
    ...
    "watermark-text": {
      original: "原始：",
      applyWatermark: "应用水印",
      tiledRepeating: "平铺（重复）",
      originalKb: "原始：{size} KB",
      processedKb: "处理后：{size} KB",
      applyWatermarkBatch: "应用水印（{count} 个文件）",
      watermarkText: "水印文字",
      fontSize: "字号",
      color: "颜色",
      opacity: "不透明度",
    ...
    "meme-generator": {
      ...
      noTemplatesMatchYourSearch: "没有符合搜索条件的模板",
      backToTemplates: "返回模板",
      chooseATextLayout: "选择文字布局",
      generatedMeme: "生成的 Meme",
      newMeme: "新建 Meme",
      yourMemeIsReady: "您的 Meme 已就绪。",
      editAgain: "再次编辑",
    ...
    compare: {
      secondImage: "第二张图片",
      chooseSecondImage: "选择第二张图片",
      comparing: "对比中...",
      downloadDiffImage: "下载差异图",
    ...
    "find-duplicates": {
      ...
      spaceSaveable: "可节省空间",
      skipped: "已跳过",
      downloadGrouped: "按组下载",
      downloadUniqueOnly: "仅下载唯一图片",
      reScanWithDifferentSettings: "使用不同设置重新扫描",
      skippedFileOne: "{count} 个文件无法分析",
      skippedFileOther: "{count} 个文件无法分析",
      uploadingPercent: "上传中... {percent}%",
      scanImages: "扫描 {count} 张图片",
      preset: "预设",
      exact: "精确",
      similar: "相似",
      loose: "宽泛",
    ...
    "qr-generate": {
      ...
      linear: "线性",
      radial: "径向",
      enterContentToGenerateA: "输入内容以生成 QR 码",
      httpsExampleCom: "https://example.com",
      enterAnyText: "输入任意文本...",
      networkNameSsid: "网络名称（SSID）",
      encryption: "加密方式",
      hiddenNetwork: "隐藏网络",
      to: "收件人",
      ...
      useGradient: "使用渐变",
      from: "起点",
      customCornerColors: "自定义角颜色",
      addLogoImage: "添加徽标图片",
      logoSize: "徽标大小",
      logoMargin: "徽标边距",
      cleanAreaBehindLogo: "清除徽标后方区域",
      errorCorrection: "纠错级别",
      low7MaxDensity: "低（7%），密度最高",
      medium15GeneralUse: "中（15%），常规使用",
      quartile25WithSmallLogo: "四分位（25%），适合小徽标",
      high30WithLargeLogo: "高（30%），适合大徽标",
      contentType: "内容类型",
      url: "网址",
      text: "文本",
      wifi: "WiFi",
    ...
    "barcode-read": {
      ...
      scanImagesForQrCodes:
        "扫描图片中的 QR 码、一维条码（Code 128、EAN、UPC 等）和二维码（DataMatrix、PDF417、Aztec）。",
      options: "选项",
      thoroughScan: "深度扫描",
      spendsMoreTimeAnalyzingThe: "花费更多时间分析图片。适用于较小、破损或低对比度的条码。",
      scanningForBarcodes: "正在扫描条码",
      copyAll: "全部复制",
      copyValue: "复制值",
      scanBarcodesBatch: "扫描条码（{count} 个文件）",
      foundBarcode: "找到 {count} 个条码",
      foundBarcodePlural: "找到 {count} 个条码",
      submit: "扫描条码",
    ...
    collage: {
      ...
      background: "背景",
      format: "格式",
      uploadImagesForCollage: "上传图片以创建拼贴",
      drop2OrMoreImages: "拖入 2 张或更多图片即可开始",
      resetPositionAndZoom: "重置位置和缩放",
      collageResult: "拼贴结果",
      backToEditor: "返回编辑器",
      layout: "布局",
      allLayouts: "所有布局",
      ...
      creating: "创建中...",
      sizeKbIn: "输入 {size} KB",
      sizeKbOut: "输出 {size} KB",
      imagesLoadedOne: "已加载 {count} 张图片",
      imagesLoadedOther: "已加载 {count} 张图片",
      bestForImages: "最适合 {count} 张图片",
      inputTotalKb: "输入总计：{size} KB",
      collageKb: "拼贴：{size} KB",
      collageCell: "拼贴单元格 {index}",
      fitEntireImage: "适应整张图片",
      fillCell: "填满单元格",
      submitWithCount: "创建拼贴（{count} 张图片）",
      templateTitle: "{label}（{count} 张图片）",
      template: "模板",
      aspectRatio: "宽高比",
      gap: "间距",
      cornerRadius: "圆角",
    ...
    stitch: {
      ...
      uploading: "上传中...",
      stitching: "拼接中...",
      downloadStitchedImage: "下载拼接图片",
      uploadingPercent: "上传中... {percent}%",
      submitCount: "拼接 {count} 张图片",
      direction: "方向",
      horizontal: "水平",
      vertical: "垂直",
      grid: "网格",
    ...
    split: {
      splitMode: "分割模式",
      tileWidthPx: "切片宽度（px）",
      tileHeightPx: "切片高度（px）",
      splitting: "分割中...",
      downloadAllAsZip: "全部下载（ZIP）",
      imageGridSummary: "图片：{width}x{height}px。网格：{cols}x{rows} = {count} 个切片",
      gridSummary: "{cols}x{rows} = {count} 个切片",
      tileDimsEach: "每个约 {width}x{height}px",
      submitBatch: "分割 {count} 张图片（每张 {tiles} 个切片）",
      splitIntoTiles: "分割为 {count} 个切片",
      imagesSplitSummary: "已分割 {count} 张图片（每张 {tiles} 个切片）",
      tilesGenerated: "已生成 {count} 个切片",
      downloadTile: "下载切片 {label}",
      tileAlt: "切片 {label}",
      modeGrid: "网格",
      modeTileSize: "切片大小",
      presets: "预设",
      ...
      tileWarningSmall: "切片会非常小（{width}x{height}px）",
    },
    border: {
      blur: "模糊",
      opacity: "不透明度",
      ...
      offsetY: "Y 偏移",
      customColor: "自定义颜色",
      applyingBorder: "正在添加边框",
      applyBorder: "添加边框",
      applyBorderBatch: "添加边框（{count} 个文件）",
      presets: "预设",
      borderWidth: "边框宽度",
      borderColor: "边框颜色",
      padding: "内边距",
    ...
    "circle-crop": {
      ...
      transparent: "透明",
      color: "彩色",
      dragThePreviewToReposition: "拖动预览图以调整位置",
      zoom: "缩放",
      borderColor: "边框颜色",
      outputSizePx: "输出大小（px）",
      submit: "圆形裁剪",
    ...
    pixelate: {
      ...
      wholeImage: "整张图像",
      selection: "选区",
      wholeHint: "对整张图像进行像素化",
      width: "宽度",
      height: "高度",
      dragHint: "在图像上拖动选框以调整位置",
      submit: "像素化",
    ...
    "gif-webp": {
      ...
      convertsGifToWebpAnd:
        "在 GIF 与 WebP 之间互相转换，保留所有动画帧。转换方向由输入文件格式自动决定。",
      lossy: "有损",
      lossless: "无损",
      submit: "转换",
      submitBatch: "转换（{count} 个文件）",
    ...
    histogram: {
      generatesAnRgbHistogramChart: "生成 RGB 直方图，展示图片的颜色分布。",
      histogramChart: "直方图",
      submit: "生成直方图",
    ...
    "sprite-sheet": {
      ...
      copyJson: "复制 JSON",
      sheetSummary:
        "{cols} x {rows} 网格 · {cellWidth} x {cellHeight}px 单元格 · {canvasWidth} x {canvasHeight}px 画布",
      columns: "列数",
      padding: "间距",
      background: "背景颜色",
      submit: "创建精灵图",
    ...
    "svg-to-raster": {
      ...
      couldNotDetectDimensionsUsing: "无法检测尺寸，将使用自定义大小。",
      renderDpi: "渲染 DPI",
      progressLabelBatch: "正在转换 {count} 个文件",
      outputFormat: "输出格式",
      sizing: "尺寸",
      scaleMode: "缩放",
      customMode: "自定义",
    ...
    "gif-tools": {
      ...
      horizontal: "水平",
      vertical: "垂直",
      readingGifMetadata: "正在读取 GIF 元数据...",
      staticImage: "静态图片",
      pixels: "像素",
      fewerColorsSmallerFile: "颜色越少，文件越小",
      higherEffortSlowerButSmaller: "强度越高，速度越慢但文件越小",
      reversesThePlaybackOrderOf: "反转所有帧的播放顺序。",
      alsoAdjustSpeed: "同时调整速度",
      loop: "循环",
      originalKb: "原始：{size} KB",
      processedKb: "处理后：{size} KB",
      framesCount: "{count} 帧",
      frameRangeHint: "0 到 {max}（0 为第一帧）",
      extractsAllFrames: "将全部 {count} 帧提取为独立图片并打包为 ZIP。",
      requiresAnimatedGif: "需要动画 GIF",
    ...
    "image-to-base64": {
      ...
      convertBeforeEncodingToControl: "编码前先转换，以控制 MIME 类型和大小",
      lowerQualitySmallerBase64String: "质量越低，Base64 字符串越小",
      maxWidthPx: "最大宽度（px）",
      t0NoLimit: "0 表示无限制",
      maxHeightPx: "最大高度（px）",
      resizeBeforeEncodingAspectRatio: "编码前调整大小，保持宽高比。0 表示无限制。",
      submitWithCount: "转换为 Base64（{count}）",
      outputFormat: "输出格式",
      keepOriginal: "保持原始格式",
      quality: "质量",
      maxWidth: "最大宽度",
    ...
    "trim-video": {
      endTimeMustBeAfter: "结束时间必须晚于开始时间",
      start: "开始（秒）",
      end: "结束（秒）",
      precise: "逐帧精确（重新编码）",
      submit: "裁剪",
  ...
  urlImport: {
    ...
    failedStatus: "失败",
    textareaPlaceholder:
      "https://example.com/photo.jpg\nhttps://example.com/report.pdf\n- https://example.com/clip.mp4\n[我的文件](https://example.com/recording.mp3)",
  },
  comparison: {
    original: "原图",
    processed: "处理后",
    ...
    processedSize: "处理后：{size}",
    smallerBadge: "（缩小 {percent}%）",
  ...
  editor: {
    ...
    options: {
      ...
      cloneStamp: {
        aligned: "对齐",
        altClickHint: "Alt+点击设置取样点",
      },
      crop: {
        ratioLabel: "比例：",
        applyTitle: "应用裁剪（Enter）",
        cancelTitle: "取消裁剪（Esc）",
      },
      dodgeBurn: {
        dodge: "减淡",
        burn: "加深",
      ...
      move: {
        alignLabel: "对齐：",
        alignLeft: "左对齐",
        alignCenterHorizontal: "水平居中",
        alignRight: "右对齐",
        alignTop: "顶端对齐",
        alignCenterVertical: "垂直居中",
        alignBottom: "底端对齐",
        distributeLabel: "分布：",
      ...
      text: {
        ...
        lineHeight: "行高",
        letterSpacing: "字间距",
        switchToPointText: "切换为点文字",
        switchToAreaText: "切换为段落文字",
        area: "段落",
        point: "点",
      },
      transform: {
    ...
    panels: {
      adjustments: {
        ...
        levelsOutWhite: "输出白场",
        presetCustom: "自定义",
        curvesHint: "点击添加控制点，拖动可移动，双击可删除。",
        sectionFilters: "滤镜",
      ...
      color: {
        channelAriaLabel: "{channel} 颜色通道",
        recent: "最近使用",
        swapColorsTitle: "交换颜色（X）",
        resetColorsTitle: "重置颜色（D）",
        foreground: "前景色",
      },
      histogram: {
        noData: "暂无直方图数据",
    ...
    ui: {
      ...
      canvasResize: {
        heading: "画布大小",
        current: "当前：{width} x {height} px",
        anchorLabel: "定位：",
        anchorAriaLabel: "定位到{position}",
        backgroundLabel: "背景：",
        anchors: {
          topLeft: "左上",
          topCenter: "上中",
      ...
      exportDialog: {
        ...
        width: "宽度",
        height: "高度",
        resetToOriginalSize: "重置为原始尺寸（{width} x {height}）",
      ...
      shapeColorPicker: {
        ariaLabel: "{label}颜色选择器",
        noneSelected: "{label}：无",
        setNone: "无{label}",
      },
    },
  },
  settings: {
    ...
    tools: {
      ...
      disabledCountOne: "{count} 个工具已禁用",
      disabledCountOther: "{count} 个工具已禁用",
    },
    experimental: {
      label: "启用实验性工具",
  ...
  auth: {
    ...
    mfaThrottled: "尝试次数过多。请在 {minutes} 分钟后重试。",
    mfaThrottledPlural: "尝试次数过多。请在 {minutes} 分钟后重试。",
    mfaThrottledUnknownWait: "尝试次数过多。请稍后重试。",
    methodSaml: "SAML",
  ...
  files: {
    ...
    download: "下载",
    details: {
      previewFailedRetry: "预览生成失败。请重试。",
    },
  },
  dropzone: {
    unsupportedFileType: "此工具不支持该文件类型",
    urlFetchFailed: "无法从 URL 获取文件",
    ariaLabel: "文件拖放区域",
    dropPrompt: "将文件拖放到此处",
    takePhoto: "拍照",
  ...
  reviewPanel: {
    ...
    downloadAllZipSize: "全部下载（ZIP，{size}）",
    downloadFilesZipSize: "下载 {count} 个文件（ZIP，{size}）",
    downloadTypeSize: "下载 {type}（{size}）",
  },
  features: {
  ...
  appLayout: {
    ...
    aiInstall: {
      installingBundle: "正在安装 {name}",
      defaultBundleName: "AI 功能",
      bundlesInstalled: "已安装 {completed}/{total}",
      bundlesQueued: "{count} 个排队中",
    },
  },
  a11y: {
  ...
  commonUi: {
    ...
    metadataGrid: {
      noData: "无数据",
      restoreField: "恢复 {field}",
      removeField: "移除 {field}",
    },
    multiImageViewer: {
      cannotPreview: "{ext} 文件无法在浏览器中预览。",
    },
    waveform: {
      play: "播放",
      pause: "暂停",
  ...
  privacyPolicy: {
    ...
    overview: {
      heading: "概述",
      body: "SnapOtter 是一款自托管的开源文件处理应用。您的实例完全由部署它的人运营和掌控。本政策说明的是软件本身如何处理您的数据。",
    },
    localProcessing: {
      heading: "本地处理",
      body: "所有文件处理都完全在部署 SnapOtter 的服务器上完成。您的文件绝不会被发送到外部服务或第三方 API。上传文件进行处理时，文件在宿主机的内存或临时存储中处理，操作完成后不会保留。",
    },
    analytics: {
      heading: "使用分析",
      body: "SnapOtter 内置了基础的分析功能（工具使用情况、错误报告），用于改进软件。其中绝不包含您的文件、文件名和个人数据。分析默认开启，可在运行时关闭。管理员可在「设置 > 系统 > {privacy}」中关闭匿名产品分析，无需重启或重新构建。若想在编译期彻底关闭，可使用 {code} 构建，这会将它从打包产物中完全剔除。关闭之后一切功能照常运行。",
      feedbackBody:
        "SnapOtter 还提供可选的反馈提示。只有在您提交时才会发送反馈，且仅在分析功能开启时发送。反馈事件以 {code} 的形式发送到 PostHog。只有当您勾选了联系授权选项，才会发送联系人姓名、邮箱和公司。SnapOtter 不会在反馈中附带文件、文件名、上传路径、OCR/转录结果、私密文档内容或原始错误日志。",
    },
    dataStorage: {
      heading: "数据存储",
      body: "如果启用了身份验证，应用会把用户账户（用户名和哈希后的密码）存储在宿主机的 PostgreSQL 数据库中。如果您使用文件库功能，上传的文件会保存在服务器的文件系统上。所有存储的数据都完全由实例运营者掌控。",
    },
    thirdParty: {
      heading: "第三方服务",
      body: "所有处理都在本地完成，您的文件不会被发送到任何地方。如上所述，匿名使用分析由 PostHog 和 Sentry 提供支持。AI 功能使用随附的模型在本地运行。除此之外不会连接任何外部服务。",
    },
    openSource: {
      heading: "开源",
      body: "SnapOtter 完全开源。您随时可以审查源代码来验证以上说明。透明是这个项目的核心原则。",
    },
    yourControl: {
      heading: "您的控制权",
      body: "由于 SnapOtter 是自托管的，实例运营者对所有数据拥有完全控制权。您随时可以删除服务器上的文件或删除数据库，从而清除自己的数据。您的基础设施之外不存在任何数据。",
    },
  },
} as const;
