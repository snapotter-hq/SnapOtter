...
export const ko: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "파일은 절대 기기 밖으로 나가지 않습니다.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "셀프 호스팅, 개인정보 우선의 파일 처리 도구 모음으로 이미지, 비디오, 오디오, PDF, 데이터 전반에 걸쳐 157개의 도구를 제공합니다. 처리, 변환, 압축 등 파일 워크플로를 클라우드에 데이터를 보내지 않고 자동화할 수 있습니다.",
      versionLabel: "버전:",
      linksHeading: "링크",
  ...
  auth: {
    ...
    heroSubtitle: "필요한 모든 파일 도구가 여기에.",
    rotatingPhrases: [
