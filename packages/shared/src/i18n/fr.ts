...
export const fr: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Vos fichiers ne quittent jamais votre machine.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Une suite de manipulation de fichiers auto-hebergee, axee sur la confidentialite, avec 157 outils pour image, video, audio, PDF et donnees. Traitez, convertissez, compressez et automatisez vos flux de travail sans envoyer de donnees vers le cloud.",
  ...
  auth: {
    ...
    heroSubtitle: "Tous les outils fichier dont vous avez besoin.",
    rotatingPhrases: [
      ...
      "Se deploie en minutes avec Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Les statistiques d'utilisation anonymes nous aident a corriger les bugs et a creer les outils dont vous avez vraiment besoin. Vos fichiers restent sur votre machine.",
    ...
    settingsPrivacy: "Vos fichiers ne quittent jamais votre machine.",
