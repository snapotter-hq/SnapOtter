...
export const tr: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Dosyalarınız asla cihazınızdan ayrılmaz.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Goruntu, video, ses, PDF ve veri icin 157 aracla gizlilik odakli, kendi sunucunuzda barindinlan bir dosya isleme paketi. Buluta veri gondermeden isleme, donusturme, sikistirma ve dosya is akislarinizi otomatiklestirme.",
      versionLabel: "Sürüm:",
  ...
  auth: {
    ...
    heroSubtitle: "İhtiyacınız olan her dosya aracı.",
    rotatingPhrases: [
      "Kayıt yok. Hesap yok.",
      ...
      "157 arac.",
      "19 AI modeli. Sizin donanımınız.",
      ...
      "Docker Compose ile dakikalar icinde dagitim.",
  ...
  analytics: {
    ...
    consentDescription:
      "Anonim kullanım istatistikleri hataları düzeltmemize ve gerçekten ihtiyaç duyduğunuz araçları oluşturmamıza yardımcı olur. Dosyalarınız cihazınızda kalır.",
    ...
    settingsDescription:
      "SnapOtter'ı geliştirmeye yardımcı olmak için anonim kullanım verilerini paylaşın.",
    settingsPrivacy: "Dosyalarınız asla cihazınızdan ayrılmaz.",
