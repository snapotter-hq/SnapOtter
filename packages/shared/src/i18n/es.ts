...
export const es: TranslationKeys = {
  ...
  settings: {
    ...
    analytics: {
      ...
      privacyNote: "Tus archivos nunca salen de tu equipo.",
      disabledByAdmin:
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Una suite de manipulacion de archivos autoalojada y con privacidad como prioridad, con 157 herramientas para imagen, video, audio, PDF y datos. Procesa, convierte, comprime y automatiza tus flujos de trabajo de archivos sin enviar datos a la nube.",
  ...
  auth: {
    ...
    heroSubtitle: "Todas las herramientas de archivos que necesitas.",
    rotatingPhrases: [
      ...
      "Se instala en minutos con Docker Compose.",
  ...
  analytics: {
    ...
    consentDescription:
      "Las estadisticas de uso anonimas nos ayudan a corregir errores y crear las herramientas que realmente necesitas. Tus archivos se quedan en tu equipo.",
    ...
    settingsPrivacy: "Tus archivos nunca salen de tu equipo.",
