...
export default defineConfig({
  title: "SnapOtter",
  description:
    "Documentation for SnapOtter - a self-hosted, open-source file manipulation suite. 157 tools, local AI, pipelines, REST API.",
  base: "/",
  ...
  head: [
    ...
    ["meta", { property: "og:image:alt", content: "SnapOtter - Self-Hosted File Manipulation Suite" }],
...
`,
        customTemplateVariables: {
          description:
            "SnapOtter is a self-hosted, open-source file manipulation suite with 157 tools across image, video, audio, PDF, and data. Deploys via Docker Compose (app + Postgres 17 + Redis 8) with GPU auto-detection.",
          details:
            "Resize, compress, convert, remove backgrounds, upscale, run OCR, transcode video, normalize audio, merge PDFs, and more - without sending files to external services.",
        },
      }),
    ],
  },
