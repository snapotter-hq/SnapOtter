...
يدعم SnapOtter أكثر من 55 تنسيق صور للإدخال و17 تنسيقاً للإخراج.
...
## تنسيقات الإخراج (17) {#output-formats-13}
...
| PSD | واجهة ImageMagick | بلا فقدان | أداة التحويل |
| PPM | واجهة ImageMagick | بلا فقدان | أداة التحويل |
| EPS | واجهة ImageMagick | بلا فقدان | أداة التحويل |
| TGA | واجهة ImageMagick | بلا فقدان | أداة التحويل |
