...
SnapOtter поддерживает 55+ форматов изображений на входе и 17 форматов на выходе.
...
## Выходные форматы (17) {#output-formats-13}
...
| PSD | ImageMagick CLI | Без потерь | Инструмент Convert |
| PPM | ImageMagick CLI | Без потерь | Инструмент Convert |
| EPS | ImageMagick CLI | Без потерь | Инструмент Convert |
| TGA | ImageMagick CLI | Без потерь | Инструмент Convert |
