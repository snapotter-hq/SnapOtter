...
## Before you start: back up the whole `/data` volume {#before-you-start-back-up-the-whole-data-volume}
...
## Upgrade to 1.17.2 first {#upgrade-to-1-17-2-first}
...
## Check your volume name {#check-your-volume-name}
...
## Path A: single container (quickest) {#path-a-single-container-quickest}
...
## Path B: Compose (recommended for production) {#path-b-compose-recommended-for-production}
...
## Preview the import first (optional) {#preview-the-import-first-optional}
...
## What carries over, and what does not {#what-carries-over-and-what-does-not}
...
## Turning the import off {#turning-the-import-off}
...
## If you already have data in the 2.0 instance {#if-you-already-have-data-in-the-2-0-instance}
