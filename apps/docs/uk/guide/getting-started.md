...
## Використання з телефона {#use-it-from-your-phone}

SnapOtter працює в мобільних браузерах, і його можна встановити як застосунок. Відкрийте свій екземпляр на телефоні, а далі:

- **iPhone / iPad (Safari):** торкніться «Поділитися», потім **На Початковий екран**.
- **Android (Chrome):** відкрийте меню браузера й торкніться **Установити додаток**.

Установлений застосунок відкривається в окремому вікні одразу з вашим екземпляром.

Один нюанс: браузери пропонують установлення лише через HTTPS. Звичайна HTTP-адреса в локальній мережі й далі працює у вкладці браузера, але для справжнього встановлення розмістіть екземпляр за зворотним проксі із сертифікатом (див. [посібник із розгортання](/uk/guide/deployment)).

На телефонах і планшетах інструменти для зображень показують кнопку **Зробити фото** поруч із кнопкою завантаження. Сфотографуйте чек або дошку, і знімок одразу потрапить в інструмент.
