...
export const TOOL_SEO: Record<string, ToolSeo> = {
  ...
  "jpg-to-png": {
    ...
    longDescription:
      "Convert JPG images to PNG. JPEG is built for photographs, and it is the one raster format every piece of software opens; PNG for screenshots, logos, and anything with flat colour or sharp edges. PNG is lossless, but it cannot restore what JPG already discarded. Expect a larger file at the same visible quality, which pays off when the image faces more editing. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a JPG into PNG before editing, so repeated saves stop degrading it",
      "Get a PNG with a real alpha channel to cut a subject out of",
      "Satisfy an upload form or pipeline that takes PNG and rejects JPG",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of JPG files",
      "Metadata and colour profile carried over wherever PNG can hold them",
      "Your JPG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting JPG to PNG lose quality?",
        a: "Nothing is lost in this direction, but nothing is regained either. It is worth doing before editing, and pointless purely as an archive upgrade.",
      },
      {
        q: "Which quality setting should I use?",
        a: "Start at the default, then lower it until you can see the difference at the size the image is actually viewed. Most photographs hold up further down than people expect.",
      },
      {
        q: "Can I go back to JPG afterwards?",
        a: "You can convert back, but you will not recover the original. JPG discarded detail when it was first written, and PNG cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "png-to-jpg": {
    ...
    longDescription:
      "Convert PNG images to JPG. PNG is built for screenshots, logos, and anything with flat colour or sharp edges; JPEG for photographs, and it is the one raster format every piece of software opens. JPG has no alpha channel, so transparency is flattened onto a solid background. JPG is lossy, trading some detail for a far smaller file. Keep the PNG if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving JPG instead of PNG",
      "Batch a folder of PNG files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects PNG",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of PNG files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your PNG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting PNG to JPG lose quality?",
        a: "The visible pixels survive intact; it is the transparency that does not. Composite against the background you will actually display on, or the edges will fringe.",
      },
      {
        q: "What happens to transparent areas?",
        a: "They are composited onto a background colour you choose, white by default. There is no way around it: JPG has nowhere to store an alpha channel.",
      },
      {
        q: "Can I go back to PNG afterwards?",
        a: "You can, and if JPG is lossless the round trip is clean. If JPG is lossy, converting back gives you a PNG wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "jpg-to-webp": {
    ...
    longDescription:
      "Convert JPG images to WebP. JPEG is built for photographs, and it is the one raster format every piece of software opens; WebP for the web, where it usually lands 25-35% smaller than an equivalent JPEG. Both formats are lossy, so this is a re-encode and a little detail goes each time. Start from the best source you have rather than chaining conversions. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving WebP instead of JPG",
      "Get a WebP with a real alpha channel to cut a subject out of",
      "Satisfy an upload form or pipeline that takes WebP and rejects JPG",
    ],
    features: [
      "Quality control over the WebP encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of JPG files",
      "Metadata and colour profile carried over wherever WebP can hold them",
      "Your JPG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting JPG to WebP lose quality?",
        a: "Convert once from the best original you have. Chaining conversions is what visibly degrades an image, not any single hop.",
      },
      {
        q: "Which quality setting should I use?",
        a: "Start at the default, then lower it until you can see the difference at the size the image is actually viewed. Most photographs hold up further down than people expect.",
      ...
      {
        q: "Can I go back to JPG afterwards?",
        a: "You can convert back, but you will not recover the original. JPG discarded detail when it was first written, and WebP cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "png-to-webp": {
    ...
    longDescription:
      "Convert PNG images to WebP. PNG is built for screenshots, logos, and anything with flat colour or sharp edges; WebP for the web, where it usually lands 25-35% smaller than an equivalent JPEG. WebP is lossy, trading some detail for a far smaller file. Keep the PNG if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving WebP instead of PNG",
      "Batch a folder of PNG files into WebP in one pass",
      "Satisfy an upload form or pipeline that takes WebP and rejects PNG",
    ],
    features: [
      "Quality control over the WebP encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of PNG files",
    ...
    faqs: [
      {
        q: "Will converting PNG to WebP lose quality?",
        a: "Judge it at the size the image is actually viewed, not zoomed to 100%. Most photographs survive far more compression than people expect.",
      },
      {
        q: "Which quality setting should I use?",
        a: "Start at the default, then lower it until you can see the difference at the size the image is actually viewed. Most photographs hold up further down than people expect.",
      ...
      {
        q: "Can I go back to PNG afterwards?",
        a: "You can, and if WebP is lossless the round trip is clean. If WebP is lossy, converting back gives you a PNG wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "webp-to-jpg": {
    ...
    longDescription:
      "Convert WebP images to JPG. WebP is built for the web, where it usually lands 25-35% smaller than an equivalent JPEG; JPEG for photographs, and it is the one raster format every piece of software opens. JPG holds a single frame, so an animated WebP is reduced to its first frame. JPG has no alpha channel, so transparency is flattened onto a solid background. Both formats are lossy, so this is a re-encode and a little detail goes each time. Start from the best source you have rather than chaining conversions. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving JPG instead of WebP",
      "Batch a folder of WebP files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects WebP",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of WebP files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your WebP files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting WebP to JPG lose quality?",
        a: "Only the first frame survives, so if the animation is the point, convert to WebP or MP4 instead and keep the motion.",
      },
      {
        q: "What happens to transparent areas?",
        a: "They are composited onto a background colour you choose, white by default. There is no way around it: JPG has nowhere to store an alpha channel.",
      ...
      {
        q: "Can I go back to WebP afterwards?",
        a: "You can convert back, but you will not recover the original. WebP discarded detail when it was first written, and JPG cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "webp-to-png": {
    ...
    longDescription:
      "Convert WebP images to PNG. WebP is built for the web, where it usually lands 25-35% smaller than an equivalent JPEG; PNG for screenshots, logos, and anything with flat colour or sharp edges. PNG holds a single frame, so an animated WebP is reduced to its first frame. PNG is lossless, but it cannot restore what WebP already discarded. Expect a larger file at the same visible quality, which pays off when the image faces more editing. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a WebP into PNG before editing, so repeated saves stop degrading it",
      "Batch a folder of WebP files into PNG in one pass",
      "Satisfy an upload form or pipeline that takes PNG and rejects WebP",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of WebP files",
    ...
    faqs: [
      {
        q: "Will converting WebP to PNG lose quality?",
        a: "Only the first frame survives, so if the animation is the point, convert to WebP or MP4 instead and keep the motion.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to WebP afterwards?",
        a: "You can convert back, but you will not recover the original. WebP discarded detail when it was first written, and PNG cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "jpg-to-avif": {
    ...
    longDescription:
      "Convert JPG images to AVIF. JPEG is built for photographs, and it is the one raster format every piece of software opens; AVIF for the web, where it generally beats both JPEG and WebP on size at matched quality. Both formats are lossy, so this is a re-encode and a little detail goes each time. Start from the best source you have rather than chaining conversions. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving AVIF instead of JPG",
      "Get a AVIF with a real alpha channel to cut a subject out of",
      "Satisfy an upload form or pipeline that takes AVIF and rejects JPG",
    ],
    features: [
      "Quality control over the AVIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of JPG files",
      "Metadata and colour profile carried over wherever AVIF can hold them",
      "Your JPG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting JPG to AVIF lose quality?",
        a: "Convert once from the best original you have. Chaining conversions is what visibly degrades an image, not any single hop.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to JPG afterwards?",
        a: "You can convert back, but you will not recover the original. JPG discarded detail when it was first written, and AVIF cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "png-to-avif": {
    ...
    longDescription:
      "Convert PNG images to AVIF. PNG is built for screenshots, logos, and anything with flat colour or sharp edges; AVIF for the web, where it generally beats both JPEG and WebP on size at matched quality. AVIF is lossy, trading some detail for a far smaller file. Keep the PNG if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving AVIF instead of PNG",
      "Batch a folder of PNG files into AVIF in one pass",
      "Satisfy an upload form or pipeline that takes AVIF and rejects PNG",
    ],
    features: [
      "Quality control over the AVIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of PNG files",
    ...
    faqs: [
      {
        q: "Will converting PNG to AVIF lose quality?",
        a: "Judge it at the size the image is actually viewed, not zoomed to 100%. Most photographs survive far more compression than people expect.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to PNG afterwards?",
        a: "You can, and if AVIF is lossless the round trip is clean. If AVIF is lossy, converting back gives you a PNG wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "webp-to-avif": {
    ...
    longDescription:
      "Convert WebP images to AVIF. WebP is built for the web, where it usually lands 25-35% smaller than an equivalent JPEG; AVIF for the web, where it generally beats both JPEG and WebP on size at matched quality. Both formats are lossy, so this is a re-encode and a little detail goes each time. Start from the best source you have rather than chaining conversions. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving AVIF instead of WebP",
      "Batch a folder of WebP files into AVIF in one pass",
      "Satisfy an upload form or pipeline that takes AVIF and rejects WebP",
    ],
    features: [
      "Quality control over the AVIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of WebP files",
    ...
    faqs: [
      {
        q: "Will converting WebP to AVIF lose quality?",
        a: "Convert once from the best original you have. Chaining conversions is what visibly degrades an image, not any single hop.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to WebP afterwards?",
        a: "You can convert back, but you will not recover the original. WebP discarded detail when it was first written, and AVIF cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "heic-to-jpg": {
    ...
    longDescription:
      "Convert HEIC images to JPG. HEIC is built for iPhone camera rolls, and very little outside Apple's ecosystem; JPEG for photographs, and it is the one raster format every piece of software opens. JPG has no alpha channel, so transparency is flattened onto a solid background. Both formats are lossy, so this is a re-encode and a little detail goes each time. Start from the best source you have rather than chaining conversions. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Open iPhone photos in software that has never heard of HEIC",
      "Batch a folder of HEIC files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects HEIC",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of HEIC files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your HEIC files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
      ...
      {
        q: "Can I go back to HEIC afterwards?",
        a: "You can convert back, but you will not recover the original. HEIC discarded detail when it was first written, and JPG cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "heic-to-png": {
    ...
    longDescription:
      "Convert HEIC images to PNG. HEIC is built for iPhone camera rolls, and very little outside Apple's ecosystem; PNG for screenshots, logos, and anything with flat colour or sharp edges. PNG is lossless, but it cannot restore what HEIC already discarded. Expect a larger file at the same visible quality, which pays off when the image faces more editing. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Open iPhone photos in software that has never heard of HEIC",
      "Batch a folder of HEIC files into PNG in one pass",
      "Satisfy an upload form or pipeline that takes PNG and rejects HEIC",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of HEIC files",
    ...
    faqs: [
      {
        q: "Will converting HEIC to PNG lose quality?",
        a: "Nothing is lost in this direction, but nothing is regained either. It is worth doing before editing, and pointless purely as an archive upgrade.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to HEIC afterwards?",
        a: "You can convert back, but you will not recover the original. HEIC discarded detail when it was first written, and PNG cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "heic-to-avif": {
    ...
    longDescription:
      "Convert HEIC images to AVIF. HEIC is built for iPhone camera rolls, and very little outside Apple's ecosystem; AVIF for the web, where it generally beats both JPEG and WebP on size at matched quality. Both formats are lossy, so this is a re-encode and a little detail goes each time. Start from the best source you have rather than chaining conversions. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Open iPhone photos in software that has never heard of HEIC",
      "Batch a folder of HEIC files into AVIF in one pass",
      "Satisfy an upload form or pipeline that takes AVIF and rejects HEIC",
    ],
    features: [
      "Quality control over the AVIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of HEIC files",
    ...
    faqs: [
      {
        q: "Will converting HEIC to AVIF lose quality?",
        a: "Convert once from the best original you have. Chaining conversions is what visibly degrades an image, not any single hop.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to HEIC afterwards?",
        a: "You can convert back, but you will not recover the original. HEIC discarded detail when it was first written, and AVIF cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "jpg-to-gif": {
    ...
    longDescription:
      "Convert JPG images to GIF. JPEG is built for photographs, and it is the one raster format every piece of software opens; GIF for short looping animation, paid for with a 256-colour palette. GIF allows 256 colours per frame, so photographic gradients will band. It suits flat graphics and short loops, not photos. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a JPG into GIF before editing, so repeated saves stop degrading it",
      "Build a short loop or flat graphic that displays anywhere an image does",
      "Satisfy an upload form or pipeline that takes GIF and rejects JPG",
    ],
    features: [
      "Quality control over the GIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of JPG files",
      "Metadata and colour profile carried over wherever GIF can hold them",
      "Your JPG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting JPG to GIF lose quality?",
        a: "Dithering hides some of the banding at the cost of a noisier, larger file. Flat graphics need none of it; photographs need more than it can give.",
      },
      {
        q: "Which quality setting should I use?",
        a: "Start at the default, then lower it until you can see the difference at the size the image is actually viewed. Most photographs hold up further down than people expect.",
      ...
      {
        q: "Can I go back to JPG afterwards?",
        a: "You can convert back, but you will not recover the original. JPG discarded detail when it was first written, and GIF cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "png-to-gif": {
    ...
    longDescription:
      "Convert PNG images to GIF. PNG is built for screenshots, logos, and anything with flat colour or sharp edges; GIF for short looping animation, paid for with a 256-colour palette. GIF allows 256 colours per frame, so photographic gradients will band. It suits flat graphics and short loops, not photos. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving GIF instead of PNG",
      "Build a short loop or flat graphic that displays anywhere an image does",
      "Satisfy an upload form or pipeline that takes GIF and rejects PNG",
    ],
    features: [
      "Quality control over the GIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of PNG files",
    ...
    faqs: [
      {
        q: "Will converting PNG to GIF lose quality?",
        a: "Dithering hides some of the banding at the cost of a noisier, larger file. Flat graphics need none of it; photographs need more than it can give.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to PNG afterwards?",
        a: "You can, and if GIF is lossless the round trip is clean. If GIF is lossy, converting back gives you a PNG wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "gif-to-jpg": {
    ...
    longDescription:
      "Convert GIF images to JPG. GIF is built for short looping animation, paid for with a 256-colour palette; JPEG for photographs, and it is the one raster format every piece of software opens. JPG holds a single frame, so an animated GIF is reduced to its first frame. JPG has no alpha channel, so transparency is flattened onto a solid background. JPG is lossy, trading some detail for a far smaller file. Keep the GIF if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving JPG instead of GIF",
      "Batch a folder of GIF files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects GIF",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of GIF files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your GIF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting GIF to JPG lose quality?",
        a: "Only the first frame survives, so if the animation is the point, convert to WebP or MP4 instead and keep the motion.",
      },
      {
        q: "What happens to transparent areas?",
      ...
      {
        q: "Can I go back to GIF afterwards?",
        a: "You can, and if JPG is lossless the round trip is clean. If JPG is lossy, converting back gives you a GIF wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "gif-to-png": {
    ...
    longDescription:
      "Convert GIF images to PNG. GIF is built for short looping animation, paid for with a 256-colour palette; PNG for screenshots, logos, and anything with flat colour or sharp edges. PNG holds a single frame, so an animated GIF is reduced to its first frame. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving PNG instead of GIF",
      "Batch a folder of GIF files into PNG in one pass",
      "Satisfy an upload form or pipeline that takes PNG and rejects GIF",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of GIF files",
    ...
    faqs: [
      {
        q: "Will converting GIF to PNG lose quality?",
        a: "Only the first frame survives, so if the animation is the point, convert to WebP or MP4 instead and keep the motion.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to GIF afterwards?",
        a: "You can, and if PNG is lossless the round trip is clean. If PNG is lossy, converting back gives you a GIF wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "webp-to-gif": {
    ...
    longDescription:
      "Convert WebP images to GIF. WebP is built for the web, where it usually lands 25-35% smaller than an equivalent JPEG; GIF for short looping animation, paid for with a 256-colour palette. GIF allows 256 colours per frame, so photographic gradients will band. It suits flat graphics and short loops, not photos. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a WebP into GIF before editing, so repeated saves stop degrading it",
      "Build a short loop or flat graphic that displays anywhere an image does",
      "Satisfy an upload form or pipeline that takes GIF and rejects WebP",
    ],
    features: [
      "Quality control over the GIF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of WebP files",
    ...
    faqs: [
      {
        q: "Will converting WebP to GIF lose quality?",
        a: "Dithering hides some of the banding at the cost of a noisier, larger file. Flat graphics need none of it; photographs need more than it can give.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to WebP afterwards?",
        a: "You can convert back, but you will not recover the original. WebP discarded detail when it was first written, and GIF cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "jpg-to-tiff": {
    ...
    longDescription:
      "Convert JPG images to TIFF. JPEG is built for photographs, and it is the one raster format every piece of software opens; TIFF for print, scanning, and archival masters, at several times the size of a JPEG. TIFF is lossless, but it cannot restore what JPG already discarded. Expect a larger file at the same visible quality, which pays off when the image faces more editing. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a JPG into TIFF before editing, so repeated saves stop degrading it",
      "Get a TIFF with a real alpha channel to cut a subject out of",
      "Satisfy an upload form or pipeline that takes TIFF and rejects JPG",
    ],
    features: [
      "Quality control over the TIFF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of JPG files",
      "Metadata and colour profile carried over wherever TIFF can hold them",
      "Your JPG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting JPG to TIFF lose quality?",
        a: "Nothing is lost in this direction, but nothing is regained either. It is worth doing before editing, and pointless purely as an archive upgrade.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to JPG afterwards?",
        a: "You can convert back, but you will not recover the original. JPG discarded detail when it was first written, and TIFF cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "png-to-tiff": {
    ...
    longDescription:
      "Convert PNG images to TIFF. PNG is built for screenshots, logos, and anything with flat colour or sharp edges; TIFF for print, scanning, and archival masters, at several times the size of a JPEG. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving TIFF instead of PNG",
      "Batch a folder of PNG files into TIFF in one pass",
      "Satisfy an upload form or pipeline that takes TIFF and rejects PNG",
    ],
    features: [
      "Quality control over the TIFF encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of PNG files",
    ...
    faqs: [
      {
        q: "Will converting PNG to TIFF lose quality?",
        a: "Both formats carry full colour, so the encode quality you pick is the only thing that matters here.",
      },
      {
        q: "Which quality setting should I use?",
        a: "Start at the default, then lower it until you can see the difference at the size the image is actually viewed. Most photographs hold up further down than people expect.",
      ...
      {
        q: "Can I go back to PNG afterwards?",
        a: "You can, and if TIFF is lossless the round trip is clean. If TIFF is lossy, converting back gives you a PNG wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "tiff-to-jpg": {
    ...
    longDescription:
      "Convert TIFF images to JPG. TIFF is built for print, scanning, and archival masters, at several times the size of a JPEG; JPEG for photographs, and it is the one raster format every piece of software opens. JPG has no alpha channel, so transparency is flattened onto a solid background. JPG is lossy, trading some detail for a far smaller file. Keep the TIFF if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving JPG instead of TIFF",
      "Batch a folder of TIFF files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects TIFF",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of TIFF files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your TIFF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting TIFF to JPG lose quality?",
        a: "The visible pixels survive intact; it is the transparency that does not. Composite against the background you will actually display on, or the edges will fringe.",
      },
      {
        q: "What happens to transparent areas?",
      ...
      {
        q: "Can I go back to TIFF afterwards?",
        a: "You can, and if JPG is lossless the round trip is clean. If JPG is lossy, converting back gives you a TIFF wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "tiff-to-png": {
    ...
    longDescription:
      "Convert TIFF images to PNG. TIFF is built for print, scanning, and archival masters, at several times the size of a JPEG; PNG for screenshots, logos, and anything with flat colour or sharp edges. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving PNG instead of TIFF",
      "Batch a folder of TIFF files into PNG in one pass",
      "Satisfy an upload form or pipeline that takes PNG and rejects TIFF",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of TIFF files",
    ...
    faqs: [
      {
        q: "Will converting TIFF to PNG lose quality?",
        a: "Both formats carry full colour, so the encode quality you pick is the only thing that matters here.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to TIFF afterwards?",
        a: "You can, and if PNG is lossless the round trip is clean. If PNG is lossy, converting back gives you a TIFF wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "psd-to-jpg": {
    ...
    longDescription:
      "Convert PSD images to JPG. Photoshop PSD is built for layered Photoshop work, and is unreadable to most non-Adobe software; JPEG for photographs, and it is the one raster format every piece of software opens. JPG has no alpha channel, so transparency is flattened onto a solid background. JPG is lossy, trading some detail for a far smaller file. Keep the PSD if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Hand a Photoshop comp to someone who does not have Photoshop",
      "Batch a folder of PSD files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects PSD",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of PSD files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your PSD files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting PSD to JPG lose quality?",
        a: "The visible pixels survive intact; it is the transparency that does not. Composite against the background you will actually display on, or the edges will fringe.",
      },
      {
        q: "What happens to transparent areas?",
      ...
      {
        q: "Can I go back to PSD afterwards?",
        a: "You can, and if JPG is lossless the round trip is clean. If JPG is lossy, converting back gives you a PSD wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "psd-to-png": {
    ...
    longDescription:
      "Convert PSD images to PNG. Photoshop PSD is built for layered Photoshop work, and is unreadable to most non-Adobe software; PNG for screenshots, logos, and anything with flat colour or sharp edges. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Hand a Photoshop comp to someone who does not have Photoshop",
      "Batch a folder of PSD files into PNG in one pass",
      "Satisfy an upload form or pipeline that takes PNG and rejects PSD",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of PSD files",
    ...
    faqs: [
      {
        q: "Will converting PSD to PNG lose quality?",
        a: "Both formats carry full colour, so the encode quality you pick is the only thing that matters here.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to PSD afterwards?",
        a: "You can, and if PNG is lossless the round trip is clean. If PNG is lossy, converting back gives you a PSD wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "png-to-eps": {
    ...
    longDescription:
      "Convert PNG images to EPS. PNG is built for screenshots, logos, and anything with flat colour or sharp edges; EPS for print and prepress workflows built around PostScript. EPS has no alpha channel, so transparency is flattened onto a solid background. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving EPS instead of PNG",
      "Batch a folder of PNG files into EPS in one pass",
      "Satisfy an upload form or pipeline that takes EPS and rejects PNG",
    ],
    features: [
      "Pick the background colour that transparency is flattened onto",
      "Batch conversion across a folder of PNG files",
      "Metadata and colour profile carried over wherever EPS can hold them",
      "Your PNG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting PNG to EPS lose quality?",
        a: "The visible pixels survive intact; it is the transparency that does not. Composite against the background you will actually display on, or the edges will fringe.",
      },
      {
        q: "What happens to transparent areas?",
        a: "They are composited onto a background colour you choose, white by default. There is no way around it: EPS has nowhere to store an alpha channel.",
      },
      {
        q: "Can I go back to PNG afterwards?",
        a: "You can, and if EPS is lossless the round trip is clean. If EPS is lossy, converting back gives you a PNG wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "jpg-to-eps": {
    ...
    longDescription:
      "Convert JPG images to EPS. JPEG is built for photographs, and it is the one raster format every piece of software opens; EPS for print and prepress workflows built around PostScript. EPS is lossless, but it cannot restore what JPG already discarded. Expect a larger file at the same visible quality, which pays off when the image faces more editing. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a JPG into EPS before editing, so repeated saves stop degrading it",
      "Batch a folder of JPG files into EPS in one pass",
      "Satisfy an upload form or pipeline that takes EPS and rejects JPG",
    ],
    features: [
      "Quality control over the EPS encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of JPG files",
      "Metadata and colour profile carried over wherever EPS can hold them",
      "Your JPG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting JPG to EPS lose quality?",
        a: "Nothing is lost in this direction, but nothing is regained either. It is worth doing before editing, and pointless purely as an archive upgrade.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to JPG afterwards?",
        a: "You can convert back, but you will not recover the original. JPG discarded detail when it was first written, and EPS cannot invent it. Keep the source file if you might need it.",
      },
    ],
  },
  "eps-to-png": {
    ...
    longDescription:
      "Convert EPS images to PNG. EPS is built for print and prepress workflows built around PostScript; PNG for screenshots, logos, and anything with flat colour or sharp edges. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving PNG instead of EPS",
      "Get a PNG with a real alpha channel to cut a subject out of",
      "Satisfy an upload form or pipeline that takes PNG and rejects EPS",
    ],
    features: [
      "Quality control over the PNG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of EPS files",
      "Metadata and colour profile carried over wherever PNG can hold them",
      "Your EPS files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting EPS to PNG lose quality?",
        a: "Both formats carry full colour, so the encode quality you pick is the only thing that matters here.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to EPS afterwards?",
        a: "You can, and if PNG is lossless the round trip is clean. If PNG is lossy, converting back gives you a EPS wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "eps-to-jpg": {
    ...
    longDescription:
      "Convert EPS images to JPG. EPS is built for print and prepress workflows built around PostScript; JPEG for photographs, and it is the one raster format every piece of software opens. JPG is lossy, trading some detail for a far smaller file. Keep the EPS if you still need the pristine original. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by serving JPG instead of EPS",
      "Batch a folder of EPS files into JPG in one pass",
      "Satisfy an upload form or pipeline that takes JPG and rejects EPS",
    ],
    features: [
      "Quality control over the JPG encode, so you choose the size-versus-detail point",
      "Batch conversion across a folder of EPS files",
      "Metadata and colour profile carried over wherever JPG can hold them",
      "Your EPS files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will converting EPS to JPG lose quality?",
        a: "Judge it at the size the image is actually viewed, not zoomed to 100%. Most photographs survive far more compression than people expect.",
      },
      {
        q: "Which quality setting should I use?",
      ...
      {
        q: "Can I go back to EPS afterwards?",
        a: "You can, and if JPG is lossless the round trip is clean. If JPG is lossy, converting back gives you a EPS wrapper around already-degraded pixels rather than the original.",
      },
    ],
  },
  "png-to-svg": {
    ...
    faqs: [
      {
        ...
        a: "No, and nothing can. Once artwork has been rasterised the paths are gone. This traces the pixels into new SVG paths that approximate them. If the true vector source exists anywhere, use that instead.",
      },
      {
        q: "Why does my photo look wrong as SVG?",
      ...
      {
        q: "Any tips for getting a better trace from a PNG?",
        a: "If the PNG has anti-aliased edges, nudge the threshold up so the tracer does not emit a halo of thin intermediate shapes around every boundary.",
      },
      {
        q: "Can I edit the result?",
        a: "Yes. The output is ordinary SVG that opens in Illustrator, Inkscape, Figma, or a text editor.",
      },
    ],
  },
  "jpg-to-svg": {
    ...
    faqs: [
      ...
      {
        q: "Any tips for getting a better trace from a JPG?",
        a: "Blur the JPG very slightly before tracing. It sounds backwards, but it smooths the compression noise the tracer would otherwise faithfully chase.",
      },
      {
        q: "Can I edit the result?",
        a: "Yes. The output is ordinary SVG that opens in Illustrator, Inkscape, Figma, or a text editor.",
  ...
  "tiff-to-svg": {
    ...
    faqs: [
      ...
      {
        q: "Any tips for getting a better trace from a TIFF?",
        a: "Feed the tracer the full-size scan rather than a shrunk copy. High-resolution input traces markedly better, and downsampling first throws away the edge precision it needs.",
      },
      {
        q: "Can I edit the result?",
        a: "Yes. The output is ordinary SVG that opens in Illustrator, Inkscape, Figma, or a text editor.",
  ...
  "psd-to-svg": {
    ...
    longDescription:
      "Trace a PSD image into SVG vector paths. This reads the pixels and redraws them as shapes, so the result is a new drawing rather than a recovered original. Logos, icons, line art, and anything with flat colour and clean edges come out well; photographs, soft gradients, and fine texture do not. A PSD is flattened before tracing, so layers, masks, and effects are baked in. If the PSD contains real vector shape or text layers, those are already vectors and exporting them from Photoshop directly will beat anything a tracer can reconstruct. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Rebuild a logo you only have as a PSD into something that scales cleanly",
      "Turn scanned line art or a signature into editable SVG paths",
      "Prepare artwork for cutting, engraving, or large-format print from a raster source",
    ],
    features: [
      "Traces PSD pixels into SVG paths, which is a redraw and not a 1:1 vector recovery",
      "Tuned for flat colour and hard edges; a poor fit for photographic content",
      "Batch tracing across many PSD files",
      "Your PSD files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
      ...
      {
        q: "Any tips for getting a better trace from a PSD?",
        a: "Flatten deliberately in Photoshop first if you care which layers win. Left alone, the converter composites everything visible and you get whatever that produces.",
      },
      {
        q: "Can I edit the result?",
        a: "Yes. The output is ordinary SVG that opens in Illustrator, Inkscape, Figma, or a text editor.",
  ...
  "eps-to-svg": {
    ...
    faqs: [
      ...
      {
        q: "Any tips for getting a better trace from a EPS?",
        a: "Render at high resolution before tracing, since the trace can only ever be as accurate as the pixels handed to it.",
      },
      {
        q: "Can I edit the result?",
        a: "Yes. The output is ordinary SVG that opens in Illustrator, Inkscape, Figma, or a text editor.",
  ...
  "svg-to-png": {
    ...
    longDescription:
      "Render an SVG into a PNG bitmap at whatever pixel size you need. PNG suits screenshots, logos, and anything with flat colour or sharp edges. Because SVG is vector, nothing is being upscaled: the artwork is redrawn at the target resolution, so a 4000px export is exactly as sharp as a 400px one. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
    ...
    faqs: [
      ...
      {
        q: "Are fonts in my SVG rendered correctly?",
        a: "Text renders when the SVG embeds its glyphs or uses a font the renderer has. If the result looks substituted, convert text to outlines in your editor first.",
      },
      {
        q: "Is there a size or batch limit?",
        a: "No. Self-hosted SnapOtter has no watermarks or quotas beyond the limits you configure yourself.",
      },
    ],
  },
  "svg-to-jpg": {
    ...
    longDescription:
      "Render an SVG into a JPG bitmap at whatever pixel size you need. JPEG suits photographs, and it is the one raster format every piece of software opens. Because SVG is vector, nothing is being upscaled: the artwork is redrawn at the target resolution, so a 4000px export is exactly as sharp as a 400px one. JPG has no alpha channel, so transparent areas are flattened onto a background colour you pick. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Export an icon or logo at the exact pixel dimensions a platform demands",
      "Produce a JPG fallback for somewhere SVG is not accepted",
      "Render one SVG at several sizes for app icons or social images",
    ],
    features: [
      "Set output width and height directly; the vector is redrawn, never upscaled",
  ...
  "jpg-to-pdf": {
    ...
    longDescription:
      "Place JPG images into a PDF, one page each, with page size and orientation under your control. Several JPG files combine into a single document in the order you arrange them.  Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from JPG artwork at a fixed paper size",
      "Bundle a set of JPG images into one attachment instead of a zip",
    ],
    features: [
      "Many JPG files into one PDF, ordered how you arrange them",
    ...
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the JPG files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large JPG makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about JPG specifically?",
        a: "JPG is the usual output of phone cameras and scanners, so this is the common path for turning photographed paperwork into a filed document.",
      },
      {
  ...
  "png-to-pdf": {
    ...
    longDescription:
      "Place PNG images into a PDF, one page each, with page size and orientation under your control. Several PNG files combine into a single document in the order you arrange them.  PNG transparency is composited onto the page background, since PDF pages are opaque. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from PNG artwork at a fixed paper size",
      "Bundle a set of PNG images into one attachment instead of a zip",
    ],
    features: [
      "Many PNG files into one PDF, ordered how you arrange them",
      "Page size, orientation, margin, and fit control",
      "Original image resolution preserved, with no silent downsampling",
      "Your PNG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the PNG files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large PNG makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about PNG specifically?",
        a: "PNG suits screenshots and UI captures, where the sharp text stays crisp because PNG never compressed it lossily in the first place.",
      },
      {
        q: "Is the text in my scans searchable?",
        a: "Not from this tool, which produces image pages. Run OCR PDF afterwards to add a searchable text layer.",
  ...
  "heic-to-pdf": {
    ...
    longDescription:
      "Place HEIC images into a PDF, one page each, with page size and orientation under your control. Several HEIC files combine into a single document in the order you arrange them.  HEIC transparency is composited onto the page background, since PDF pages are opaque. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from HEIC artwork at a fixed paper size",
      "Bundle a set of HEIC images into one attachment instead of a zip",
    ],
    features: [
      "Many HEIC files into one PDF, ordered how you arrange them",
      "Page size, orientation, margin, and fit control",
      "Original image resolution preserved, with no silent downsampling",
      "Your HEIC files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the HEIC files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large HEIC makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about HEIC specifically?",
        a: "HEIC comes straight off an iPhone, and PDF is often the easiest way to hand those photos to someone whose software cannot open HEIC at all.",
      },
      {
        q: "Is the text in my scans searchable?",
        a: "Not from this tool, which produces image pages. Run OCR PDF afterwards to add a searchable text layer.",
  ...
  "tiff-to-pdf": {
    ...
    longDescription:
      "Place TIFF images into a PDF, one page each, with page size and orientation under your control. Several TIFF files combine into a single document in the order you arrange them.  TIFF transparency is composited onto the page background, since PDF pages are opaque. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from TIFF artwork at a fixed paper size",
      "Bundle a set of TIFF images into one attachment instead of a zip",
    ],
    features: [
      "Many TIFF files into one PDF, ordered how you arrange them",
      "Page size, orientation, margin, and fit control",
      "Original image resolution preserved, with no silent downsampling",
      "Your TIFF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the TIFF files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large TIFF makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about TIFF specifically?",
        a: "TIFF is the scanner format, and a single TIFF can already hold many pages. Multi-page TIFFs expand into multiple PDF pages rather than collapsing to one.",
      },
      {
        q: "Is the text in my scans searchable?",
        a: "Not from this tool, which produces image pages. Run OCR PDF afterwards to add a searchable text layer.",
  ...
  "webp-to-pdf": {
    ...
    longDescription:
      "Place WebP images into a PDF, one page each, with page size and orientation under your control. Several WebP files combine into a single document in the order you arrange them.  WebP transparency is composited onto the page background, since PDF pages are opaque. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from WebP artwork at a fixed paper size",
      "Bundle a set of WebP images into one attachment instead of a zip",
    ],
    features: [
      "Many WebP files into one PDF, ordered how you arrange them",
      "Page size, orientation, margin, and fit control",
      "Original image resolution preserved, with no silent downsampling",
      "Your WebP files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the WebP files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large WebP makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about WebP specifically?",
        a: "WebP is a web format rather than a document one, so this is typically about getting downloaded images into something printable and shareable.",
      },
      {
        q: "Is the text in my scans searchable?",
        a: "Not from this tool, which produces image pages. Run OCR PDF afterwards to add a searchable text layer.",
  ...
  "gif-to-pdf": {
    ...
    longDescription:
      "Place GIF images into a PDF, one page each, with page size and orientation under your control. Several GIF files combine into a single document in the order you arrange them.  GIF transparency is composited onto the page background, since PDF pages are opaque. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from GIF artwork at a fixed paper size",
      "Bundle a set of GIF images into one attachment instead of a zip",
    ],
    features: [
      "Many GIF files into one PDF, ordered how you arrange them",
      "Page size, orientation, margin, and fit control",
      "Original image resolution preserved, with no silent downsampling",
      "Your GIF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the GIF files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large GIF makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about GIF specifically?",
        a: "GIF may be animated, and a PDF page cannot be. Animated GIFs contribute their first frame only.",
      },
      {
        q: "Is the text in my scans searchable?",
        a: "Not from this tool, which produces image pages. Run OCR PDF afterwards to add a searchable text layer.",
  ...
  "eps-to-pdf": {
    ...
    longDescription:
      "Place EPS images into a PDF, one page each, with page size and orientation under your control. Several EPS files combine into a single document in the order you arrange them.  Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Combine scanned or photographed pages into one document to email or file",
      "Produce a printable PDF from EPS artwork at a fixed paper size",
      "Bundle a set of EPS images into one attachment instead of a zip",
    ],
    features: [
      "Many EPS files into one PDF, ordered how you arrange them",
      "Page size, orientation, margin, and fit control",
      "Original image resolution preserved, with no silent downsampling",
      "Your EPS files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Will the PDF be much larger than the EPS files?",
        a: "Roughly the sum of the images plus a little structure. PDF wraps the image data rather than re-compressing it, so a large EPS makes a large page. Compress the images first if size matters.",
      },
      {
        q: "Anything to know about EPS specifically?",
        a: "EPS is already PostScript, so it maps onto PDF pages more directly than a bitmap does and vector artwork stays sharp at any zoom.",
      },
      {
        q: "Is the text in my scans searchable?",
        a: "Not from this tool, which produces image pages. Run OCR PDF afterwards to add a searchable text layer.",
  ...
  "pdf-to-jpg": {
    ...
    longDescription:
      "Render each page of a PDF into a separate JPG image at a DPI you choose. 150 DPI suits screen use and 300 DPI matches print. JPG keeps the output small, which suits photo-heavy pages and previews. Text edges soften slightly, so push the DPI up if the pages are mostly type. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Pull page images out of a PDF for a slide deck or a document",
      "Generate thumbnails or previews of a PDF's pages",
      "Get a flat JPG of a page for somewhere PDF is not accepted",
    ],
    features: [
      "Per-page JPG output at a DPI you select",
      "Page range selection instead of the whole document",
      "Multi-page PDFs returned as a zip of numbered images",
      "Your PDF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
      ...
      {
        q: "Anything to watch with JPG output?",
        a: "Quality around 85 is the usual sweet spot for scanned pages: visually clean, and a fraction of the lossless size.",
      },
      {
  ...
  "pdf-to-png": {
    ...
    longDescription:
      "Render each page of a PDF into a separate PNG image at a DPI you choose. 150 DPI suits screen use and 300 DPI matches print. PNG is lossless, so screenshots, diagrams, and small text come out exactly as rendered. Files are larger than JPG, sometimes much larger on photographic pages. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Pull page images out of a PDF for a slide deck or a document",
      "Generate thumbnails or previews of a PDF's pages",
      "Get a flat PNG of a page for somewhere PDF is not accepted",
    ],
    features: [
      "Per-page PNG output at a DPI you select",
      "Page range selection instead of the whole document",
      "Multi-page PDFs returned as a zip of numbered images",
      "Your PDF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Anything to watch with PNG output?",
        a: "Expect roughly 3-5x the file size of the same page rendered to JPG, which is the price of exact text edges.",
      },
      {
        q: "Does this work on password-protected PDFs?",
        a: "Not directly. Remove the password with Unlock PDF first, then convert.",
  ...
  "pdf-to-tiff": {
    ...
    longDescription:
      "Render each page of a PDF into a separate TIFF image at a DPI you choose. 150 DPI suits screen use and 300 DPI matches print. TIFF is the archival and prepress choice, and unlike the others it can hold every page in one multi-page file rather than a folder of separate images. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Pull page images out of a PDF for a slide deck or a document",
      "Generate thumbnails or previews of a PDF's pages",
      "Get a flat TIFF of a page for somewhere PDF is not accepted",
    ],
    features: [
      "Per-page TIFF output at a DPI you select",
      "Page range selection instead of the whole document",
      "Multi-page PDFs returned as a zip of numbered images",
      "Your PDF files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      ...
      {
        q: "Anything to watch with TIFF output?",
        a: "Ask for a single multi-page TIFF when the destination is an archive, rather than a folder of separate page images.",
      },
      {
        q: "Does this work on password-protected PDFs?",
        a: "Not directly. Remove the password with Unlock PDF first, then convert.",
  ...
  "mov-to-mp4": {
    ...
    longDescription:
      "Convert QuickTime MOV video to MP4. MP4 plays essentially everywhere: browsers, phones, TVs, and editors, while MOV plays well on Apple hardware and in editing suites, patchily elsewhere. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MOV recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MP4 before editing",
      "Re-wrap a MOV for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the MOV, rather than trusting the extension",
    ...
    faqs: [
      {
        ...
        a: "A MOV source out of a camera or an editor may hold ProRes or DNxHD, which no browser will play, so this is usually a genuine re-encode rather than a re-wrap. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MP4?",
        a: "Pick MP4 unless you have a specific reason not to. It is the one container you can hand to a stranger and simply expect to work.",
      },
      {
  ...
  "webm-to-mp4": {
    ...
    longDescription:
      "Convert WebM video to MP4. MP4 plays essentially everywhere: browsers, phones, TVs, and editors, while WEBM plays in every modern browser, but not in most desktop players or on TVs. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a WEBM recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MP4 before editing",
      "Re-wrap a WEBM for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the WEBM, rather than trusting the extension",
      "Bitrate and resolution control, or a stream copy when the codecs already line up",
      "Audio carried across and re-encoded only when it has to be",
    ...
    faqs: [
      {
        q: "Does converting WEBM to MP4 reduce quality?",
        a: "A WebM source is VP8, VP9, or AV1. None of those sit inside MP4, MOV, or AVI in any way players actually support, so expect a full re-encode. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MP4?",
        a: "Pick MP4 unless you have a specific reason not to. It is the one container you can hand to a stranger and simply expect to work.",
  ...
  "mkv-to-mp4": {
    ...
    longDescription:
      "Convert Matroska MKV video to MP4. MP4 plays essentially everywhere: browsers, phones, TVs, and editors, while MKV plays in desktop players like VLC, but rarely in browsers or on phones and TVs. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MKV recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MP4 before editing",
      "Re-wrap a MKV for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the MKV, rather than trusting the extension",
      "Bitrate and resolution control, or a stream copy when the codecs already line up",
      "Audio carried across and re-encoded only when it has to be",
    ...
    faqs: [
      {
        q: "Does converting MKV to MP4 reduce quality?",
        a: "An MKV source very often already holds H.264 or H.265, in which case the video is copied across untouched and only the container changes. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MP4?",
        a: "Pick MP4 unless you have a specific reason not to. It is the one container you can hand to a stranger and simply expect to work.",
  ...
  "avi-to-mp4": {
    ...
    longDescription:
      "Convert AVI video to MP4. MP4 plays essentially everywhere: browsers, phones, TVs, and editors, while AVI plays on older Windows software, and is long past being a sensible delivery format. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a AVI recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MP4 before editing",
      "Re-wrap a AVI for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the AVI, rather than trusting the extension",
      "Bitrate and resolution control, or a stream copy when the codecs already line up",
      "Audio carried across and re-encoded only when it has to be",
      "Your AVI files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Does converting AVI to MP4 reduce quality?",
        a: "An AVI source is typically an older codec such as DivX, Xvid, or MJPEG, so a re-encode is unavoidable here, and it is also an upgrade. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MP4?",
        a: "Pick MP4 unless you have a specific reason not to. It is the one container you can hand to a stranger and simply expect to work.",
  ...
  "mp4-to-mov": {
    ...
    longDescription:
      "Convert MP4 video to QuickTime MOV. QuickTime MOV plays well on Apple hardware and in editing suites, patchily elsewhere, while MP4 plays essentially everywhere: browsers, phones, TVs, and editors. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MP4 recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MOV before editing",
      "Re-wrap a MP4 for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the MP4, rather than trusting the extension",
      "Bitrate and resolution control, or a stream copy when the codecs already line up",
      "Audio carried across and re-encoded only when it has to be",
    ...
    faqs: [
      {
        q: "Does converting MP4 to MOV reduce quality?",
        a: "An MP4 source is already H.264 or H.265 in almost every case, so moving it into another container is frequently a straight stream copy that costs nothing in quality and finishes in seconds. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MOV?",
        a: "Pick MOV when the file is heading into Final Cut or Premiere, or staying inside an Apple workflow. For anything you are sending outward, MP4 travels further.",
      },
      {
        q: "How long does it take?",
        a: "A stream copy takes seconds. A full re-encode is bound by your CPU or GPU and scales with length and resolution. Progress is reported live while it runs.",
  ...
  "mp4-to-webm": {
    ...
    longDescription:
      "Convert MP4 video to WebM. WebM plays in every modern browser, but not in most desktop players or on TVs, while MP4 plays essentially everywhere: browsers, phones, TVs, and editors. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MP4 recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on WEBM before editing",
      "Re-wrap a MP4 for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the MP4, rather than trusting the extension",
    ...
    faqs: [
      {
        q: "Does converting MP4 to WEBM reduce quality?",
        a: "An MP4 source is already H.264 or H.265 in almost every case, so moving it into another container is frequently a straight stream copy that costs nothing in quality and finishes in seconds. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target WEBM?",
        a: "Pick WebM for video you serve from your own pages, where you control playback and want smaller files with no licensing questions attached.",
      },
      {
        q: "How long does it take?",
        a: "A stream copy takes seconds. A full re-encode is bound by your CPU or GPU and scales with length and resolution. Progress is reported live while it runs.",
  ...
  "webm-to-mov": {
    ...
    longDescription:
      "Convert WebM video to QuickTime MOV. QuickTime MOV plays well on Apple hardware and in editing suites, patchily elsewhere, while WEBM plays in every modern browser, but not in most desktop players or on TVs. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a WEBM recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MOV before editing",
      "Re-wrap a WEBM for upload without re-shooting or re-exporting",
    ...
    faqs: [
      {
        q: "Does converting WEBM to MOV reduce quality?",
        a: "A WebM source is VP8, VP9, or AV1. None of those sit inside MP4, MOV, or AVI in any way players actually support, so expect a full re-encode. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MOV?",
  ...
  "mkv-to-mov": {
    ...
    longDescription:
      "Convert Matroska MKV video to QuickTime MOV. QuickTime MOV plays well on Apple hardware and in editing suites, patchily elsewhere, while MKV plays in desktop players like VLC, but rarely in browsers or on phones and TVs. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MKV recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MOV before editing",
      "Re-wrap a MKV for upload without re-shooting or re-exporting",
    ...
    faqs: [
      {
        q: "Does converting MKV to MOV reduce quality?",
        a: "An MKV source very often already holds H.264 or H.265, in which case the video is copied across untouched and only the container changes. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MOV?",
  ...
  "avi-to-mov": {
    ...
    longDescription:
      "Convert AVI video to QuickTime MOV. QuickTime MOV plays well on Apple hardware and in editing suites, patchily elsewhere, while AVI plays on older Windows software, and is long past being a sensible delivery format. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a AVI recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MOV before editing",
      "Re-wrap a AVI for upload without re-shooting or re-exporting",
    ...
    faqs: [
      {
        q: "Does converting AVI to MOV reduce quality?",
        a: "An AVI source is typically an older codec such as DivX, Xvid, or MJPEG, so a re-encode is unavoidable here, and it is also an upgrade. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MOV?",
  ...
  "mp4-to-avi": {
    ...
    longDescription:
      "Convert MP4 video to AVI. AVI plays on older Windows software, and is long past being a sensible delivery format, while MP4 plays essentially everywhere: browsers, phones, TVs, and editors. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MP4 recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on AVI before editing",
      "Re-wrap a MP4 for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the MP4, rather than trusting the extension",
    ...
    faqs: [
      {
        q: "Does converting MP4 to AVI reduce quality?",
        a: "An MP4 source is already H.264 or H.265 in almost every case, so moving it into another container is frequently a straight stream copy that costs nothing in quality and finishes in seconds. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target AVI?",
        a: "Pick AVI only because some legacy tool demands it. Nothing built this decade prefers it, and it cannot carry modern codecs cleanly.",
      },
      {
        q: "How long does it take?",
        a: "A stream copy takes seconds. A full re-encode is bound by your CPU or GPU and scales with length and resolution. Progress is reported live while it runs.",
  ...
  "mov-to-avi": {
    ...
    longDescription:
      "Convert QuickTime MOV video to AVI. AVI plays on older Windows software, and is long past being a sensible delivery format, while MOV plays well on Apple hardware and in editing suites, patchily elsewhere. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MOV recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on AVI before editing",
      "Re-wrap a MOV for upload without re-shooting or re-exporting",
    ...
    faqs: [
      {
        q: "Does converting MOV to AVI reduce quality?",
        a: "A MOV source out of a camera or an editor may hold ProRes or DNxHD, which no browser will play, so this is usually a genuine re-encode rather than a re-wrap. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target AVI?",
  ...
  "mkv-to-avi": {
    ...
    longDescription:
      "Convert Matroska MKV video to AVI. AVI plays on older Windows software, and is long past being a sensible delivery format, while MKV plays in desktop players like VLC, but rarely in browsers or on phones and TVs. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a MKV recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on AVI before editing",
      "Re-wrap a MKV for upload without re-shooting or re-exporting",
    ...
    faqs: [
      {
        q: "Does converting MKV to AVI reduce quality?",
        a: "An MKV source very often already holds H.264 or H.265, in which case the video is copied across untouched and only the container changes. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target AVI?",
  ...
  "avi-to-mkv": {
    ...
    longDescription:
      "Convert AVI video to Matroska MKV. Matroska MKV plays in desktop players like VLC, but rarely in browsers or on phones and TVs, while AVI plays on older Windows software, and is long past being a sensible delivery format. Container and codec are handled together, so what comes out is a file that genuinely opens rather than a renamed extension. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a AVI recording playable on a device or site that rejects it",
      "Standardise mixed-format footage on MKV before editing",
      "Re-wrap a AVI for upload without re-shooting or re-exporting",
    ],
    features: [
      "Reads what is actually inside the AVI, rather than trusting the extension",
    ...
    faqs: [
      {
        q: "Does converting AVI to MKV reduce quality?",
        a: "An AVI source is typically an older codec such as DivX, Xvid, or MJPEG, so a re-encode is unavoidable here, and it is also an upgrade. Where a re-encode is needed it is a real one, so start from the best source you have.",
      },
      {
        q: "Why target MKV?",
        a: "Pick MKV when one file has to carry several audio tracks, subtitles, or chapters, and it will be played on a desktop rather than streamed.",
      },
      {
        q: "How long does it take?",
        a: "A stream copy takes seconds. A full re-encode is bound by your CPU or GPU and scales with length and resolution. Progress is reported live while it runs.",
  ...
  "mp4-to-gif": {
    ...
    longDescription:
      "Turn a clip of MP4 video into an animated GIF. GIF displays anywhere an image does, including comment boxes and chat clients that block video, and it charges you for that: 256 colours per frame and a file often larger than the video it came from. MP4 is usually H.264 at a sane bitrate, so it decodes fast and the frame timing is regular, which is the easy case for a clean loop. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
    ...
    faqs: [
      {
        q: "Why is my GIF bigger than the MP4 it came from?",
      ...
      {
        q: "Any tips when the source is MP4?",
        a: "Its constant frame rate means you can halve to 12fps by taking every other frame, with no judder in the result.",
      },
      {
  ...
  "mov-to-gif": {
    ...
    faqs: [
      {
        q: "Why is my GIF bigger than the MOV it came from?",
        a: "Because GIF stores frames with no motion compensation, while modern video codecs encode only what changed. A 10-second GIF at full frame rate can easily beat the source. Cut the length, then the width, then the frame rate.",
      },
      {
        q: "Why does the colour look banded?",
      ...
      {
        q: "Any tips when the source is MOV?",
        a: "Scale the width down before touching anything else. On 4K camera footage that single change dominates the final file size.",
      },
      {
        q: "What length works well?",
        a: "Under about 5 seconds, at 10-15fps and around 480px wide, keeps most GIFs manageable.",
  ...
  "mkv-to-gif": {
    ...
    faqs: [
      {
        q: "Why is my GIF bigger than the MKV it came from?",
        a: "Because GIF stores frames with no motion compensation, while modern video codecs encode only what changed. A 10-second GIF at full frame rate can easily beat the source. Cut the length, then the width, then the frame rate.",
      },
      {
        q: "Why does the colour look banded?",
      ...
      {
        q: "Any tips when the source is MKV?",
        a: "Check which video track you are trimming if the file carries more than one, or you may cut from the wrong stream.",
      },
      {
        q: "What length works well?",
        a: "Under about 5 seconds, at 10-15fps and around 480px wide, keeps most GIFs manageable.",
  ...
  "avi-to-gif": {
    ...
    longDescription:
      "Turn a clip of AVI video into an animated GIF. GIF displays anywhere an image does, including comment boxes and chat clients that block video, and it charges you for that: 256 colours per frame and a file often larger than the video it came from. AVI is normally an older codec at modest resolution, which makes it a light source for GIF. Interlaced captures may show combing that survives into the frames. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Make a short loop for a README, issue thread, or chat where video will not embed",
      "Cut a reaction clip out of a longer AVI",
      "Produce an autoplaying preview for somewhere that strips video tags",
    ],
    features: [
      "Trim to a start and end point before the GIF is built",
      "Frame rate and width control, the two knobs that actually decide the size",
      "Per-clip optimised palette to limit banding inside GIF's 256 colours",
      "Handles what AVI actually contains without a separate decode step",
      "Your AVI files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Why is my GIF bigger than the AVI it came from?",
        a: "Because GIF stores frames with no motion compensation, while modern video codecs encode only what changed. A 10-second GIF at full frame rate can easily beat the source. Cut the length, then the width, then the frame rate.",
      },
      {
        q: "Why does the colour look banded?",
      ...
      {
        q: "Any tips when the source is AVI?",
        a: "Deinterlace first if the footage came off tape or a capture card, or the combing artifacts get baked into every frame.",
      },
      {
        q: "What length works well?",
        a: "Under about 5 seconds, at 10-15fps and around 480px wide, keeps most GIFs manageable.",
  ...
  "gif-to-mp4": {
    ...
    longDescription:
      "Convert an animated GIF into MP4 video. This is usually a large win: real video codecs use motion compensation, so the same animation typically lands 5-20x smaller than the GIF and looks better, having escaped GIF's 256-colour ceiling. MP4 plays essentially everywhere: browsers, phones, TVs, and editors. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by replacing a heavy GIF with a looping MP4",
  ...
  "gif-to-mov": {
    ...
    longDescription:
      "Convert an animated GIF into QuickTime MOV video. This is usually a large win: real video codecs use motion compensation, so the same animation typically lands 5-20x smaller than the GIF and looks better, having escaped GIF's 256-colour ceiling. QuickTime MOV plays well on Apple hardware and in editing suites, patchily elsewhere. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Cut page weight by replacing a heavy GIF with a looping MOV",
      "Get a GIF onto a platform that accepts video but not animated images",
      "Recover a usable master from an animation that only survives as a GIF",
    ],
    features: [
  ...
  "mp4-to-mp3": {
    ...
    longDescription:
      "Pull the audio track out of a MP4 video and save it as MP3. MP3 is the safe default: every player built in the last 25 years reads it. MP4 almost always carries AAC, so an MP3 or WAV target means a real decode, while pulling the AAC out untouched is instant. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded MP4 for offline listening",
      "Lift music or a voiceover from MP4 footage for reuse",
    ...
    features: [
      ...
      "Track selection on MP4 files carrying more than one audio stream",
      "Your MP4 files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Does extracting audio re-encode it?",
        a: "Yes, unless the source track is already MP3, in which case it is copied out untouched. Going from one lossy format to another loses a little, so pick the highest bitrate you are willing to store.",
      },
      {
        q: "My MP4 has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      },
      {
        q: "Why pick MP3 here?",
        a: "Choose MP3 when the file has to simply work somewhere you do not control.",
      },
      {
        q: "How big will the MP3 be?",
        a: "Roughly bitrate times duration. At 192kbps that works out around 1.4MB per minute.",
      },
    ],
  },
  "mov-to-mp3": {
    ...
    longDescription:
      "Pull the audio track out of a MOV video and save it as MP3. MP3 is the safe default: every player built in the last 25 years reads it. MOV from cameras and editors frequently holds uncompressed PCM rather than a compressed track, so a WAV target can be a straight copy while MP3 is a genuine encode. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded MOV for offline listening",
      "Lift music or a voiceover from MOV footage for reuse",
      "Feed the audio to transcription or analysis that will not take video",
    ],
    features: [
      "Audio extracted directly, with no needless video decode",
      "Bitrate selectable, so you set the size-versus-fidelity point",
      "Track selection on MOV files carrying more than one audio stream",
      "Your MOV files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
      ...
      {
        q: "My MOV has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      },
      {
        q: "Why pick MP3 here?",
  ...
  "mkv-to-mp3": {
    ...
    longDescription:
      "Pull the audio track out of a MKV video and save it as MP3. MP3 is the safe default: every player built in the last 25 years reads it. MKV is the permissive one: the audio inside might be AC3, DTS, Opus, FLAC, or several tracks at once. Pick the track you want, then choose a target every player can read. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded MKV for offline listening",
      "Lift music or a voiceover from MKV footage for reuse",
      "Feed the audio to transcription or analysis that will not take video",
    ],
    features: [
      "Audio extracted directly, with no needless video decode",
      "Bitrate selectable, so you set the size-versus-fidelity point",
      "Track selection on MKV files carrying more than one audio stream",
      "Your MKV files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
      ...
      {
        q: "My MKV has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      },
      {
        q: "Why pick MP3 here?",
  ...
  "webm-to-mp3": {
    ...
    faqs: [
      ...
      {
        q: "My WEBM has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      },
      {
        q: "Why pick MP3 here?",
  ...
  "avi-to-mp3": {
    ...
    longDescription:
      "Pull the audio track out of a AVI video and save it as MP3. MP3 is the safe default: every player built in the last 25 years reads it. AVI typically holds MP3 or raw PCM. If it is already MP3 the extraction is a copy, so there is no second lossy pass to worry about. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded AVI for offline listening",
      "Lift music or a voiceover from AVI footage for reuse",
      "Feed the audio to transcription or analysis that will not take video",
    ],
    features: [
      "Audio extracted directly, with no needless video decode",
      "Bitrate selectable, so you set the size-versus-fidelity point",
      "Track selection on AVI files carrying more than one audio stream",
      "Your AVI files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
      ...
      {
        q: "My AVI has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      },
      {
        q: "Why pick MP3 here?",
  ...
  "mp4-to-wav": {
    ...
    longDescription:
      "Pull the audio track out of a MP4 video and save it as WAV. WAV is uncompressed PCM: perfect fidelity at roughly 10MB per minute. MP4 almost always carries AAC, so an MP3 or WAV target means a real decode, while pulling the AAC out untouched is instant. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded MP4 for offline listening",
      "Lift music or a voiceover from MP4 footage for reuse",
      "Feed the audio to transcription or analysis that will not take video",
    ...
    faqs: [
      {
        q: "Does extracting audio re-encode it?",
        a: "No. WAV is lossless, so the decoded audio is written out without a second lossy pass.",
      },
      {
        q: "My MP4 has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      ...
      {
        q: "Why pick WAV here?",
        a: "Choose WAV when the audio is heading into an editor or a transcription pipeline that wants uncompressed input.",
      },
      {
        q: "How big will the WAV be?",
        a: "WAV is uncompressed or losslessly compressed, so expect tens of megabytes per hour at minimum. Choose MP3 when size matters more than fidelity.",
      },
    ],
  },
  "mov-to-wav": {
    ...
    longDescription:
      "Pull the audio track out of a MOV video and save it as WAV. WAV is uncompressed PCM: perfect fidelity at roughly 10MB per minute. MOV from cameras and editors frequently holds uncompressed PCM rather than a compressed track, so a WAV target can be a straight copy while MP3 is a genuine encode. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded MOV for offline listening",
      "Lift music or a voiceover from MOV footage for reuse",
      "Feed the audio to transcription or analysis that will not take video",
  ...
  "mp4-to-ogg": {
    ...
    longDescription:
      "Pull the audio track out of a MP4 video and save it as OGG. Ogg Vorbis is royalty-free and strong at low bitrates, but thin on hardware support. MP4 almost always carries AAC, so an MP3 or WAV target means a real decode, while pulling the AAC out untouched is instant. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a podcast or interview out of a recorded MP4 for offline listening",
      "Lift music or a voiceover from MP4 footage for reuse",
      "Feed the audio to transcription or analysis that will not take video",
    ...
    faqs: [
      {
        q: "Does extracting audio re-encode it?",
        a: "Yes, unless the source track is already OGG, in which case it is copied out untouched. Going from one lossy format to another loses a little, so pick the highest bitrate you are willing to store.",
      },
      {
        q: "My MP4 has several audio tracks. Which one do I get?",
        a: "The default track unless you choose another. Multi-track files list what they contain so you can pick.",
      ...
      {
        q: "Why pick OGG here?",
        a: "Choose Ogg when you serve audio from your own pages and want a royalty-free codec.",
      },
      {
        q: "How big will the OGG be?",
        a: "Roughly bitrate times duration. At 192kbps that works out around 1.4MB per minute.",
      },
    ],
  },
  "m4a-to-mp3": {
    ...
    longDescription:
      "Convert M4A audio to MP3. You are starting from M4A, which is AAC audio in an MP4 container, which some older players refuse to open. MP3 is the safe default: every player built in the last 25 years reads it. Both formats are lossy, so this is a second compression pass over audio that was already compressed. Fine for listening, wrong for archiving. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a M4A file playing on a car stereo, an old phone, or anything stubborn",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names MP3 specifically",
    ],
    features: [
      "Bitrate and sample rate control",
      "Tags, artwork, and track metadata carried across wherever MP3 supports them",
      "Batch conversion across a whole library",
      "Your M4A files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will M4A to MP3 lose quality?",
        a: "Some, unavoidably. Pick a bitrate you are happy to live with, because the discarded detail is gone for good and re-encoding upward later recovers nothing.",
      },
      {
        q: "Are tags and cover art kept?",
        a: "Yes, wherever the target has somewhere to put them. MP3 carries the common fields; anything exotic in the source may not survive.",
      },
      {
        q: "Anything peculiar about M4A I should know?",
        a: "M4A and MP4 are the same container with a different extension. If a player rejects the .m4a, renaming it to .mp4 occasionally works without converting anything.",
      },
      {
  ...
  "m4a-to-wav": {
    ...
    longDescription:
      "Convert M4A audio to WAV. You are starting from M4A, which is AAC audio in an MP4 container, which some older players refuse to open. WAV is uncompressed PCM: perfect fidelity at roughly 10MB per minute. WAV is lossless, but it cannot rebuild what M4A already threw away. You get a larger file containing exactly what the M4A held, which helps before editing and achieves nothing as an archive upgrade. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a M4A into WAV for editing or archiving",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names WAV specifically",
    ],
    features: [
      "Lossless encode, with no quality call to make",
      "Tags, artwork, and track metadata carried across wherever WAV supports them",
      "Batch conversion across a whole library",
      "Your M4A files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will M4A to WAV lose quality?",
        a: "Nothing is lost on this hop. Whether that is useful depends on the source: from a lossy original you get a faithful copy of already-reduced audio, not a restored one.",
      },
      {
        q: "Are tags and cover art kept?",
        a: "Yes, wherever the target has somewhere to put them. WAV carries the common fields; anything exotic in the source may not survive.",
      },
      {
        q: "Anything peculiar about M4A I should know?",
        a: "M4A and MP4 are the same container with a different extension. If a player rejects the .m4a, renaming it to .mp4 occasionally works without converting anything.",
  ...
  "aac-to-mp3": {
    ...
    longDescription:
      "Convert AAC audio to MP3. You are starting from AAC, which is cleaner than MP3 at the same bitrate, and standard across Apple devices. MP3 is the safe default: every player built in the last 25 years reads it. Both formats are lossy, so this is a second compression pass over audio that was already compressed. Fine for listening, wrong for archiving. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a AAC file playing on a car stereo, an old phone, or anything stubborn",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names MP3 specifically",
    ],
    features: [
      ...
      "Tags, artwork, and track metadata carried across wherever MP3 supports them",
      "Batch conversion across a whole library",
      "Your AAC files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will AAC to MP3 lose quality?",
        a: "Some, unavoidably. Pick a bitrate you are happy to live with, because the discarded detail is gone for good and re-encoding upward later recovers nothing.",
      },
      {
        q: "Are tags and cover art kept?",
      ...
      {
        q: "Anything peculiar about AAC I should know?",
        a: "A raw .aac stream has no container and no dependable duration header, which is why some players scrub through it badly. Converting fixes that even when the codec stays the same.",
      },
      {
        q: "Can I convert a whole folder at once?",
        a: "Yes. Batch conversion applies the same settings to every file and returns them together.",
  ...
  "aac-to-wav": {
    ...
    longDescription:
      "Convert AAC audio to WAV. You are starting from AAC, which is cleaner than MP3 at the same bitrate, and standard across Apple devices. WAV is uncompressed PCM: perfect fidelity at roughly 10MB per minute. WAV is lossless, but it cannot rebuild what AAC already threw away. You get a larger file containing exactly what the AAC held, which helps before editing and achieves nothing as an archive upgrade. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a AAC into WAV for editing or archiving",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names WAV specifically",
    ],
    features: [
    ...
    faqs: [
      {
        q: "Will AAC to WAV lose quality?",
        a: "Nothing is lost on this hop. Whether that is useful depends on the source: from a lossy original you get a faithful copy of already-reduced audio, not a restored one.",
      },
      {
        q: "Are tags and cover art kept?",
  ...
  "aac-to-flac": {
    ...
    longDescription:
      "Convert AAC audio to FLAC. You are starting from AAC, which is cleaner than MP3 at the same bitrate, and standard across Apple devices. FLAC is lossless compression, so bit-perfect audio at about half the size of WAV. FLAC is lossless, but it cannot rebuild what AAC already threw away. You get a larger file containing exactly what the AAC held, which helps before editing and achieves nothing as an archive upgrade. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a AAC into FLAC for editing or archiving",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names FLAC specifically",
    ],
    features: [
      "Lossless encode, with no quality call to make",
      "Tags, artwork, and track metadata carried across wherever FLAC supports them",
      "Batch conversion across a whole library",
      "Your AAC files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will AAC to FLAC lose quality?",
        a: "Nothing is lost on this hop. Whether that is useful depends on the source: from a lossy original you get a faithful copy of already-reduced audio, not a restored one.",
      },
      {
        q: "Are tags and cover art kept?",
        a: "Yes, wherever the target has somewhere to put them. FLAC carries the common fields; anything exotic in the source may not survive.",
      },
      {
        q: "Anything peculiar about AAC I should know?",
        a: "A raw .aac stream has no container and no dependable duration header, which is why some players scrub through it badly. Converting fixes that even when the codec stays the same.",
  ...
  "ogg-to-mp3": {
    ...
    longDescription:
      "Convert Ogg Vorbis audio to MP3. You are starting from Ogg Vorbis, which is royalty-free and strong at low bitrates, but thin on hardware support. MP3 is the safe default: every player built in the last 25 years reads it. Both formats are lossy, so this is a second compression pass over audio that was already compressed. Fine for listening, wrong for archiving. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a OGG file playing on a car stereo, an old phone, or anything stubborn",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names MP3 specifically",
    ],
    features: [
      ...
      "Tags, artwork, and track metadata carried across wherever MP3 supports them",
      "Batch conversion across a whole library",
      "Your OGG files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will OGG to MP3 lose quality?",
        a: "Some, unavoidably. Pick a bitrate you are happy to live with, because the discarded detail is gone for good and re-encoding upward later recovers nothing.",
      },
      {
        q: "Are tags and cover art kept?",
      ...
      {
        q: "Anything peculiar about OGG I should know?",
        a: "Ogg's bitrate is variable by design, so a nominal 128kbps Vorbis file is not directly comparable to a constant 128kbps MP3, and usually sounds better.",
      },
      {
        q: "Can I convert a whole folder at once?",
        a: "Yes. Batch conversion applies the same settings to every file and returns them together.",
  ...
  "ogg-to-wav": {
    ...
    longDescription:
      "Convert Ogg Vorbis audio to WAV. You are starting from Ogg Vorbis, which is royalty-free and strong at low bitrates, but thin on hardware support. WAV is uncompressed PCM: perfect fidelity at roughly 10MB per minute. WAV is lossless, but it cannot rebuild what OGG already threw away. You get a larger file containing exactly what the OGG held, which helps before editing and achieves nothing as an archive upgrade. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a OGG into WAV for editing or archiving",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names WAV specifically",
    ],
    features: [
    ...
    faqs: [
      {
        q: "Will OGG to WAV lose quality?",
        a: "Nothing is lost on this hop. Whether that is useful depends on the source: from a lossy original you get a faithful copy of already-reduced audio, not a restored one.",
      },
      {
        q: "Are tags and cover art kept?",
  ...
  "wav-to-mp3": {
    ...
    longDescription:
      "Convert WAV audio to MP3. You are starting from WAV, which is uncompressed PCM: perfect fidelity at roughly 10MB per minute. MP3 is the safe default: every player built in the last 25 years reads it. WAV is lossless and MP3 is lossy, so this discards audio data in exchange for a much smaller file. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a WAV file playing on a car stereo, an old phone, or anything stubborn",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names MP3 specifically",
    ],
    features: [
      ...
      "Tags, artwork, and track metadata carried across wherever MP3 supports them",
      "Batch conversion across a whole library",
      "Your WAV files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will WAV to MP3 lose quality?",
        a: "Some, unavoidably. Pick a bitrate you are happy to live with, because the discarded detail is gone for good and re-encoding upward later recovers nothing.",
      },
      {
        q: "Are tags and cover art kept?",
      ...
      {
        q: "Anything peculiar about WAV I should know?",
        a: "WAV has no standard tag block, so artist and title fields most likely do not exist in the source to carry over.",
      },
      {
        q: "Can I convert a whole folder at once?",
        a: "Yes. Batch conversion applies the same settings to every file and returns them together.",
  ...
  "mp3-to-wav": {
    ...
    longDescription:
      "Convert MP3 audio to WAV. You are starting from MP3, which is the safe default: every player built in the last 25 years reads it. WAV is uncompressed PCM: perfect fidelity at roughly 10MB per minute. WAV is lossless, but it cannot rebuild what MP3 already threw away. You get a larger file containing exactly what the MP3 held, which helps before editing and achieves nothing as an archive upgrade. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Move a MP3 into WAV for editing or archiving",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names WAV specifically",
    ],
    features: [
      ...
      "Tags, artwork, and track metadata carried across wherever WAV supports them",
      "Batch conversion across a whole library",
      "Your MP3 files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will MP3 to WAV lose quality?",
        a: "Nothing is lost on this hop. Whether that is useful depends on the source: from a lossy original you get a faithful copy of already-reduced audio, not a restored one.",
      },
      {
        q: "Are tags and cover art kept?",
      ...
      {
        q: "Anything peculiar about MP3 I should know?",
        a: "MP3 cannot mark a gapless album boundary reliably, so expect a short silence between tracks unless the player understands the gapless tags.",
      },
      {
        q: "Can I convert a whole folder at once?",
        a: "Yes. Batch conversion applies the same settings to every file and returns them together.",
  ...
  "flac-to-mp3": {
    ...
    longDescription:
      "Convert FLAC audio to MP3. You are starting from FLAC, which is lossless compression, so bit-perfect audio at about half the size of WAV. MP3 is the safe default: every player built in the last 25 years reads it. FLAC is lossless and MP3 is lossy, so this discards audio data in exchange for a much smaller file. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
      "Get a FLAC file playing on a car stereo, an old phone, or anything stubborn",
      "Standardise a mixed music or voice library on a single format",
      "Meet an upload requirement that names MP3 specifically",
    ],
    features: [
      ...
      "Tags, artwork, and track metadata carried across wherever MP3 supports them",
      "Batch conversion across a whole library",
      "Your FLAC files are processed on your own server and never uploaded anywhere",
    ],
    faqs: [
      {
        q: "Will FLAC to MP3 lose quality?",
        a: "Some, unavoidably. Pick a bitrate you are happy to live with, because the discarded detail is gone for good and re-encoding upward later recovers nothing.",
      },
      {
        q: "Are tags and cover art kept?",
      ...
      {
        q: "Anything peculiar about FLAC I should know?",
        a: "FLAC keeps the full dynamic range. If the destination is a phone or a car stereo, consider normalising while you convert.",
      },
      {
        q: "Can I convert a whole folder at once?",
        a: "Yes. Batch conversion applies the same settings to every file and returns them together.",
  ...
  "excel-to-csv": {
    ...
    longDescription:
      "Convert an Excel workbook to CSV. CSV is plain text, which is what makes it portable and also what makes it lossy in a structural sense: formulas collapse to their computed values, and formatting, charts, and multiple sheets do not survive. Runs on your own SnapOtter instance. Files never reach a third party.",
    useCases: [
    ...
    faqs: [
      {
        ...
        a: "CSV holds one table, so each sheet becomes its own file. Pick a single sheet if you want a single output.",
      },
      {
        q: "Are my formulas preserved?",
        a: "Their results are. CSV has no concept of a formula, so what lands is the value each cell displayed.",
      },
      {
